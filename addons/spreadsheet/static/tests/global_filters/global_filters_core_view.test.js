...
test("Value of numeric filter", () => {
    ...
    addGlobalFilterWithoutReload(model, {
        ...
        defaultValue: { operator: "=", minimumOrTargetValue: 10 },
    });

    let result = setGlobalFilterValueWithoutReload(model, {
        id: "1",
        value: { operator: "=", minimumOrTargetValue: false },
    });
    expect(result.isSuccessful).toBe(false);
    expect(result.reasons).toEqual(["InvalidValueTypeCombination"]);
    ...
    result = setGlobalFilterValueWithoutReload(model, {
        id: "1",
        value: { operator: "=", minimumOrTargetValue: "value" },
    });
    expect(result.isSuccessful).toBe(false);
    expect(result.reasons).toEqual(["InvalidValueTypeCombination"]);
    ...
    result = setGlobalFilterValueWithoutReload(model, {
        id: "1",
        value: { operator: "=", minimumOrTargetValue: "5" },
    });
    expect(result.isSuccessful).toBe(false);
    expect(result.reasons).toEqual(["InvalidValueTypeCombination"]);
    ...
    result = setGlobalFilterValueWithoutReload(model, {
        id: "1",
        value: { operator: "=", minimumOrTargetValue: "" },
    });
    expect(result.isSuccessful).toBe(false);
    expect(result.reasons).toEqual(["InvalidValueTypeCombination"]);
    ...
    result = addGlobalFilterWithoutReload(model, {
        ...
        defaultValue: { operator: "=", minimumOrTargetValue: 99 },
    });
    expect(result.isSuccessful).toBe(true);
