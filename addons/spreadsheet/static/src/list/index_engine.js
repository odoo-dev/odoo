...
import { ListCoreGlobalFilterPlugin } from "@spreadsheet/list/plugins/list_core_global_filter_plugin";

const { inverseCommandRegistry, corePluginRegistry, featurePluginRegistry, coreViewsPluginRegistry } = spreadsheet.registries;
...
corePluginRegistry.add("ListCoreGlobalFilterPlugin", ListCoreGlobalFilterPlugin);
