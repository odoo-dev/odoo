...
// https://deno.land/std@0.224.0/streams/text_line_stream.ts
// https://jsr.io/@std/streams/doc/~/TextLineStream

/**
 * @typedef {Object} TextLineStreamOptions
 * @property {boolean} [allowCR=false] Allow splitting by `\r`.
 */
...
export class TextLineStream extends TransformStream {
    ...
    /**
     * @param {TextLineStreamOptions} options {} - Options for the stream.
     */
