...
class AccountFiscalPosition(models.Model):
    ...
    def _validate_foreign_vat(self):
        for record in self:
            ...
            checked_country_code = self.env['res.partner'].run_vat_test(record.foreign_vat, record.country_id)
            ...
            if not checked_country_code:
                ...
                error_message = self.env['res.partner'].build_vat_error_message(record.country_id.code.lower(), record.foreign_vat, fp_label)
