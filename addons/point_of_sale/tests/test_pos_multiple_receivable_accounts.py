...
class TestPoSMultipleReceivableAccounts(TestPoSCommon):
    ...
    def test_01_invoiced_order_from_other_customer(self):
        ...
        self._run_test({
            ...
            'orders': [
                ...
                {'pos_order_lines_ui_args': [(self.product2, 5), (self.product3, 5)], 'payments': [(self.bank_pm1, 264.76)], 'customer': self.other_customer, 'uuid': '09876-098-0987'},
            ],
    ...
    def test_02_all_orders_invoiced_mixed_customers(self):
        ...
        self._run_test({
            'payment_methods': self.cash_pm1 | self.bank_pm1,
            'orders': [
                {'pos_order_lines_ui_args': [(self.product1, 10), (self.product2, 10), (self.product3, 10)], 'customer': self.other_customer, 'uuid': '09876-098-0987'},
                {'pos_order_lines_ui_args': [(self.product1, 5), (self.product2, 5)], 'payments': [(self.bank_pm1, 158.75)], 'customer': self.customer, 'uuid': '09876-098-0988'},
                {'pos_order_lines_ui_args': [(self.product2, 5), (self.product3, 5)], 'payments': [(self.bank_pm1, 264.76)], 'customer': self.other_customer, 'uuid': '09876-098-0989'},
            ],
            'before_closing_cb': _before_closing_cb,
            'journal_entries_before_closing': {
                '09876-098-0987': {
