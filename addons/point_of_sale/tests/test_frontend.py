...
class TestUi(TestPointOfSaleHttpCommon):
    ...
    def test_02_pos_with_invoiced(self):
        ...
        n_invoiced = self.env['pos.order'].search_count([('account_move', '!=', False), ('config_id', '=', self.main_pos_config.id)])
        n_paid = self.env['pos.order'].search_count([('state', '=', 'paid'), ('config_id', '=', self.main_pos_config.id)])
