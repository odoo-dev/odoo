...
class ResConfigSettings(models.TransientModel):
    ...
    module_pos_dpo = fields.Boolean(string="DPO By Network Payment Terminal", help="The transactions are processed by DPO By Network. Set your DPO By Network credentials on the related payment method.")
