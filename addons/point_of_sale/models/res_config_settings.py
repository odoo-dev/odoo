...
class ResConfigSettings(models.TransientModel):
    ...
    group_pos_preset = fields.Boolean(string="Presets", implied_group="point_of_sale.group_pos_preset", help="Enable the presets menu in configuration menu of the Point of Sale.")
