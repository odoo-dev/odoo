...
class PosConfig(models.Model):
    ...
    cash_control = fields.Boolean(string='Advanced Cash Control', compute='_compute_cash_control', store=True, help="Check the amount of the cashbox at opening and closing.")
