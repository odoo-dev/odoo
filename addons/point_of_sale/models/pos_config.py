...
class PosConfig(models.Model):
    ...
    is_customer_display = fields.Boolean(string="Pos Customer Display")
    is_customer_display_proxy = fields.Boolean(string="An IOT-connected screen")
    ...
    def _get_customer_display_data(self):
        ...
        return {
            ...
            'is_customer_display_proxy': self.is_customer_display_proxy,
            'has_bg_img': bool(self.customer_display_bg_img),
            'company_id': self.company_id.id,
            **({'proxy_ip': self._get_display_device_ip()} if self.is_customer_display_proxy else {}),
        }
