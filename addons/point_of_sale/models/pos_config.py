...
class PosConfig(models.Model):
    ...
    module_pos_commission = fields.Boolean("POS Commissions")
    ...
    @api.depends('use_pricelist', 'pricelist_id', 'available_pricelist_ids', 'payment_method_ids', 'limit_categories',
        'iface_available_categ_ids', 'module_pos_hr', 'module_pos_discount', 'module_pos_commission', 'iface_tipproduct', 'default_preset_id')
