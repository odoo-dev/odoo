...
test("convert orderline to combo", async () => {
...
test("convert orderlines to combo with upsell groups", async () => {
    const store = await setupPosEnv();
    store.addNewOrder();
...
test("do not suggest combo when all groups are upsell", async () => {
    const store = await setupPosEnv();
    store.addNewOrder();
...
test("convert orderlines to combo with multiple quantities", async () => {
    const store = await setupPosEnv();
    store.addNewOrder();
...
test("convert orderlines to combo marks no upsell for regular combo", async () => {
    const store = await setupPosEnv();
    store.addNewOrder();
...
test("convert orderlines to combo no free item not applicable", async () => {
    const store = await setupPosEnv();
    store.addNewOrder();
...
test("convert orderlines to combo creates combo parent and children", async () => {
    const store = await setupPosEnv();
...
test("convert orderlines to combo apply first and keep remaining lines", async () => {
    const store = await setupPosEnv();
    const order = store.addNewOrder();
...
test("convert orderlines to combo apply all combinations", async () => {
    const store = await setupPosEnv();
    const order = store.addNewOrder();
...
test("combo upsell: multiple combo suggestions and apply with configurator popup", async () => {
    const store = await setupPosEnv();
    store.addNewOrder();
...
test("combo upsell: multiple combo suggestions shows choose button and verifies saved amount", async () => {
    const store = await setupPosEnv();
    store.addNewOrder();
    const order = store.getOrder();
    const productScreen = await mountWithCleanup(ProductScreen, {
