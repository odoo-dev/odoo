...
registry.category("web_tour.tours").add("TicketScreenTour", {
    steps: () =>
        [
            ...
            Chrome.clickOrders(),
            TicketScreen.nthRowContains(1, "B Test Partner", false),
            Chrome.createFloatingOrder(),
            ProductScreen.addOrderline("Desk Pad", "1", "3"),
            ProductScreen.clickPartnerButton(),
            ...
            Chrome.clickOrders(),
            TicketScreen.nthRowContains(1, "C Test Partner", false),
            Chrome.createFloatingOrder(),
            ...
            TicketScreen.nthRowContains(1, "Receipt"),
            TicketScreen.search("Customer", "B Test Partner"),
            TicketScreen.nthRowContains(1, "B Test Partner", false),
            TicketScreen.search("Customer", "C Test Partner"),
            TicketScreen.nthRowContains(1, "C Test Partner", false),
            ...
            Dialog.confirm(),
            PartnerList.clickPartner("D Test Partner"),
...
registry.category("web_tour.tours").add("test_order_refund_flow", {
    steps: () =>
        [
            ...
            ProductScreen.clickRefund(),
            TicketScreen.selectOrder("001"),
            inLeftSide([...ProductScreen.clickLine("Letter Tray", "3")]),
            ProductScreen.clickNumpad("1"),
            TicketScreen.toRefundTextContains("1"),
            TicketScreen.confirmRefund(),
            PaymentScreen.isShown(),
