...
export class PosOrder extends Base {
    ...
    get taxTotals() {
        ...
        for (const line of orderLines) {
            ...
            baseLines.push(accountTaxHelpers.prepare_base_line_for_taxes_computation(
                line,
                {
                    ...extraValues,
                    quantity: line.qty,
        ...
        const cashRounding = !this.config.only_round_cash_method && this.config.cash_rounding
