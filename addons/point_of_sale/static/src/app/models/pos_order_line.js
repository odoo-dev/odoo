...
export class PosOrderline extends Base {
    ...
    check_equivalent_line(lineA, lineB) {
        ...
        const lineAPrice = window.parseFloat(
            roundDecimals(lineA.price_unit || 0, productPriceUnit).toFixed(productPriceUnit)
        );
        const lineBPrice = window.parseFloat(
            roundDecimals(lineA.price_unit || 0, productPriceUnit).toFixed(productPriceUnit)
        );
        ...
        return (
            ...
            floatIsZero(lineAPrice - lineBPrice - lineB.get_price_extra(), lineA.currency) &&
            !(
