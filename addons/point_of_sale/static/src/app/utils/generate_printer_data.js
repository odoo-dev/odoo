    ...
    generateLineData() {
        return this.order.lines.map((line) => {
            ...
            return {
                ...
                price_without_discount: this.formatCurrency(line.displayPriceNoDiscount),
    ...
    generateData() {
        ...
        return {
            order: {
                ...
                change: this.order.change && this.formatCurrency(this.order.change),
            },
            ...
            qrPaymentData: this.getQrPaymentData(this.order),
            conditions: {
