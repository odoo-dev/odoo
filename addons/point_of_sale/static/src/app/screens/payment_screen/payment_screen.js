...
export class PaymentScreen extends Component {
    ...
    async addTip() {
        ...
        const { confirmed, payload } = await this.popup.add(NumberPopup, {
            ...
            nbrDecimal: this.pos["res.currency"].decimal_places,
            inputSuffix: this.pos["res.currency"].symbol,
        });
    ...
    async afterOrderValidation(suggestToSync = true) {
        ...
        if (
            ...
            this.pos["pos.config"].iface_print_auto
        ) {
            ...
            if (this.hardwareProxy.printer && invoiced_finalized) {
                ...
                if (printResult && this.pos["pos.config"].iface_print_skip_screen) {
