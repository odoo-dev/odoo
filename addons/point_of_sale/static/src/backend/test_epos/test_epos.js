...
export class TestEPos extends Component {
    ...
    get printersIds() {
        return this.props.record.data[this.props.printer_type || "receipt_printer_ids"]?.currentIds || [];
    }

    get isDisabled() {
        return this.props.record.resModel === "pos.config" && !this.printersIds.length;
    }

    async _testAllPrinters() {
        if (!this.printersIds.length) {
        ...
        for (const p_id of this.printersIds) {
