...
class AccountMove(models.Model):
    ...
    def l10n_hr_edi_mer_action_fetch_status(self):
        self.ensure_one()
        self.env['l10n_hr_edi.mojeracun_connection']._mer_fetch_document_status_single(self)
    ...
    def l10n_hr_edi_mer_action_report_paid(self):
        for move in self:
            ...
            if amount_to_report and state_to_set:
                try:
                    response = self.env['l10n_hr_edi.mojeracun_connection']._mer_api_mark_paid(
                        move.company_id,
                ...
                self.env['l10n_hr_edi.mojeracun_connection']._mer_api_update_document_process_status(
                    move.company_id,
                    move.l10n_hr_mer_document_eid,
                    state_to_set,
                )
