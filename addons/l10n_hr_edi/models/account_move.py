...
class AccountMove(models.Model):
    ...
    l10n_hr_mer_document_status = fields.Selection(
        ...
        string='MojEracun basic document status',
        help="MojEracun internal document status - to be validated and recieved by the customer.",
        copy=False,
    )
    # This seems to somewhat correspond to Odoo account_move state,
    # but also contains eRacun related load and overlap with the other MER status
