...
class L10nHrMojEracunRejectInvoice(models.TransientModel):
    ...
    def button_reject_invoice(self):
        if self.move_id.l10n_hr_mer_document_eid:
            response = self.env['l10n_hr_edi.mojeracun_connection']._mer_api_reject_with_id(
            ...
            self.move_id._message_log(
                body=self.env._(
                    ...
                    timestamp=response.json()['fiscalizationTimestamp'], electronic_id=self.move_id.l10n_hr_mer_document_eid,
                ),
