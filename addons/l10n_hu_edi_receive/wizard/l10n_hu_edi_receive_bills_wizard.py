...
class L10nHuEdiReceiveBillsWizard(models.TransientModel):
    ...
    def action_receive_bills(self):
        ...
        return {
            ...
            'params': {
                'type': 'success',
                'message': _("Bills were successfully received from NAV.") if moves else _("No bills received from NAV."),
                'next': moves._get_records_action(name=_("Bills received from NAV")) if moves else {'type': 'ir.actions.act_window_close'},
            },
        }
