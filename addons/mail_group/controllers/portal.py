...
class PortalMailGroup(http.Controller):
    ...
    @http.route('/groups/<model("mail.group"):group>/<model("mail.group.message"):message>/get_replies',
                type='rpc', auth='public', methods=['POST'], website=True)
    ...
    @http.route('/group/subscribe', type='rpc', auth='public', website=True)
    ...
    @http.route('/group/unsubscribe', type='rpc', auth='public', website=True)
