...
class MrpWorkcenter(models.Model):
    ...
    workorder_blocked_count = fields.Integer('Total Pending Orders', compute='_compute_workorder_count')  # FIXME : Never Used
...
class MrpWorkcenterCapacity(models.Model):
    ...
    _check_company_auto = True
    _order = 'workcenter_id, product_id nulls first,product_uom_id'
    ...
    capacity = fields.Float('Capacity', help="Number of pieces that can be produced in parallel for this product.")
