...
class MrpProduction(models.Model):
    ...
    def _compute_show_allocation(self):
        ...
        for mo in self:
            if mo.picking_type_id and mo.picking_type_id.auto_show_reception_report:
    ...
    def _get_autoprint_done_report_actions(self):
        ...
        reception_reports_to_print = self.filtered(
            lambda p: (
                ...
                and p.picking_type_id.auto_print_mrp_reception_report
        ...
        if reception_reports_to_print:
            ...
            clean_action(action, self.env)
            report_actions.append(action)
        reception_labels_to_print = self.filtered(lambda p: p.picking_type_id.auto_show_reception_report and p.picking_type_id.auto_print_mrp_reception_report_labels and p.picking_type_id.code == 'mrp_operation')
