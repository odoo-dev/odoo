    ...
    def get_rules_dict(self):
        ...
        for warehouse in self:
            result[warehouse.id].update({
                'mrp_one_step': [],
                'pbm': [
                    warehouse.Routing(warehouse.lot_stock_id, warehouse.pbm_loc_id, warehouse.pbm_type_id, 'pull', 'make_to_stock'),
                    warehouse.Routing(warehouse.pbm_loc_id, production_location_id, warehouse.manu_type_id, 'pull', 'make_to_order'),
                ],
                'pbm_sam': [
                    warehouse.Routing(warehouse.lot_stock_id, warehouse.pbm_loc_id, warehouse.pbm_type_id, 'pull', 'make_to_stock'),
                    warehouse.Routing(warehouse.pbm_loc_id, production_location_id, warehouse.manu_type_id, 'pull', 'make_to_order'),
                    warehouse.Routing(warehouse.sam_loc_id, warehouse.lot_stock_id, warehouse.sam_type_id, 'push', 'make_to_order'),
                ],
            })
