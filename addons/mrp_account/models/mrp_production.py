...
class MrpProduction(models.Model):
    ...
    def _cal_price(self, consumed_moves):
        ...
        if finished_moves:
            ...
            finished_moves_product_uom = finished_moves[0].product_id.uom_id
            for work_order in self.workorder_ids:
                work_center_cost += work_order._cal_cost()
            quantity = finished_moves[0].product_uom._compute_quantity(
            ...
            if finished_moves[0].product_id.cost_method in ('fifo', 'average'):
