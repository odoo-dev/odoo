...
class TestMrpValuationStandard(TestMrpValuationCommon):
    def test_fifo_fifo_1(self):
        ...
        self.assertEqual(self.component.total_value, 20)
        ...
        self._produce(mo)
        mo.button_mark_done()
        self.assertEqual(self.component.total_value, 0)
        self.assertEqual(self.product1.total_value, 30)
        self.assertEqual(self.component.qty_available, 0)
    ...
    def test_fifo_fifo_2(self):
        ...
        self.assertEqual(self.component.qty_available, 0)
        self.assertEqual(self.product1.qty_available, 2)
        self._make_out_move(self.product1, 1, force_assign=True)
    ...
    def test_fifo_byproduct(self):
        ...
        mo = mo.production_group_id.production_ids[-1]
        self.assertEqual(self.component.total_value, 20)
        self.assertEqual(self.product1.total_value, 10 * (100 - byproduct_cost_share) / 100)
        self.assertEqual(byproduct.total_value, 10 * byproduct_cost_share / 100)
        self.assertEqual(self.component.qty_available, 1)
        self.assertEqual(self.product1.qty_available, 1)
        self.assertEqual(byproduct.qty_available, 1)
        self._produce(mo)
        mo.button_mark_done()
        self.assertEqual(self.component.total_value, 0)
        self.assertEqual(self.product1.total_value, 30 * (100 - byproduct_cost_share) / 100)
        self.assertEqual(byproduct.total_value, 30 * byproduct_cost_share / 100)
        self.assertEqual(self.component.qty_available, 0)
        self.assertEqual(self.product1.qty_available, 2)
        self.assertEqual(byproduct.qty_available, 2)
    ...
    def test_fifo_unbuild(self):
        ...
        self.assertEqual(self.component.total_value, 30)
    ...
    def test_fifo_produce_deliver_return_unbuild(self):
        ...
        self._produce(mo)
        mo.button_mark_done()
        self.assertRecordValues(mo.move_finished_ids, [{'value': 10.0, 'quantity': 1.0, 'remaining_qty': 1.0}])
        self.assertRecordValues(self.product1, [{'total_value': 10.0, 'qty_available': 1.0}])

        out_move = self._make_out_move(self.product1, 1.0, create_picking=True, force_assign=True)
        ...
        unbuild_form.mo_id = mo
        unbuild_form.save().action_unbuild()
        self.assertRecordValues(mo.move_finished_ids, [{'value': 10.0, 'quantity': 1.0, 'remaining_qty': 0.0}])
        self.assertRecordValues(self.product1, [{'total_value': 0.0, 'qty_available': 0.0}])
    ...
    def test_fifo_std_1(self):
        ...
        mo._post_inventory()
        self.assertEqual(self.component.total_value, 20)
        self.assertEqual(self.product1.total_value, 8.8)
        self.assertEqual(self.component.qty_available, 1)
        self.assertEqual(self.product1.qty_available, 1)
        self._produce(mo)
        mo.button_mark_done()
        self.assertEqual(self.component.total_value, 0)
        self.assertEqual(self.product1.total_value, 8.8 * 2)
        self.assertEqual(self.component.qty_available, 0)
        self.assertEqual(self.product1.qty_available, 2)
    ...
    def test_std_avco_1(self):
        ...
        self._produce(mo, 1)
        mo._post_inventory()
        self.assertEqual(self.component.total_value, 8.8)
        self.assertEqual(self.product1.total_value, 8.8)
        self.assertEqual(self.component.qty_available, 1)
        self.assertEqual(self.product1.qty_available, 1)
        self._produce(mo)
    ...
    def test_std_std_1(self):
        ...
        mo._post_inventory()
        self.assertEqual(self.component.total_value, 8.8)
        self.assertEqual(self.product1.total_value, 7.2)
        self.assertEqual(self.component.qty_available, 1)
        self.assertEqual(self.product1.qty_available, 1)
        self._produce(mo)
        mo.button_mark_done()
        self.assertEqual(self.component.total_value, 0)
        self.assertEqual(self.product1.total_value, 7.2 * 2)
        self.assertEqual(self.component.qty_available, 0)
        self.assertEqual(self.product1.qty_available, 2)
    ...
    def test_avco_avco_1(self):
        ...
        self._produce(mo, 1)
        mo._post_inventory()
        self.assertEqual(self.component.total_value, 15)
        self.assertEqual(self.product1.total_value, 15)
        self.assertEqual(self.component.qty_available, 1)
        self.assertEqual(self.product1.qty_available, 1)
        self._produce(mo)
    ...
    def test_validate_draft_kit(self):
        ...
        self.assertEqual(self.component.qty_available, 1)
        self.assertEqual(self.component.total_value, 1424)
...
class TestMrpStockValuation(TestStockValuationBase):
    ...
    def setUpClass(cls):
        ...
        cls.production_location = cls.env['stock.location'].search([('usage', '=', 'production'), ('company_id', '=', cls.env.company.id)])
        cls.production_location.valuation_account_id = cls.production_account
