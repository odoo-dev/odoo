...
class TestStockValuationWithCOA(PurchaseTestCommon):
    ...
    def test_anglosaxon_valuation_price_total_diff_discount(self):
        ...
        # Create PO
        order = self._create_purchase(self.product_fifo_auto, price_unit=110.0)
        ...
        self.assertEqual(self.product_fifo_auto.total_value, 90.0)
    ...
    def test_anglosaxon_valuation_discount(self):
        ...
        # Create PO
        order = self._create_purchase(self.product_fifo_auto)

        # Receive the goods
        receipt = self._receive(order, quantity=1)

        # Create an invoice with a different price and a discount
        self._create_bill(purchase_order=order, discount=10.0, clear_taxes=True)
    ...
    def test_anglosaxon_valuation_price_unit_diff_discount(self):
        ...
        # Create PO
        order = self._create_purchase(self.product_fifo_auto, price_unit=90.0)
    ...
    def test_pdiff_and_aml_labels(self):
        ...
        with po_form.order_line.new() as po_line:
            po_line.product_id = self.product_fifo_auto
    ...
    def test_pdiff_lot_valuation(self):
        ...
        """
        self.product_avco_auto.tracking = 'serial'
        self.product_avco_auto.lot_valuated = True
        po = self._create_purchase(product=self.product_avco_auto, quantity=3.0, price_unit=100.0)
        ...
        self.assertEqual(self.product_avco_auto.total_value, 300.0)
        ...
        self.assertEqual(self.product_avco_auto.standard_price, 150.0)
        self.assertEqual(self.product_avco_auto.total_value, 450.0)
        self.assertRecordValues(self.product_avco_auto, [{
    ...
    def test_purchase_with_backorders_and_return_and_price_changes(self):
        ...
        """
        po = self._create_purchase(self.product_avco_auto, quantity=100, price_unit=10.0)
    ...
    def test_invoice_on_ordered_qty_with_backorder_and_different_currency_automated(self):
        ...
        self.product_fifo_auto.purchase_method = 'purchase'
    ...
    def test_bill_with_zero_qty(self):
        ...
        """
        product1 = self.product_fifo_auto
        product2 = self.product1
    ...
    def _test_fifo_and_returns_common(self):
        ...
        Receive & Bill 1 @ 10
        """
        po = self._create_purchase(self.product_fifo_auto, quantity=1, price_unit=10.0)
    ...
    def test_fifo_return_and_receive_all_on_backorder(self):
        ...
        po = self._create_purchase(self.product_fifo_auto, quantity=4, price_unit=25.0)
        ...
        self.assertRecordValues(self.product_fifo_auto, [{
            'qty_available': 5,
            'total_value': 125.0,
            'standard_price': 25.0,
        }])
    ...
    def test_fifo_bill_return_refund(self):
        ...
        po = self._create_purchase(self.product_fifo_auto, quantity=1, price_unit=25.0)
    ...
    def test_incoming_with_negative_qty(self):
        ...
        po = self._create_purchase(self.product_fifo_auto, quantity=-2, price_unit=10.0)
    ...
    def test_standard_valuation_return_credit_note(self):
        ...
        self.assertRecordValues(self.product_standard_auto, [{
            'qty_available': 0,
            'total_value': 0.0,
        }])
    ...
    def test_multicurrency_bill_before_receipt_values_at_bill_rate(self):
        ...
        """
        product = self.product_fifo_auto  # fifo, real_time
