...
registry.category("web_tour.tours").add("test_replenishment_supplier_multicompany_access", {
    steps: () => [
        ...
        {
            content: "Check vendor is saved on the row",
            trigger: '.o_data_row:has(.o_data_cell[name="product_id"]:contains("Product A")) .o_data_cell[name="supplier_id"]:contains("Partner A")',
        },
    ],
});
