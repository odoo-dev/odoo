...
class PurchaseOrder(models.Model):
    ...
    picking_type_id = fields.Many2one('stock.picking.type', 'Deliver To', required=True, index=True, default=_default_picking_type, ui_domain=lambda self: [('code', 'in', self._get_allowed_picking_code()), '|', ('warehouse_id.company_id', 'in', self.env.companies.ids), ('warehouse_id', '=', False)],
