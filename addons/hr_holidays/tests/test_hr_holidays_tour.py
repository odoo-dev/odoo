...
# from com.odoo.addons.hr_holidays.models.res_users import User
...
class TestHrHolidaysTour(HttpCase):
    ...
    def test_hr_holidays_launch(self):
        admin_user = self.env.ref("base.user_admin")
        admin_employee = admin_user.employee_id
        self.env.ref("base.lang_sr@latin").active
        admin_user.lang = "sr@latin"

        self.start_tour("/web", "hr_holidays_launch", watch=True, step_delay=2000)
