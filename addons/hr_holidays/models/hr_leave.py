...
class HrLeave(models.Model):
    ...
    def _compute_work_entry_type_id(self):
        ...
        for holiday in draft_leaves:
            local_work_entry_types = self.env['hr.work.entry.type'].with_context(default_date_from=holiday.request_date_from, default_date_to=holiday.request_date_to).search([('country_id', 'in', [holiday.employee_id.company_id.country_id.id] + [False])])
    ...
    def _get_durations(self, check_work_entry_type=True, resource_calendar=None, additional_domain=None):
        ...
        for leave in self:
            ...
            if leave.employee_id:
                ...
                # sudo as is_flexible is on version model and employee does not have access to it.
<<<<<<< eae3f1b970220186b259b444a8ae8729b5439e98
                if leave.employee_id.sudo().is_flexible and leave.request_date_to == leave.request_date_from:
||||||| 98becb791a483cdae384887bcc128664cba77a21
                elif leave.employee_id.sudo().is_flexible and leave.request_date_to == leave.request_date_from:
=======
                elif leave.employee_id.sudo().is_fully_flexible or (leave.employee_id.sudo().is_flexible and leave.request_date_to == leave.request_date_from):
>>>>>>> f6b826a33d05998e0970879e535a541217afe37a
...
||||||| 98becb791a483cdae384887bcc128664cba77a21
                    ...
                    ]) if not leave.work_entry_type_id.include_public_holidays_in_duration else resource_calendar_leaves
                    if public_holidays:
