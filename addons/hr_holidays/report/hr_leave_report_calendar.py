...
class HrLeaveReportCalendar(models.Model):
    ...
    is_absent = fields.Boolean(related='employee_id.is_absent', related_sudo=True)
    member_of_department = fields.Boolean(related='employee_id.member_of_department', related_sudo=True)
    leave_manager_id = fields.Many2one(related='employee_id.leave_manager_id', related_sudo=True)
