...
class HrLeaveEmployeeReport(models.Model):
    ...
    @api.depends('month_aligned_date_from', 'month_aligned_date_to', 'leave_id.resource_calendar_id')
    ...
    @api.depends('month_aligned_date_from', 'month_aligned_date_to', 'leave_id.employee_id', 'leave_id.holiday_status_id')
