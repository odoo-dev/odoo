...
test("change icon on change partner im_status for leave variants", async () => {
    ...
    await contains(
        ".o-mail-DiscussContent-header .o-mail-ImStatus [data-icon='travel'][title='On Leave (Online)']"
    );
    ...
    await contains(".o-mail-DiscussContent-header .o-mail-ImStatus [data-icon='travel'][title='On Leave']");
    pyEnv["bus.bus"]._sendone("broadcast", "bus.bus/im_status_updated", {
        partner_id: serverState.partnerId,
    ...
    await contains(
        ".o-mail-DiscussContent-header .o-mail-ImStatus [data-icon='travel'][title='On Leave (Idle)']"
    );
    pyEnv["bus.bus"]._sendone("broadcast", "bus.bus/im_status_updated", {
        partner_id: serverState.partnerId,
