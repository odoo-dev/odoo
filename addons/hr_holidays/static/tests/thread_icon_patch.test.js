...
test("thread icon of a chat when correspondent is on leave & online", async () => {
    ...
    await contains(".o-mail-DiscussSidebarChannel", {
        contains: [".o-mail-ThreadIcon [data-icon='travel'][title='On Leave (Online)']"],
        text: "Demo",
    });
});
...
test("thread icon of a chat when correspondent is on leave & away", async () => {
    ...
    await openDiscuss();
    await contains(".o-mail-DiscussSidebarChannel", {
        contains: [".o-mail-ThreadIcon [data-icon='travel'][title='On Leave (Idle)']"],
        text: "Demo",
    });
});
...
test("thread icon of a chat when correspondent is on leave & offline", async () => {
    ...
    await openDiscuss();
    await contains(".o-mail-DiscussSidebarChannel", {
        contains: [".o-mail-ThreadIcon [data-icon='travel'][title='On Leave']"],
        text: "Demo",
    });
});
