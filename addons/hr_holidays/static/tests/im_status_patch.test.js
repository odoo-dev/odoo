...
test("on leave & online", async () => {
    ...
    await contains(
        ".o-mail-DiscussContent-header .o-mail-ImStatus i[data-icon='travel'][title='On Leave (Online)']"
    );
});
...
test("on leave & away", async () => {
    ...
    await openDiscuss(channelId);
    await contains(
        ".o-mail-DiscussContent-header .o-mail-ImStatus i[data-icon='travel'][title='On Leave (Idle)']"
    );
});
...
test("on leave & offline", async () => {
    ...
    await start();
    await openDiscuss(channelId);
    await contains(".o-mail-DiscussContent-header .o-mail-ImStatus i[data-icon='travel'][title='On Leave']");
});
