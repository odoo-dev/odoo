...
class HomeStaticTemplateHelpers(object):
    ...
    @classmethod
    def get_qweb_templates_checksum(cls, addons=None, db=None, debug=False, bundle='web.assets_qweb'):
        return cls(addons, db, checksum_only=True, debug=debug)._get_qweb_templates(bundle)[1]

    @classmethod
    def get_qweb_templates(cls, addons=None, db=None, debug=False, bundle='web.assets_qweb'):
...
class WebClient(http.Controller):
    ...
    def qweb(self, unique, mods=None, db=None, bundle='web.assets_qweb'):
