...
class Action(Controller):
    ...
    @route('/web/action/load', type='rpc', auth='user', readonly=True)
    ...
    @route('/web/action/run', type='rpc', auth="user")
    ...
    @route('/web/action/load_breadcrumbs', type='rpc', auth='user', readonly=True)
