...
class Export(http.Controller):
    ...
    @http.route('/web/export/formats', type='rpc', auth='user', readonly=True)
    def formats(self):
    ...
    @http.route('/web/export/get_fields', type='rpc', auth='user', readonly=True)
    ...
    @http.route('/web/export/namelist', type='rpc', auth='user', readonly=True)
