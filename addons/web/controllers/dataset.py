...
class DataSet(http.Controller):
    ...
    @http.route(['/web/dataset/call_kw', '/web/dataset/call_kw/<path:path>'], type='rpc', auth="user", readonly=_call_kw_readonly)
    def call_kw(self, model, method, args, kwargs, path=None):
        check_method_name(method)
        return call_kw(request.env[model], method, args, kwargs)

    @http.route(['/web/dataset/call_button', '/web/dataset/call_button/<path:path>'], type='rpc', auth="user", readonly=_call_kw_readonly)
    ...
    @http.route('/web/dataset/resequence', type='rpc', auth="user")
