        ...
        <form class="contents" t-on-submit.prevent="refresh">
            ...
            <div class="flex items-center gap-1">
                ...
                <t t-foreach="CASE_EVENT_TYPES" t-as="sType" t-key="sType">
                    ...
                    >
                        <i class="oi" t-att-class="CASE_EVENT_TYPES[sType].icon_class" t-att-data-icon="CASE_EVENT_TYPES[sType].icon"/>
                    </button>
                </t>
            </div>
            <button
            ...
            >
                ...
                >
                    ...
                    <i class="oi" data-icon="sort" t-att-class="{ 'oi-flip-vertical': uiState.sortResults === 'desc' }" />
                </span>
            </button>
            <label
                class="cursor-pointer flex items-center gap-1 hover:bg-gray-300 dark:hover:bg-gray-700"
            ...
            >
                <i class="oi w-4 h-4" t-att-data-icon="color.scheme === 'light' ? 'dark_mode' : 'light_mode'" />
                Color scheme
            </button>
