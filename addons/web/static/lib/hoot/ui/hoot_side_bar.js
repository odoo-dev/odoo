...
const { Boolean, Number, Object, String } = globalThis;
...
export class HootSideBar extends Component {
    ...
    static template = xml`
        <div class="${HootSideBar.name} flex-col w-64 h-full overflow-x-hidden overflow-y-auto resize-x bg-gray-200 dark:bg-gray-800 hidden md:flex">
            <ul>
