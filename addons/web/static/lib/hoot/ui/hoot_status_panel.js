...
import { Component, onWillRender, useEffect, useRef, proxy, xml, plugin } from "@odoo/owl";
            ...
            <div class="flex items-center gap-2 overflow-hidden">
                ...
                <t t-elif="this.runnerState.status === 'running'">
                    ...
                    <div
                        ...
                        title="Running"
                    />
                    <strong class="text-primary" t-esc="this.env.runner.totalTime" />
                </t>
                <t t-else="">
                    <span class="hidden md:block">
                        <strong class="text-primary" t-esc="this.runnerReporting.tests" />
                        tests completed
                        (total time: <strong class="text-primary" t-esc="this.env.runner.totalTime" />
                ...
                <t t-if="this.state.timer">
                    <span class="text-cyan" t-esc="this.formatTime(this.state.timer, 's')" />
                </t>
            </div>
            <div class="flex items-center gap-1">
                <t t-if="this.runnerReporting.passed">
                    ...
                    >
                        ...
                        <t t-esc="this.runnerReporting.passed" />
                    </button>
                </t>
                <t t-if="this.runnerReporting.failed">
                    ...
                    >
                        ...
                        <t t-esc="this.runnerReporting.failed" />
                    </button>
                </t>
                <t t-if="this.runnerReporting.skipped">
                    ...
                    >
                        ...
                        <t t-esc="this.runnerReporting.skipped" />
                    </button>
                </t>
                <t t-if="this.runnerReporting.todo">
                    ...
                    >
                        ...
                        <t t-esc="this.runnerReporting.todo" />
                    </button>
                </t>
                <t t-if="this.ui.totalResults() gt this.ui.resultsPerPage()">
                    ...
                    <div class="flex gap-1 animate-slide-left">
                        ...
                        <strong class="text-primary" t-esc="this.ui.resultsPage() + 1" />
