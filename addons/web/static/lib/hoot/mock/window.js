...
function getWatchedEventTargets(view) {
    return [
        ...
        window.AbortSignal.prototype,
        window.Animation.prototype,
        window.AudioDecoder.prototype,
        window.AudioEncoder.prototype,
        window.AudioNode.prototype,
        window.BackgroundFetchRegistration.prototype,
        window.BaseAudioContext.prototype,
        window.BatteryManager.prototype,
        window.BroadcastChannel.prototype,
        window.CaptureController.prototype,
        window.Clipboard.prototype,
        window.CloseWatcher.prototype,
        window.CookieStore.prototype,
        window.CreateMonitor.prototype,
        window.DevicePosture.prototype,
        window.DocumentPictureInPicture.prototype,
        window.EditContext.prototype,
        window.EventSource.prototype,
        window.FileReader.prototype,
        window.GPUDevice.prototype,
        window.HID.prototype,
        window.HIDDevice.prototype,
        window.IDBDatabase.prototype,
        window.IDBRequest.prototype,
        window.IDBTransaction.prototype,
        window.IdleDetector.prototype,
        ...
        window.MIDIAccess.prototype,
        window.MIDIPort.prototype,
        window.Navigation.prototype,
        window.NavigationHistoryEntry.prototype,
        window.NavigatorManagedData.prototype,
        window.NetworkInformation.prototype,
        window.Notification.prototype,
        window.OffscreenCanvas.prototype,
        window.PaymentRequest.prototype,
        window.PaymentResponse.prototype,
        window.Performance.prototype,
        window.PermissionStatus.prototype,
        window.PictureInPictureWindow.prototype,
        window.PresentationAvailability.prototype,
        window.PresentationConnection.prototype,
        window.PresentationConnectionList.prototype,
        window.PresentationRequest.prototype,
        window.Profiler.prototype,
        window.RemotePlayback.prototype,
        window.RTCDataChannel.prototype,
        window.RTCDtlsTransport.prototype,
        window.RTCDTMFSender.prototype,
        window.RTCIceTransport.prototype,
        window.RTCPeerConnection.prototype,
        window.RTCSctpTransport.prototype,
        window.Screen.prototype,
        window.ScreenDetails.prototype,
        window.ScreenOrientation.prototype,
        window.Sensor.prototype,
        window.Serial.prototype,
        window.SerialPort.prototype,
        ...
        window.SourceBufferList.prototype,
        window.SpeechRecognition.prototype,
        window.SpeechSynthesis.prototype,
        window.SpeechSynthesisUtterance.prototype,
        window.TextTrack.prototype,
        window.TextTrackCue.prototype,
        window.TextTrackList.prototype,
        window.USB.prototype,
        window.VideoDecoder.prototype,
        window.VideoEncoder.prototype,
        window.VirtualKeyboard.prototype,
        window.VisualViewport.prototype,
        window.WakeLockSentinel.prototype,
        window.WebSocket.prototype,
        window.Window.prototype,
        window.WindowControlsOverlay.prototype,
        window.Worker.prototype,
        window.XMLHttpRequestEventTarget.prototype,
        window.XRLayer.prototype,
        window.XRLightProbe.prototype,
        window.XRSession.prototype,
        window.XRSpace.prototype,
        window.XRSystem.prototype,
    ];
}
