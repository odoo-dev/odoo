...
import { onWillRender, onWillStart, useRef, useState } from "@odoo/owl";
...
export class OfflineSearchBar extends SearchBar {
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            const availableQueries = await offlineService.getAvailableQueries(actionId, viewType);
            const filters = Object.entries(availableQueries)
