...
function makeActionManager(env) {
    ...
    function _getSwitchViewParams() {
        ...
        if (state.action && !actionRegistry.contains(state.action)) {
            ...
            if (
                ...
                const props = { recordId: state.id || false };
    ...
    function _getViewProps(view, action, views, props = {}) {
        ...
        if ("resId" in props) {
            viewProps.recordId = props.resId;
            delete viewProps.resId;
        }
        if (action.res_id) {
            viewProps.recordId = action.res_id;
        }
        return viewProps;
    }
    ...
    async function switchView(viewType, props = {}) {
        ...
        if (view.isLegacy && newController.jsId === controller.jsId) {
            ...
            const params = {};
            if (props && "recordId" in props) {
                params.currentId = props.recordId;
            }
