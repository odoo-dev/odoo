    ...
    setup() {
        ...
        onPatched(() => {
            ...
            if (activeColumnId) {
                ...
                const column = document.querySelector(`.o_kanban_group[data-id="${activeColumnId}"]`);
                const activeCard = column?.querySelector(".o_kanban_record"); // Adjust selector if needed
