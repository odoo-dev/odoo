...
export class FormController extends Component {
    ...
    setup() {
        ...
        if (xmlDocHeader) {
            ...
            // is left, and it counts the children of that very element. It
            // hangs under a `form` because a compiler may walk the ancestors
            // of a node up to the root of the arch, and a detached container
            // would let that walk run past it.
            const xmlDocHeaderButtons = doc.createElement("div");
            doc.createElement("form").appendChild(xmlDocHeaderButtons);
