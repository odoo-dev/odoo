...
test("clickbot show rpc error when an error dialog is detected", async () => {
            ...
            error: (msg) => {
                ...
                expect.step(
                    msg
                        ...
                        // containing the tracetrack / date / url linked to the running environnement
                        .replace(
    ...
    const expectedModalHtml = /* xml */ `
        ...
        <footer class="modal-footer justify-content-start gap-2 w-100" data-buttons-count="0">
