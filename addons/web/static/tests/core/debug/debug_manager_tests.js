...
import { createWebClient, getActionManagerTestConfig } from "../../webclient/actions/helpers";
...
QUnit.module("DebugMenu", (hooks) => {
    ...
    QUnit.test("can open a view", async (assert) => {
        ...
        testConfig.serverData.models["ir.ui.view"] = {
            fields: {
                model: { type: "char" },
                name: { type: "char" },
                type: { type: "char" },
        ...
        testConfig.serverData.views[
            "ir.ui.view,false,list"
        ] = `<list><field name="name"/><field name="type"/></list>`;
        testConfig.serverData.views["ir.ui.view,false,search"] = `<search/>`;
        testConfig.serverData.views["partner,1,form"] = `<form><div class="some_view"/></form>`;
