...
QUnit.module("Views", (hooks) => {
    ...
    QUnit.skipWOWL("LPE adapted, but the onchange seems to not push all field values..." +
        ...
        async function (assert) {
            ...
            serverData.models.partner.onchanges = {
                trululu(record) {
                    ...
                    // LPE FIXME: send all values to onchange ?
                    record.product_ids = record.product_ids || [];
