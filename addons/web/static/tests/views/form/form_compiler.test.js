    ...
    const expected = /*xml*/ `
        <t t-translation="off">
            <div class="o_form_renderer"
                 ...
                 t-attf-class="{{__comp__.props.record.isInEdition ? 'o_form_editable' : 'o_form_readonly'}} d-flex d-print-block {{ __comp__.uiService.size &lt; 5 ? &quot;flex-column&quot; : &quot;flex-nowrap h-100&quot; }} {{ ${hasTouch()} || __comp__.uiService.size &lt;= 0 ? &quot;o_field_highlight&quot; : &quot;&quot; }} {{ __comp__.props.record.dirty ? 'o_form_dirty' : !__comp__.props.record.isNew ? 'o_form_saved' : '' }}"
