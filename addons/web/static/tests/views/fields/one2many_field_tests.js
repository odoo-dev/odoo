...
QUnit.module("Fields", (hooks) => {
    ...
    QUnit.test("O2M List without relation_field", async function (assert) {
        ...
        assert.containsN(target, ".o_field_x2many_list .o_data_row", 2, "There should be 2 rows");
    });
    ...
    QUnit.test("add record in a one2many non editable list with context", async function (assert) {
        ...
        await makeView({
            ...
            mockRPC(route, args) {
                if (args.method === "onchange2" && args.model === "turtle") {
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.verifySteps(["onchange2"], "onchange should have been done");
        }
    );
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.verifySteps(["name_search", "web_read", "onchange2"]);
        }
    );
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.verifySteps(["get_views", "get_views", "web_read", "onchange2", "onchange2"]);
        }
    );
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.verifySteps([
                ...
                "onchange2", // main record
                "onchange2", // sub record
                "onchange2", // edition of display_name of sub record
            ]);
        }
    );
