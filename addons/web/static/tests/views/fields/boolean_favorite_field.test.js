...
test("FavoriteField in kanban view", async () => {
    ...
    expect(`.o_kanban_record .o_field_widget .o_favorite > a i[data-icon="star"].oi-filled`).toHaveCount(1, {
    ...
    expect(`.o_kanban_record .o_field_widget .o_favorite > a i[data-icon="star"].oi-filled`).toHaveCount(0, {
...
test("FavoriteField in form view", async () => {
    ...
    expect(`.o_field_widget .o_favorite > a i[data-icon="star"].oi-filled`).toHaveCount(1, {
        message: "should be favorite",
    });
    ...
    await contains(`.o_field_widget .o_favorite`).click();
    expect.verifySteps(["save"]);
    expect(`.o_field_widget .o_favorite > a i[data-icon="star"].oi-filled`).toHaveCount(0, {
        message: "should not be favorite",
    });
    expect(`.o_field_widget .o_favorite > a i[data-icon="star"]`).toHaveCount(1, {
        message: "should not be favorite",
    });
...
test("FavoriteField in editable list view without label", async () => {
    ...
    expect(`.o_data_row:first .o_field_widget .o_favorite > a i[data-icon="star"].oi-filled`).toHaveCount(1, {
        message: "should be favorite",
    });
    ...
    expect(`.o_data_row:first .o_field_widget .o_favorite > a i[data-icon="star"].oi-filled`).toHaveCount(0, {
        message: "should not be favorite",
    });

    // save
    await contains(`.o_list_button_save`).click();
    expect(`.o_data_row:first .o_field_widget .o_favorite > a i[data-icon="star"]`).toHaveCount(1, {
        message: "should not be favorite",
    });
});
