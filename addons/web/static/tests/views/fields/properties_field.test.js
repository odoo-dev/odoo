...
test("properties: suffix", async () => {
    ...
    expect(".o_field_properties .o_property_field:last .o_input_box_overlay.suffix").toHaveText(
        "kg"
    );
});
...
test("properties: signature", async () => {
    ...
    expect(".o_property_field:eq(0) .o_input_box_overlay.suffix").toHaveCount(0, {
