...
describe("groupby sequence of fields", () => {
    ...
    test("groupby sequence fnames many2one", async () => {
        RelatedBar._records = [
            { id: 1, name: "bar_a" },
            { id: 2, name: false },
        ];
    ...
    test("groupby sequence fnames char", async () => {
        RelatedBar._records = [
            { id: 1, name: "bar_a" },
            { id: 2, name: false },
        ];
    ...
    test("groupby sequence fnames date", async () => {
        RelatedFoo._records = [
    ...
    test("groupby sequence fnames date with date part", async () => {
        RelatedFoo._records = [
            { id: 1, schedule_datetime: false },
            { id: 2, schedule_datetime: "1916-08-18 12:30:00" },
        ];
    ...
    test("groupby sequence fnames with formatted_read_grouping_sets", async () => {
        RelatedBar._records = [
            { id: 1, name: "bar_a" },
            { id: 2, name: false },
        ];
