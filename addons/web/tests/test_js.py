...
class WebSuite(QunitCommon, HOOTCommon):
    ...
    def test_unit_desktop(self):
        ...
        self.browser_js(f'/web/tests?headless&loglevel=2&preset=desktop&timeout=21000{self.hoot_filters}', "", "", login='admin', timeout=2500, success_signal="[HOOT] test suite succeeded", error_checker=unit_test_error_checker)

    @odoo.tests.no_retry
    def test_hoot(self):
        # HOOT tests suite
        self.browser_js(f'/web/static/lib/hoot/tests/index.html?headless&loglevel=2{self.hoot_filters}', "", "", login='admin', timeout=2500, success_signal="[HOOT] test suite succeeded", error_checker=unit_test_error_checker)
...
class MobileWebSuite(QunitCommon, HOOTCommon):
    ...
    def test_unit_mobile(self):
        ...
        self.browser_js(f'/web/tests?headless&loglevel=2&preset=mobile&tag=-headless&timeout=21000{self.hoot_filters}', "", "", login='admin', timeout=2500, success_signal="[HOOT] test suite succeeded", error_checker=unit_test_error_checker)
