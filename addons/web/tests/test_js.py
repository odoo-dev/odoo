...
class WebSuite(QunitCommon, HOOTCommon):
    ...
    def test_unit_desktop(self):
        ...
        self.browser_js(f'/web/tests?headless&loglevel=2&preset=desktop&timeout=15000{self.hoot_filters}&suite=df7eb1d6', "", "", login='admin', timeout=1800, success_signal="[HOOT] test suite succeeded", error_checker=unit_test_error_checker)
...
class MobileWebSuite(QunitCommon, HOOTCommon):
    ...
    def test_unit_mobile(self):
        ...
        self.browser_js(f'/web/tests?headless&loglevel=2&preset=mobile&tag=-headless&timeout=15000{self.hoot_filters}&suite=df7eb1d6', "", "", login='admin', timeout=1800, success_signal="[HOOT] test suite succeeded", error_checker=unit_test_error_checker)
