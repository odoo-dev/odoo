...
class WebSuite(QunitCommon, HOOTCommon):
    ...
    def test_unit_desktop(self):
        ...
        self.browser_js(f'/web/tests?headless&loglevel=2&preset=desktop&timeout=15000&test=-b424ca4c{self.hoot_filters}', "", "", login='admin', timeout=2100, success_signal="[HOOT] test suite succeeded", error_checker=unit_test_error_checker)
