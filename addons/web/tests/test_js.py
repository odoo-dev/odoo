...
class WebSuite(odoo.tests.HttpCase):
    ...
    def test_unit_desktop(self):
        ...
        self.browser_js('/web/tests?headless&loglevel=2&preset=desktop&timeout=15000&filter=/^(@website)/', "", "", login='admin', timeout=2000, success_signal="[HOOT] test suite succeeded", error_checker=unit_test_error_checker)
...
class MobileWebSuite(odoo.tests.HttpCase):
    ...
    def test_unit_mobile(self):
        ...
        self.browser_js('/web/tests?headless&loglevel=2&preset=mobile&tag=-headless&timeout=15000&filter=/^(@website)/', "", "", login='admin', timeout=1800, success_signal="[HOOT] test suite succeeded", error_checker=unit_test_error_checker)
