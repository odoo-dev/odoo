...
class WebSuite(odoo.tests.HttpCase):
    ...
    def test_unit_desktop(self):
        ...
        self.browser_js('/web/tests?headless&loglevel=2&preset=desktop&timeout=15000', "", "", login='admin', timeout=2400, success_signal="[HOOT] test suite succeeded", error_checker=unit_test_error_checker)
