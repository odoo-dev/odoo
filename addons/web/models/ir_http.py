...
class IrHttp(models.AbstractModel):
    ...
    def lazy_session_info(self):
        bundle_params = {'lang': request.session.context['lang']}
        bundle_assets_backend_lazy = 'web.assets_backend_lazy_dark' if request.cookies.get('color_scheme') == 'dark' else 'web.assets_backend_lazy'
        return {
            "bundles": {
                bundle_assets_backend_lazy: self.get_bundle(bundle_name=bundle_assets_backend_lazy, bundle_params=bundle_params),
                'web.fullcalendar_lib':
                    self.get_bundle(bundle_name='web.fullcalendar_lib', bundle_params=bundle_params),
                'web.chartjs_lib':
                    self.get_bundle(bundle_name='web.chartjs_lib', bundle_params=bundle_params)
            }
        }
