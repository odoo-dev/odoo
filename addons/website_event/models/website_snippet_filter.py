    ...
    def _get_hardcoded_sample(self, model):
        ...
        if model._name == 'event.event':
            data = [{
                ...
                'date_begin': self.env.now.date() + timedelta(days=10),
                'date_end': self.env.now.date() + timedelta(days=11),
            }, {
                ...
                'date_begin': self.env.now.date(),
                'date_end': self.env.now.date() + timedelta(days=2),
            }, {
                ...
                'date_begin': self.env.now.date() + timedelta(weeks=8),
                'date_end': self.env.now.date() + timedelta(weeks=8, days=5),
            }, {
                ...
                'date_begin': self.env.now.date() + timedelta(days=7),
                'date_end': self.env.now.date() + timedelta(days=7),
            }, {
                ...
                'date_begin': self.env.now.date() + timedelta(days=1),
                ...
                'date_begin': self.env.now.date() + timedelta(days=2),
                'date_end': self.env.now.date() + timedelta(days=4),
            }]
            merged = []
