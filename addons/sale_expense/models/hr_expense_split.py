...
class HrExpenseSplit(models.TransientModel):
    ...
    sale_order_id = fields.Many2one('sale.order', string="Reinvoice to", compute='_compute_sale_order_id', readonly=False, store=True, ui_domain="[('state', '=', 'sale'), ('company_id', '=', company_id)]")
