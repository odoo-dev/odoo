...
class DriverController(http.Controller):
    @http.route('/hw_drivers/action', type='rpc', auth='none', cors='*', csrf=False, save_session=False)
    ...
    @http.route('/hw_drivers/event', type='rpc', auth='none', cors='*', csrf=False, save_session=False)
