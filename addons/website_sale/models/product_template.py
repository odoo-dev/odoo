...
class ProductTemplate(models.Model):
    ...
    base_unit_count = fields.Float(
        ...
        help="Display base unit price on your eCommerce pages."
        " Set to 0 to hide it for this product.",
    ...
    def _has_is_custom_values(self):
        ...
        :rtype: bool
        """
        active_product_template_value_ids = (
            self.valid_product_template_attribute_line_ids.product_template_value_ids._only_active()
        )
        return any(v.is_custom for v in active_product_template_value_ids)
    ...
    def _get_possible_variants_sorted(self):
        ...
        def _sort_key_variant(variant):
            ...
            for attribute in variant.product_template_attribute_value_ids.sorted(
                ...
                # if you change this order, keep it in sync with `product.attribute.value` _order.
    ...
    @staticmethod
    def _get_attribute_value_domain(attribute_value_dict):
        return [
