...
class Website(models.Model):
    ...
    @api.model
    @staticmethod
    def get_configurator_shop_page_styles():
    ...
    @api.model
    @staticmethod
    def get_configurator_product_page_styles():
        ...
        for footer_id in ThemeUtils._footer_templates:
            ...
            try:
                ...
                footer_containers = [
                    ...
                    "hasclass('o_container_small')",
                    "hasclass('container-fluid')",
                ]
                footer_div_node = arch_tree.xpath(' or '.join(footer_containers))
                ...
                if footer_id == 'website_sale.template_footer_website_sale':
                    ...
                    if not ecommerce_categories_node:
                        ...
                        # transformed into static nodes after a save/edit thanks to the t-ignore in
                        # parent node.
                        footer_updated = True
    ...
    def configurator_addons_apply(self, industry_name=None, **kwargs):
        ...
        def generate_categories(industry_name_):
            ...
            prompt = (
                ...
                "Your task is to develop compelling category names and descriptions for a"
                f"{industry_name_}'s new online store.\n"
                f"The goal is to create categories that are persuasive, attention-grabbing, and"
                " concise, encouraging visitors to explore the offerings.\n"
                ...
                f"Description Length: Keep descriptions very short and to the point (ideally under"
                " 20 words).\n"
                "Persuasion: Descriptions should be persuasive and designed to attract attention.\n"
                ...
                " the specified format and constraints."
            )
    ...
    def _get_and_cache_current_cart(self):
        """Retrieve and caches the current cart for the session.
    ...
    def _send_abandoned_cart_email(self):
        for website in self.search([]):
            ...
            # Mark abandoned carts that failed the filter as sent to avoid rechecking them again.
