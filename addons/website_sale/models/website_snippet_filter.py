...
class WebsiteSnippetFilter(models.Model):
    ...
    def _get_products_latest_viewed(self, website, limit, domain, **kwargs):
        ...
        if visitor:
            excluded_products = website.current_session_sale_order_id.sudo().order_line.product_id.ids
    ...
    def _get_products_recently_sold_with(
        ...
        if current_template:
            ...
            if sale_orders:
                cart_products = website.current_session_sale_order_id.sudo().order_line.product_id
