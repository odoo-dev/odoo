...
class Website(main.Website):
    ...
    def _login_redirect(self, uid, redirect=None):
        ...
        if CART_SESSION_CACHE_KEY in request.session and not request.session.get(CART_SESSION_CACHE_KEY):
            # If public user had no cart, and logs in, we want to find his previous cart if he had one.
            request.session.pop(CART_SESSION_CACHE_KEY)
