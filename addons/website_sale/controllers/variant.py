...
class WebsiteSaleVariantController(Controller):
    ...
    @route('/website_sale/get_combination_info', type='rpc', auth='public', methods=['POST'], website=True)
    ...
    @route('/sale/create_product_variant', type='rpc', auth='public', methods=['POST'])
