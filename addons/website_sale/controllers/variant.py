...
class WebsiteSaleVariantController(Controller):
    ...
    def get_combination_info_website(
        ...
        if request.website.product_page_image_width != 'none' and not request.env.context.get(
    ...
    def create_product_variant(
        ...
        """Old product configurator logic, only used by frontend configurator, will be deprecated
        soon."""
        return (
