...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    @route(['/shop/product/extra-images'], type='rpc', auth='user', website=True)
    ...
    @route(['/shop/product/clear-images'], type='rpc', auth='user', website=True)
    ...
    @route(['/shop/product/resequence-image'], type='rpc', auth='user', website=True)
    ...
    @route(['/shop/product/is_add_to_cart_allowed'], type='rpc', auth="public", website=True)
    ...
    @route(['/shop/cart/update_json'], type='rpc', auth="public", methods=['POST'], website=True)
    ...
    @route('/shop/save_shop_layout_mode', type='rpc', auth='public', website=True)
    def save_shop_layout_mode(self, layout_mode):
        assert layout_mode in ('grid', 'list'), "Invalid shop layout mode"
        request.session['website_sale_shop_layout_mode'] = layout_mode

    @route(['/shop/cart/quantity'], type='rpc', auth="public", methods=['POST'], website=True)
    ...
    @route(['/shop/cart/clear'], type='rpc', auth="public", website=True)
    def clear_cart(self):
        order = request.website.sale_get_order()
    ...
    @route(
        _express_checkout_route, type='rpc', methods=['POST'], auth="public", website=True,
        sitemap=False
    )
    ...
    @route('/shop/update_address', type='rpc', auth='public', website=True)
    ...
    @route(['/shop/config/product'], type='rpc', auth='user')
    ...
    @route(['/shop/config/attribute'], type='rpc', auth='user')
    ...
    @route(['/shop/config/website'], type='rpc', auth='user')
    ...
    @route(['/shop/country_info/<model("res.country"):country>'], type='rpc', auth="public", methods=['POST'], website=True)
    ...
    # --------------------------------------------------------------------------
    @route('/shop/products/recently_viewed_update', type='rpc', auth='public', website=True)
    ...
    @route('/shop/products/recently_viewed_delete', type='rpc', auth='public', website=True)
