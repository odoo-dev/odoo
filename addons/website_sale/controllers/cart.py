...
class Cart(PaymentPortal):
    ...
    def cart(self, id=None, access_token=None, revive_method='', **post):
        ...
        :param str revive_method: The revival method of abandoned carts, can be 'merge' or 'squash'.
        ...
        if id and access_token:
            ...
            if not abandoned_order or not consteq(abandoned_order.access_token, access_token):
    ...
    def _cart_values(self, **_post):
        """Pass additional values when rendering the 'website_sale.cart' template."""
        return {}
