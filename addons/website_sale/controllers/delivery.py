...
class Delivery(WebsiteSale):
    ...
    @route('/shop/delivery_methods', type='rpc', auth='public', website=True)
    ...
    @route('/shop/set_delivery_method', type='rpc', auth='public', website=True)
    ...
    @route('/shop/get_delivery_rate', type='rpc', auth='public', methods=['POST'], website=True)
    ...
    @route('/website_sale/set_pickup_location', type='rpc', auth='public', website=True)
    ...
    @route('/website_sale/get_pickup_locations', type='rpc', auth='public', website=True)
    ...
    @route(_express_checkout_delivery_route, type='rpc', auth='public', website=True)
