...
class TestWebsiteSequence(BaseCommon):
    ...
    def assert_product_reordering(self, products, order):
    ...
    def test_01_website_sequence(self):
        ...
        self.assert_product_reordering(self.p1 + self.p2 + self.p3 + self.p4, sequence_order)
        # 100:1, 180:2, 225:3, 250:4
        self.p2.set_sequence_down()
        # 100:1, 180:3, 225:2, 250:4
        self.assert_product_reordering(self.p1 + self.p3 + self.p2 + self.p4, sequence_order)
        self.p4.set_sequence_up()
        # 100:1, 180:3, 225:4, 250:2
        self.assert_product_reordering(self.p1 + self.p3 + self.p4 + self.p2, sequence_order)
        self.p2.set_sequence_top()
        # 95:2, 100:1, 180:3, 225:4
        self.assert_product_reordering(self.p2 + self.p1 + self.p3 + self.p4, sequence_order)
        self.p1.set_sequence_bottom()
        # 95:2, 180:3, 225:4, 230:1
        self.assert_product_reordering(self.p2 + self.p3 + self.p4 + self.p1, sequence_order)
    ...
    def test_02_newest_arrivals(self):
        ...
        self.assert_product_reordering(target, newest_arrival_order)
