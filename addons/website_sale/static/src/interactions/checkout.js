...
export class Checkout extends Interaction {
    ...
    setup() {
        ...
        this.mainButton = Array.from(document.getElementsByName("website_sale_main_button")).find(
    ...
    _isDeliveryMethodReady() {
        ...
        const checkedRadio = document.querySelector('input[name="o_delivery_radio"]:checked');
        return (
            checkedRadio && !checkedRadio.disabled && !this._isPickupLocationMissing(checkedRadio)
        );
    }
    ...
    _isPickupLocationMissing(radio) {
        ...
        return !deliveryMethodContainer.querySelector('span[name="o_pickup_location_selector"]')
            .dataset.locationId;
    }
