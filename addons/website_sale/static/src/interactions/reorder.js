...
export class SaleOrderPortalReorder extends Interaction {
    ...
    _trackProducts(trackingInfo) {
        document
            ...
            .dispatchEvent(new CustomEvent("add_to_cart_event", { detail: trackingInfo }));
    }
}

registry.category("public.interactions").add("website_sale.portal_reorder", SaleOrderPortalReorder);
