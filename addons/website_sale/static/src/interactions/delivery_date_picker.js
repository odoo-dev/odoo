...
export class DeliveryDatePicker extends Interaction {
    ...
    start() {
        const deliveryMethod = this.el.closest('[name="o_delivery_method"]');
    ...
    /**
    * Check if the date is valid for this delivery method.
    *
    * @param {DateTime} date
    * @private
    */
...
registry.category('public.interactions').add('website_sale.daterange_picker', DeliveryDatePicker);
