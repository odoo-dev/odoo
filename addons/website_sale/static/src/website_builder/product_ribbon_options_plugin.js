...
class ProductsRibbonOptionPlugin extends Plugin {
    ...
    resources = {
        builder_options: [withSequence(SNIPPET_SPECIFIC_NEXT, ProductHeaderShopOption2)],
        builder_actions: {
            SetRibbonAction,
            CreateRibbonAction,
            ModifyRibbonAction,
...
registry.category("website-plugins").add(ProductsRibbonOptionPlugin.id, ProductsRibbonOptionPlugin);
