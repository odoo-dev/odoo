...
class PosPaymentMethod(models.Model):
    ...
    qfpay_pos_key = fields.Char('QFPay POS Key', copy=False, groups='base.group_erp_manager')
    qfpay_notification_key = fields.Char(string='QFPay Notification Key', copy=False, groups='base.group_erp_manager')
    qfpay_latest_response = fields.Char(copy=False, groups='base.group_erp_manager')
