...
class SaleOrderLine(models.Model):
    ...
    purchase_line_ids = fields.Many2many('purchase.order.line', 'sale_purchase_line_rel','sale_line_id', string="Generated Purchase Lines", readonly=True, help="Purchase line generated by this Sales item on order confirmation, or when the quantity was increased.")
