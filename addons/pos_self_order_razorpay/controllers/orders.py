...
class PosSelfOrderControllerRazorpay(PosSelfOrderController):
    @http.route("/pos-self-order/razorpay-fetch-payment-status/", auth="public", type="rpc", website=True)
    ...
    @http.route("/pos-self-order/razorpay-cancel-transaction/", auth="public", type="rpc", website=True)
