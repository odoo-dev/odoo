...
class Task(models.Model):
    ...
    leave_types_count = fields.Integer(compute='_compute_leave_types_count', string="Time Off Types Count") # TODO: remove me in master
    ...
    def _search_is_timeoff_task(self, operator, value):
        ...
        timeoff_task = self.env.company.leave_timesheet_task_id
        if operator == '!=':
            value = not value
        return [('id', 'in' if value else 'not in', timeoff_task.ids)]
