...
class ResConfigSettings(models.TransientModel):
    ...
    internal_project_id = fields.Many2one(
        ...
        ui_domain="[('company_id', '=', company_id), ('is_template', '=', False)]", readonly=False,
    ...
    leave_timesheet_task_id = fields.Many2one(
        ...
        ui_domain="[('company_id', '=', company_id), ('project_id', '=?', internal_project_id), ('has_template_ancestor', '=', False)]",
