odoo.define("mail_bot/static/src/components/notification_request/notification_request.js", function (require) {
    ...
    class NotificationRequest extends Component {
        ...
        constructor(...args) {
            ...
            useStore((props) => {
                return {
                    ...
                    partnerRoot: this.env.messaging.partnerRoot ? this.env.messaging.partnerRoot.__state : undefined,
                };
            });
        }
         ...
         */
        getHeaderText() {
            return _.str.sprintf(this.env._t("%s has a request"), this.env.messaging.partnerRoot.nameOrDisplayName);
        }
        ...
        _handleResponseNotificationPermission(value) {
            ...
            if (value !== "granted") {
                this.env.services["bus_service"].sendNotification(this.env._t("Permission denied"), this.env._t("Odoo will not have the permission to send native notifications on this device."));
            }
        }
