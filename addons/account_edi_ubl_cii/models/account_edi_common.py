...
class AccountEdiCommon(models.AbstractModel):
    ...
    def _import_ubl_cii_init_collected_values(self, invoice, file_data):
        tree = file_data['xml_tree']
        company = invoice.company_id
    ...
    def _import_ubl_cii_invoice_document_sign(self, collected_values):
    ...
    def _import_ubl_cii_invoice_update_move_type(self, collected_values):
    ...
    def _import_ubl_cii_retrieve_customer(self, collected_values):
        ...
        self.env['res.partner']._import_retrieve_customer(
            search_plan=self._import_ubl_cii_retrieve_customer_search_plan(collected_values),
            company=company,
    ...
    def _import_ubl_cii_create_missing_customer(self, collected_values):
        customer_values = collected_values['customer_values']
        logs = collected_values['logs']
        ...
        partner_create_values = self._import_ubl_cii_prepare_missing_customer_create_values(collected_values)
    ...
    def _import_ubl_cii_invoice_add_currency(self, collected_values):
    ...
    def _import_ubl_cii_retrieve_partner_bank(self, collected_values):
        company = collected_values['company']
    ...
    def _import_ubl_cii_invoice_retrieve_products(self, collected_values):
        company = collected_values['company']
        ...
        self.env['product.product']._import_retrieve_product(
            search_plan=self._import_ubl_cii_retrieve_products_search_plan(collected_values),
            company=company,
    ...
    def _import_ubl_cii_invoice_retrieve_product_uoms(self, collected_values): #CC
        lines_collected_values = collected_values['lines_collected_values']
        cache = {}
        for line_collected_values in lines_collected_values:
    ...
    def _import_ubl_cii_invoice_retrieve_accounts(self, collected_values):
    ...
    def _import_ubl_cii_invoice_retrieve_taxes(self, collected_values):
        company = collected_values['company']
        logs = collected_values['logs']
        lines_collected_values = collected_values['lines_collected_values']
        ...
        self.env['account.tax']._import_retrieve_tax(
            search_plan=self._import_ubl_cii_retrieve_taxes_search_plan(collected_values),
            company=company,
    ...
    def _import_ubl_cii_invoice_get_default_base_line_kwargs(self, collected_values):
        invoice = collected_values['invoice']
    ...
    def _import_ubl_cii_invoice_get_allowance_charge_line_kwargs(self, collected_values):
        ...
        base_line_kwargs = {
            **self._import_ubl_cii_invoice_get_default_base_line_kwargs(collected_values),
            'quantity': quantity,
            'price_unit': price_unit,
    ...
    def _import_ubl_cii_invoice_line_get_product_base_line_kwargs(self, collected_values):
    ...
    def _import_ubl_cii_invoice_add_base_lines(self, collected_values):
        ...
        for allowance_charge in collected_values['charges'] + collected_values['allowances']:
            base_line_kwargs = self._import_ubl_cii_invoice_get_allowance_charge_line_kwargs({
                **collected_values,
        ...
        for line_collected_values in lines_collected_values:
            ...
            # Product line.
            base_line_kwargs = self._import_ubl_cii_invoice_line_get_product_base_line_kwargs(line_collected_values)
            base_lines.append(AccountTax._prepare_base_line_for_taxes_computation(
                record=None,
                **base_line_kwargs,
            ))
    ...
    def _import_ubl_cii_invoice_write_collected_values(self, collected_values):
        invoice = collected_values['invoice']
        base_lines = collected_values['base_lines']
    ...
    def _import_ubl_cii_invoice_fix_taxes_amounts(self, collected_values):
        AccountTax = self.env['account.tax']
        invoice = collected_values['invoice']
    ...
    def _import_ubl_cii_invoice_post_processing(self, collected_values):
