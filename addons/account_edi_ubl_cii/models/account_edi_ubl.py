...
class AccountEdiUBL(models.AbstractModel):
    ...
    def _import_ubl_cii_prepare_missing_customer_create_values(self, collected_values):
        self._import_ubl_prepare_missing_customer_create_values(collected_values)
    ...
    def _import_ubl_cii_retrieve_taxes_search_plan(self, collected_values):
        return self._import_ubl_retrieve_taxes_search_plan(collected_values)
    ...
    def _import_ubl_invoice_get_default_base_line_kwargs(self, collected_values):
        return self._import_ubl_cii_invoice_get_default_base_line_kwargs(collected_values)

    def _import_ubl_invoice_line_get_product_base_line_kwargs(self, collected_values):
        return self._import_ubl_cii_invoice_line_get_product_base_line_kwargs(collected_values)

    def _import_ubl_invoice_get_allowance_charge_line_kwargs(self, collected_values):
        return self._import_ubl_cii_invoice_get_allowance_charge_line_kwargs(collected_values)
    ...
    def _import_ubl_cii_retrieve_products_search_plan(self, collected_values):
        return self._import_ubl_retrieve_products_search_plan(collected_values)
