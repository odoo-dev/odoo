...
class ResPartner(models.Model):
    ...
    def _compute_available_peppol_eas(self):
        all_eas = list(dict(self.env['res.partner']._fields['peppol_eas'].selection))
        for partner in self:
            eas_for_country = list(EAS_MAPPING.get(partner.country_code, []))
            partner.available_peppol_eas = eas_for_country or all_eas
