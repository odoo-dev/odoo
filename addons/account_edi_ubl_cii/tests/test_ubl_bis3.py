...
class TestUblBis3(AccountTestInvoicingCommon):
    ...
    def test_product_intrastat_code_old(self):
    ...
    def test_sale_order_discount_old(self):
        self.env['ir.config_parameter'].sudo().set_param('account_edi_ubl_cii.use_new_dict_to_xml_helpers', False)
    ...
    def test_beg_testcase01_minimal_invoice_old(self):
        self.env['ir.config_parameter'].sudo().set_param('account_edi_ubl_cii.use_new_dict_to_xml_helpers', False)
    ...
    def test_beg_testcase05_cash_discount(self):
        ...
        invoice.action_post()
        invoice = invoice.with_context(test_beg_testcase05_cash_discount=True)  # TODO: remove
        self.env['account.move.send']._generate_and_send_invoices(invoice, sending_methods=['manual'])
        self.assertTrue(invoice.ubl_cii_xml_id)
        ...
        if self.env['ir.config_parameter'].sudo().get_param('account_edi_ubl_cii.use_new_dict_to_xml_helpers'):
    ...
    def test_beg_testcase05_cash_discount_old(self):
        self.env['ir.config_parameter'].sudo().set_param('account_edi_ubl_cii.use_new_dict_to_xml_helpers', False)
    ...
    def test_beg_testcase06_discount_with_cash_payment(self):
        ...
        invoice = invoice.with_context(test_beg_testcase06_discount_with_cash_payment=True)  # TODO: remove
        self.env['account.move.send']._generate_and_send_invoices(invoice, sending_methods=['manual'])
        self.assertTrue(invoice.ubl_cii_xml_id)
    ...
    def test_beg_testcase10_invoice_in_usd_and_eur_vat_21(self):
        ...
        adjusted_output_tree = self.with_applied_xpath(
            ...
            <xpath expr="//*[local-name()='Delivery']/*[local-name()='DeliveryParty']/*[local-name()='PartyName']/*[local-name()='Name' and text()='Hotel Local SPRL, Delivery location name']" position="replace"
                xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"
                xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2">
    ...
    def test_beg_testcase10_invoice_in_usd_and_eur_vat_21_old(self):
        self.env['ir.config_parameter'].sudo().set_param('account_edi_ubl_cii.use_new_dict_to_xml_helpers', False)
    ...
    def test_beg_testcase11_invoice_in_usd_and_eur_vat_6_and_vat_21_old(self):
        self.env['ir.config_parameter'].sudo().set_param('account_edi_ubl_cii.use_new_dict_to_xml_helpers', False)
