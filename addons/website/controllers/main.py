...
class Website(Home):
    ...
    @http.route('/website/get_languages', type='rpc', auth="user", website=True)
    ...
    @http.route(['/website/country_infos/<model("res.country"):country>'], type='rpc', auth="public", methods=['POST'], website=True)
    ...
    @http.route('/website/get_suggested_links', type='rpc', auth="user", website=True)
    ...
    @http.route('/website/save_session_layout_mode', type='rpc', auth='public', website=True)
    ...
    @http.route('/website/snippet/filters', type='rpc', auth='public', website=True)
    ...
    @http.route('/website/snippet/options_filters', type='rpc', auth='user', website=True)
    ...
    @http.route('/website/snippet/filter_templates', type='rpc', auth='public', website=True)
    ...
    @http.route('/website/get_current_currency', type='rpc', auth="public", website=True)
    ...
    @http.route('/website/snippet/autocomplete', type='rpc', auth='public', website=True)
    ...
    @http.route('/website/get_new_page_templates', type='rpc', auth='user', website=True)
    ...
    @http.route("/website/get_switchable_related_views", type="rpc", auth="user", website=True)
    ...
    @http.route('/website/reset_template', type='rpc', auth='user', methods=['POST'])
    ...
    @http.route(['/website/seo_suggest'], type='rpc', auth="user", website=True)
    ...
    @http.route(['/website/get_seo_data'], type='rpc', auth="user", website=True)
    ...
    @http.route(['/website/check_can_modify_any'], type='rpc', auth="user", website=True)
    ...
    @http.route('/website/google_maps_api_key', type='rpc', auth='public', website=True)
    ...
    @http.route('/website/google_font_metadata', type='rpc', auth='user', website=True)
    ...
    @http.route(['/website/theme_customize_data_get'], type='rpc', auth='user', website=True)
    ...
    @http.route(['/website/theme_customize_data'], type='rpc', auth='user', website=True)
    ...
    @http.route(['/website/theme_customize_bundle_reload'], type='rpc', auth='user', website=True)
    ...
    @http.route(['/website/theme_upload_font'], type='rpc', auth='user', website=True)
