...
class WebsiteBackend(http.Controller):
    ...
    @http.route('/website/fetch_dashboard_data', type="rpc", auth='user')
    ...
    @http.route('/website/check_new_content_access_rights', type="rpc", auth='user')
    ...
    @http.route('/website/track_installing_modules', type='rpc', auth='user')
