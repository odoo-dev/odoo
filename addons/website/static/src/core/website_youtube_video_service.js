...
registry.category("services").add("youtube_video", {
    start() {
        /**
         ...
         * @param {string} src
         */
        function setupAutoplay(src, needCookiesApproval) {
         ...
         */
        function triggerAutoplay(iframeEl) {
        ...
        return { setupAutoplay, triggerAutoplay };
    }
});
