...
export class ImageHoverPlugin extends Plugin {
    ...
    resources = {
        ...
        on_after_compute_shape_handlers: async (svg, params) => {
            let rgba = null;
            let rbg = null;
            let opacity = null;
        ...
        on_hover_animation_mode_cleaned_sequential_async_handlers: this.removeHoverEffect.bind(this),
        on_hover_animation_mode_applied_sequential_async_handlers: this.setHoverEffect.bind(this),
    };
