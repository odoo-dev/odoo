...
class HighlightToolbarButton extends Component {
    ...
    static template = xml`
        <button t-custom-ref="root" t-attf-class="btn btn-light o-select-highlight {{highlightState.highlightId ? 'active' : ''}}" t-on-click="this.openHighlightConfigurator" t-att-title="this.props.title">
