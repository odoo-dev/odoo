        ...
        return {
            blockCount: {
                getValue: ({ editingElement }) => {
                    ...
                    if (!wrapper) return EcommCategoriesShowcaseOptionPlugin.DEFAULT_BLOCK_COUNT.toString();
                ...
                apply: ({ editingElement, value }) => {
                    ...
                    let removedBlocks = this.removedBlocksCache.get(editingElement) || [];
                    ...
                    if (!isPreview) {
                        this.removedBlocksCache.set(editingElement, workingRemovedBlocks);
                    }
                },
