const paletteData = {
  palettes: {
    1: {id: 1, color1: '#984c46', color2: '#23323b', color3: '#eceae4', type: 'base'},
    2: {id: 2, color1: '#B99932', color2: '#DED1C1', color3: '#F5F5F5', type: 'base'},
    3: {id: 3, color1: '#f8882f', color2: '#6a7c8f', color3: '#fdf8ef', type: 'base'},
    4: {id: 4, color1: '#6E7993', color2: '#96848C', color3: '#8F9AA2', type: 'base'},
    5: {id: 5, color1: '#F7CF41', color2: '#1A2930', color3: '#989898', type: 'base'},
    6: {id: 6, color1: '#45859A', color2: '#B57D4D', color3: '#F5F5F5', type: 'base'},
    7: {id: 7, color1: '#1a547a', color2: '#ddc76a', color3: '#D6E6F1', type: 'base'},
    8: {id: 8, color1: '#763240', color2: '#C19F7F', color3: '#FFFFFF', type: 'base'},
    9: {id: 9, color1: '#4DC5C1', color2: '#EC576B', color3: '#E5E337', type: 'base'},
    10: {id: 10, color1: '#b56355', color2: '#6ba17a', color3: '#ebe6ea', type: 'base'},
    11: {id: 11, color1: '#01ACAB', color2: '#FEDC3D', color3: '#FAE8E0', type: 'base'},
    12: {id: 12, color1: '#926190', color2: '#F3E0CD', color3: '#F9EFE9', type: 'base'},
    13: {id: 13, color1: '#478FA2', color2: '#CECECE', color3: '#E8E9E9', type: 'base'},
