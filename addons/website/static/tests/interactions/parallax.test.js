...
test.tags("desktop")("s_parallax_bg move up with positive speed", async () => {
    const { core, el } = await startInteractions(`
        <section style="height: 1000px; background-color: blue;"></section>
        <section class="parallax" data-scroll-background-ratio="2" style="min-height: 200px; z-index: -1000;">
        ...
        <section style="height: 1000px; background-color: red;"></section>
    `);
...
test.tags("desktop")("s_parallax_bg doesn't move with no speed", async () => {
    const { core, el } = await startInteractions(`
        <section style="height: 1000px; background-color: blue;"></section>
        <section class="parallax" data-scroll-background-ratio="0" style="min-height: 200px; z-index: -1000;">
            <div class="s_parallax_bg" style="background-color: green; height: 600px; overflow: hidden;">
                <div style="height: 200px;">
                    <h1>TOP</h1>
                </div>
