...
registerWebsitePreviewTour("edit_menus", {}, () => [
    ...
    },
    {
        ...
        run(helpers) {
            return helpers.drag_and_drop(".oe_menu_editor li:contains('new_menu') .form-control", {
                position: "bottom",
            });
        },
    },
    {
        ...
        run(helpers) {
            return helpers.drag_and_drop('.oe_menu_editor li:contains("new_menu") .oi-draggable', {
                position: "bottom",
            });
        },
    },
