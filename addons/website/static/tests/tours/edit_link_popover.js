...
tour.register('edit_link_popover', {
    ...
    {
        content: "Click on Break Link in Popover",
        trigger: '.o_edit_menu_popover .o_we_break_link',
    },
    {
    ...
    {
        content: "Click navbar menu Contact us",
        trigger: '#top_menu a:contains("Contact us")',
    },
    {
        content: "Popover should be shown",
        trigger: '.o_edit_menu_popover .o_we_url_link:contains("Contact Us")',
    ...
    {
        content: "Click on the Contact us menu again",
        trigger: '#top_menu a:contains("Contact us")',
    },
    {
        content: "Popover should be shown with updated preview data",
        extra_trigger: '#top_menu a:contains("Contact us")[href="/"]', // href should be changed
        trigger: '.o_edit_menu_popover .o_we_url_link:contains("Home")',
        run: function () {}, // it's a check
    },
    {
