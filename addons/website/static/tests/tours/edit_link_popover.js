...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        ...openLinkPopup(`${FIRST_PARAGRAPH} a`, "newly created", 1),
        {
        ...
        ...applyLinkAndClickBody,
        ...openLinkPopup(`${FIRST_PARAGRAPH} a`, "", 1),
        {
        ...
        ...openLinkPopup(`:iframe #o_main_nav a.btn-primary[href="/contactus"]`, "CTA"),
        {
            content: "Popover should be shown (3)",
            trigger: '.o-we-linkpopover .o_we_url_link:contains("Contact Us")',
        },
        ...openLinkPopup(`:iframe footer a[href="/"]`, "footer Home"),
        {
