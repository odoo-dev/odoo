...
registry.category("web_tour.tours").add("html_editor_language", {
    steps: () => [
        {
            content:
...
registry.category("web_tour.tours").add("html_editor_multiple_templates", {
    steps: () => [
        waitForEditMode,
        {
...
registry.category("web_tour.tours").add("test_html_editor_scss", {
    steps: () => [
...
registry.category("web_tour.tours").add("test_html_editor_scss_2", {
    steps: () => [
...
registry.category("web_tour.tours").add("test_ace_editor_is_hidden", {
    steps: () => [
        {
            trigger: ":iframe #wrapwrap",
        },
