...
class WebsiteCustom_Blocked_Third_Party_Domains(models.TransientModel):
    ...
    content = fields.Text(default=lambda s: s.env['website']._get_current_website().custom_blocked_third_party_domains)
    ...
    def action_save(self):
        ...
        self.env['website']._get_current_website().custom_blocked_third_party_domains = '\n'.join(domains)
