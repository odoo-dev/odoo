...
class TestCowViewSaving(TestViewSavingCommon, HttpCase):
    ...
    def test_view_to_translate_tag_render_template(self):
        ...
        self.assertIn('to_translate', render(self.base_view.id, 1, 'en_US', True))
        self.assertIn('translated', render(self.base_view.id, 1, 'fr_BE', True))
        ...
        # specific view with website_id
        self.assertIn('to_translate', render(specific_view.id, 1, 'en_US', True))
        self.assertIn('translated', render(specific_view.id, 1, 'fr_BE', True))
