...
class TestGetCurrentWebsite(HttpCaseWithUserDemo):
    ...
    def test_01_get_current_fallback_website_id(self):
        """Make sure `_get_current_fallback_website_id works`."""
        ...
        self.assertEqual(irHttp._get_current_fallback_website_id(''), website1.id)
        ...
        self.assertEqual(irHttp._get_current_fallback_website_id('my-site-1.fr'), website1.id)

        # CASE: domain set: get matching domain (scheme and port supported)
        self.assertEqual(irHttp._get_current_fallback_website_id('my-site-1.fr:8069'), website1.id)

        self.assertEqual(irHttp._get_current_fallback_website_id('my2ndsite.com:80'), website2.id)
        self.assertEqual(irHttp._get_current_fallback_website_id('my2ndsite.com:8069'), website2.id)
        self.assertEqual(irHttp._get_current_fallback_website_id('my2ndsite.com'), website2.id)

        # CASE: domain set, wrong domain: get first
        self.assertEqual(irHttp._get_current_fallback_website_id('test.com'), website1.id)

        # CASE: subdomain: not supported
        self.assertEqual(irHttp._get_current_fallback_website_id('www.my2ndsite.com'), website1.id)
        ...
        self.assertEqual(irHttp._get_current_fallback_website_id('site-1.com'), website1.id)
        self.assertEqual(irHttp._get_current_fallback_website_id('even-better-site-1.com'), website2.id)
        ...
        self.assertEqual(irHttp._get_current_fallback_website_id('site-1.com:80'), website1.id)
        self.assertEqual(irHttp._get_current_fallback_website_id('site-1.com:81'), website2.id)
        self.assertEqual(irHttp._get_current_fallback_website_id('site-1.com:82'), website1.id)
        self.assertEqual(irHttp._get_current_fallback_website_id('site-1.com'), website1.id)

        # CASE: Unicode domain (IDNA) support
        website2.domain = 'düsseldorf.com'
        self.assertEqual(irHttp._get_current_fallback_website_id('xn--dsseldorf-q9a.com'), website2.id)
        self.assertEqual(irHttp._get_current_fallback_website_id('düsseldorf.com'), website2.id)
