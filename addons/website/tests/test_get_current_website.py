...
class TestGetCurrentWebsite(HttpCaseWithUserDemo):
    ...
    def test_01_retrieve_website_id(self):
        """Make sure `_retrieve_website_id works`."""
        ...
        self.assertEqual(Website._retrieve_website_id(''), website1.id)
        ...
        self.assertEqual(Website._retrieve_website_id('my-site-1.fr'), website1.id)

        # CASE: domain set: get matching domain (scheme and port supported)
        self.assertEqual(Website._retrieve_website_id('my-site-1.fr:8069'), website1.id)

        self.assertEqual(Website._retrieve_website_id('my2ndsite.com:80'), website2.id)
        self.assertEqual(Website._retrieve_website_id('my2ndsite.com:8069'), website2.id)
        ...
        self.assertEqual(Website._retrieve_website_id('site-1.com'), website1.id)
        self.assertEqual(Website._retrieve_website_id('even-better-site-1.com'), website2.id)
        ...
        self.assertEqual(Website._retrieve_website_id('site-1.com:80'), website1.id)
        self.assertEqual(Website._retrieve_website_id('site-1.com:81'), website2.id)
        self.assertEqual(Website._retrieve_website_id('site-1.com:82'), website1.id)
        self.assertEqual(Website._retrieve_website_id('site-1.com'), website1.id)

        # CASE: Unicode domain (IDNA) support
        website2.domain = 'düsseldorf.com'
        self.assertEqual(Website._retrieve_website_id('xn--dsseldorf-q9a.com'), website2.id)
        self.assertEqual(Website._retrieve_website_id('düsseldorf.com'), website2.id)
