        ...
        for menu in self:
            ...
            if menu.page_id and not menu.env.user._is_internal():
                ...
                if (not page_sudo.is_visible
                    or (not page_sudo._handle_visibility(do_raise=False)
                        and page_sudo.visibility != "password")):
                    visible = False
            ...
            if menu.controller_page_id and not menu.env.user._is_internal():
                ...
                if (not controller_page_sudo.is_published
                    or (not controller_page_sudo._handle_visibility(do_raise=False)
                        and controller_page_sudo.visibility != "password")):
                    visible = False
