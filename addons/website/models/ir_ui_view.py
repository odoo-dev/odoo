    ...
    def filter_duplicate(self):
        ...
        for view in self:
            if view.website_id:
                ...
                if view.website_id.id != current_website_id:
                    continue
                most_specific_views[view.key] = view
            if view.key not in most_specific_views:
        ...
        return self.env['ir.ui.view'].union(*most_specific_views.values())
