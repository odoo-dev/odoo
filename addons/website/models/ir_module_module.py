...
class IrModuleModule(models.Model):
    ...
    _theme_translated_fields = {
        'theme.ir.ui.view': [('theme.ir.ui.view,arch', 'ir.qweb,arch_db')],
    ...
    def _check(self):
        ...
        if website_views_to_adapt:
            for view_replay in website_views_to_adapt:
                cow_view = Qweb.browse(view_replay[0])
                Qweb._load_records_write_on_cow(cow_view, view_replay[1], view_replay[2])
