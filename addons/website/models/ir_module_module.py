...
class IrModuleModule(models.Model):
    ...
    def write(self, vals):
        """
            Override to load a newly installed theme on the websites already using it.
            ...
            Upgrading a theme only refreshes its templates, it does not touch the
            websites using it: they keep the records they had until the theme is
            explicitly applied again, see ``theme.engine._theme_apply``.
        """
    ...
    def button_remove_theme(self):
        ...
        self.env['theme.engine']._theme_remove(self.env.website)
