...
class Website(models.Model):
    ...
    def call_iap_website_service(self, route, params):
        website_service_endpoint = self.env['ir.config_parameter'].sudo().get_param('website.website_service_endpoint', 'https://iap-services.odoo.com')
        ...
        def customize_page(page_code, snippet_list, pages_views):
            ...
            for snippet in snippet_list:
                try:
                    ...
                    logger.warning("View not found for key '%s'" % snippet)
