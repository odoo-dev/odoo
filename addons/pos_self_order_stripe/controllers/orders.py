...
class PosSelfOrderControllerStripe(PosSelfOrderController):
    @http.route("/pos-self-order/stripe-connection-token/", auth="public", type="rpc", website=True)
    ...
    @http.route("/pos-self-order/stripe-capture-payment/", auth="public", type="rpc", website=True)
