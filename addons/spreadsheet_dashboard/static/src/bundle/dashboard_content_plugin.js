...
<div data-name="Dashboard" class="oe_unremovable oe_unmovable"">
    <div class="oe_unremovable">
        <div class="row mw-100 mx-0">
        <div class="col o_mail_no_options o_mail_wrapper_td bg-white oe_structure o_savable oe_empty o_dirty" data-editor-message-default="true" data-editor-message="Drag blocks here" contenteditable="true">
            <section class="s_three_columns o_mail_snippet_general o_cc pt32 pb32" data-vxml="001" data-snippet="s_three_columns" data-name="Columns" contenteditable="false">
