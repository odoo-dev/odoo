...
class Company(models.Model):
    ...
    def _compute_l10n_ch_isr(self):
        ...
        for company in self:
            ...
            company.l10n_ch_isr_margin_left = float(get_param('l10n_ch.isr_margin_top', default=10))
            company.l10n_ch_isr_margin_top = float(get_param('l10n_ch.isr_margin_left', default=10))
