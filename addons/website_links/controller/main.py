...
class WebsiteUrl(http.Controller):
    @http.route('/website_links/new', type='rpc', auth='user', methods=['POST'])
    ...
    @http.route('/website_links/add_code', type='rpc', auth='user')
    ...
    @http.route('/website_links/recent_links', type='rpc', auth='user')
