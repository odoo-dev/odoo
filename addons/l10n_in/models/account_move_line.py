    ...
    def _compute_l10n_in_gstr_section(self):
        ...
        def is_b2b_rcm(line):
            return (
                ...
                (line.move_id.l10n_in_gst_treatment in ('regular', 'composition', 'uin_holders') and has_tags('gst_rc')) or
                (line.move_id.l10n_in_gst_treatment == 'special_economic_zone' and has_tags('nil'))
            )
