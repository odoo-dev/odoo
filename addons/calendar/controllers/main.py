...
class CalendarController(http.Controller):
    ...
    @http.route('/calendar/notify', type='rpc', auth="user")
    def notify(self):
        return request.env['calendar.alarm_manager'].get_next_notif()

    @http.route('/calendar/notify_ack', type='rpc', auth="user")
    def notify_ack(self):
    ...
    @http.route('/calendar/check_credentials', type='rpc', auth='user')
