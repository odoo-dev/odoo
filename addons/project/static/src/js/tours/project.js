...
registry.category("web_tour.tours").add("project_tour", {
    ...
    steps: () => [
        stepUtils.showAppsMenuItem(),
        {
            ...
            content: markup(
                _t("Want a better way to <b>manage your projects</b>? <i>It starts here.</i>")
            ),
        ...
        },
        {
            ...
            content: markup(
                _t("Choose a task <b>name</b> <i>(e.g. Website Design, Purchase Goods...)</i>")
            ),
            tooltipPosition: "right",
            run: "edit Test",
        },
        ...
        },
        {
            ...
            content: markup(
                _t("<b>Log internal notes</b> and use @<b>mentions</b> to notify your colleagues.")
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
        ...
        },
        {
            ...
            content: markup(
                _t("Create <b>activities</b> to set yourself to-dos or to schedule meetings.")
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
