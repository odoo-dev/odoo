...
class ProjectTaskTypeDeleteWizard(models.TransientModel):
    ...
    project_ids = fields.Many2many('project.project', context={'active_test': False}, ui_domain="['|', ('active', '=', False), ('active', '=', True)]", string='Projects', ondelete='cascade', export_string_translation=False)
