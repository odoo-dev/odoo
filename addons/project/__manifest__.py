...

{
    ...
    'assets': {
        ...
        'project.webclient': [
            ...
            'mail/static/src/core/web/recipient_tag.js',
            'mail/static/src/core/web/recipient_tag.xml',
            'mail/static/src/core/web/recipients_popover.js',
            'mail/static/src/core/web/recipients_popover.xml',
            'mail/static/src/core/web/recipients_input.js',
            'mail/static/src/core/web/recipients_input.xml',
            'mail/static/src/core/web/recipients_input.scss',
            'mail/static/src/core/web/recipients_input_tags_list_popover.js',
            'mail/static/src/core/web/recipients_input_tags_list_popover.xml',
