/** @odoo-module alias=snailmail.components.NotificationList.notificationGroupTests **/
...
QUnit.test('notifications grouped by notification_type', async function (assert) {
    ...
    assert.strictEqual(
        groups[0].querySelector('.o-NotificationGroup-inlineText').textContent.trim(),
    ...
    assert.strictEqual(
        groups[1].querySelector('.o-NotificationGroup-inlineText').textContent.trim(),
