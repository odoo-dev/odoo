...
class ProjectTask(models.Model):
    ...
    sale_order_id = fields.Many2one(ui_domain="['|', '|', ('partner_id', '=', partner_id), ('partner_id.commercial_partner_id.id', 'parent_of', partner_id), ('partner_id', 'parent_of', partner_id)]")
    ...
    def _compute_remaining_hours_so(self):
        ...
        mapped_remaining_hours = {task._origin.id: task.sale_line_id and task.sale_order_state == 'sale' and
    ...
    def _compute_last_sol_of_customer(self):
        ...
        for task in self:
            ...
            task.last_sol_of_customer = sol_per_domain[domain_str]
