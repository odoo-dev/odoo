...
class TestProjectBilling(TestCommonSaleTimesheet):
    ...
    def test_make_billable_at_task_rate(self):
        ...
        wizard = self.env['project.create.sale.order'].with_context(active_id=self.project_non_billable.id, active_model='project.project').create({
            'line_ids': [
                (0, 0, {'product_id': self.product_delivery_timesheet3.id, 'price_unit': self.product_delivery_timesheet3.lst_price}),
            ],
        })
    ...
    def test_customer_change_in_project(self):
        ...
        self.assertFalse(self.project_project_rate.sale_line_id, "The SOL in the project should be False because the previous SOL does not for the actual customer of the project.")
        ...
        self.assertFalse(self.project_employee_rate.sale_line_id, "The SOL in the project should be False because the previous SOL does not for the actual customer of the project.")
