    ...
    def _get_hr_res_company(self):
        return {
            self.env.company.id: {
                ...
                'account_journal_suspense_account_id': 'hr_100910',
                ...
                'default_cash_difference_income_account_id': 'hr_780000',
                'default_cash_difference_expense_account_id': 'hr_480000',
                'account_sale_tax_id': 'VAT_S_IN_ROC_25',
                'account_purchase_tax_id': 'VAT_P_IN_ROC_25',
                'expense_account_id': 'hr_400000',
                'deferred_expense_account_id': 'hr_190000',
                'income_account_id': 'hr_750000',
                'deferred_revenue_account_id': 'hr_290000',
