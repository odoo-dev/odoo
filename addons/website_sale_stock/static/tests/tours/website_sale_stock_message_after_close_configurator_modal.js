...
registry
    ...
    .add("website_sale_stock.message_after_close_onfigurator_modal_with_optional_products", {
...
registry
    .category("web_tour.tours")
    .add("website_sale_stock.message_after_close_onfigurator_modal_without_optional_products", {
        // This tour relies on a data created from the python test.
        steps: () => [
            {
                content: "Check that the stock quantity is displayed and correct",
