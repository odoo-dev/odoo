...
class ProductProduct(models.Model):
    ...
    def _get_max_quantity(self, website, sale_order, **kwargs):
        """Return the max quantity of a product. It is the difference between the quantity that's
        free to use and the quantity that's already been added to the cart.
