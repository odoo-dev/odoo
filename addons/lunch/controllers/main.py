...
class LunchController(http.Controller):
    @http.route('/lunch/infos', type='rpc', auth='user')
    ...
    @http.route('/lunch/trash', type='rpc', auth='user')
    ...
    @http.route('/lunch/pay', type='rpc', auth='user')
    ...
    @http.route('/lunch/payment_message', type='rpc', auth='user')
    def payment_message(self):
        return {'message': request.env['ir.qweb']._render('lunch.lunch_payment_dialog', {})}

    @http.route('/lunch/user_location_set', type='rpc', auth='user')
    ...
    @http.route('/lunch/user_location_get', type='rpc', auth='user')
