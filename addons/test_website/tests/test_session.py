...
class TestWebsiteSession(HttpCaseWithUserDemo):
    ...
    def test_02_inactive_session_lang(self):
        ...
        # ensure that _get_current_fallback_website_id will be able to match a website
        # if _get_current_website_id doesn't match (from forced website, cookie...)
        current_website_id = self.env["ir.http"]._get_current_fallback_website_id(odoo.tests.HOST)
