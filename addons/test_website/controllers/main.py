...
class WebsiteTest(Home):
    ...
    @http.route('/test_get_dbname', type='rpc', auth='public', website=True, sitemap=False)
    ...
    @http.route('/test_user_error_json', type='rpc', auth='public', website=True, sitemap=False)
    ...
    @http.route('/test_validation_error_json', type='rpc', auth='public', website=True, sitemap=False)
    def test_validation_error_json(self, **kwargs):
        raise ValidationError("This is a validation rpc test")

    @http.route('/test_access_error_json', type='rpc', auth='public', website=True, sitemap=False)
    ...
    @http.route('/test_missing_error_json', type='rpc', auth='public', website=True, sitemap=False)
    ...
    @http.route('/test_internal_error_json', type='rpc', auth='public', website=True, sitemap=False)
    ...
    @http.route('/test_access_denied_json', type='rpc', auth='public', website=True, sitemap=False)
