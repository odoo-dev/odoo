...
class WebsocketController(Controller):
    ...
    @route('/websocket/peek_notifications', type='rpc', auth='public', cors='*')
    ...
    @route('/websocket/update_bus_presence', type='rpc', auth='public', cors='*')
    ...
    @route("/websocket/on_closed", type="rpc", auth="public", cors="*")
