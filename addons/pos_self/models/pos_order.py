...
class PosOrder(models.Model):
    ...
    def _get_self_prefix(self, pos_config, device_type):
        raise NotImplementedError("This method should be implemented in pos_self_order module since the prefix is different between kiosk and mobile orders")
    ...
    def _check_pos_order(self, pos_config, order, device_type, table=None):
        ...
        prefix = self._get_self_prefix(pos_config, device_type)
