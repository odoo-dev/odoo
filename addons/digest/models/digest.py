...
class DigestDigestKpi(models.Model):
    ...
    value_last_24_hours = fields.Char(compute='_compute_values', groups="base.group_system")
    value_last_7_days = fields.Char(compute='_compute_values', groups="base.group_system")
    value_last_30_days = fields.Char(compute='_compute_values', groups="base.group_system")

    value_last_24_hours_margin = fields.Float(compute='_compute_values', groups="base.group_system")
    value_last_7_days_margin = fields.Float(compute='_compute_values', groups="base.group_system")
    value_last_30_days_margin = fields.Float(compute='_compute_values', groups="base.group_system")

    has_compute_error = fields.Boolean(compute='_compute_values', groups="base.group_system")
    ...
    @api.depends('digest.company_id')
    @api.depends_context('company')
    def _compute_values(self):
        for digest_kpi in self:
            kpi = digest_kpi.kpi_id.with_company(digest_kpi.digest.company_id or self.env.company)
            digest_kpi.value_last_24_hours = kpi.value_last_24_hours
            digest_kpi.value_last_7_days = kpi.value_last_7_days
            digest_kpi.value_last_30_days = kpi.value_last_30_days

            digest_kpi.value_last_24_hours_margin = kpi.value_last_24_hours_margin
            digest_kpi.value_last_7_days_margin = kpi.value_last_7_days_margin
            digest_kpi.value_last_30_days_margin = kpi.value_last_30_days_margin

            digest_kpi.has_compute_error = kpi.has_compute_error
