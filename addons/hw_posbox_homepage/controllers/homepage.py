...
class IotBoxOwlHomePage(Home):
    ...
    # ---------------------------------------------------------- #
    @http.route('/hw_posbox_homepage/six_payment_terminal_add', auth="none", type="rpc", methods=['POST'], cors='*')
    ...
    @http.route('/hw_posbox_homepage/save_credential', auth="none", type="rpc", methods=['POST'], cors='*')
    ...
    @http.route('/hw_posbox_homepage/update_wifi', auth="none", type="rpc", methods=['POST'], cors='*')
    ...
    @http.route('/hw_posbox_homepage/enable_ngrok', auth="none", type="rpc", methods=['POST'], cors='*')
    ...
    @http.route('/hw_posbox_homepage/connect_to_server', auth="none", type="rpc", methods=['POST'], cors='*')
    ...
    @http.route('/hw_posbox_homepage/log_levels_update', auth="none", type="rpc", methods=['POST'], cors='*')
