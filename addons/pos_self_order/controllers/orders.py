...
class PosSelfOrderController(http.Controller):
    @http.route("/pos-self-order/process-order/<device_type>/", auth="public", type="rpc", website=True)
    ...
    @http.route('/pos-self-order/get-orders', auth='public', type='rpc', website=True)
    ...
    @http.route('/kiosk/payment/<int:pos_config_id>/<device_type>', auth='public', type='rpc', website=True)
    ...
    @http.route('/pos-self-order/change-printer-status', auth='public', type='rpc', website=True)
