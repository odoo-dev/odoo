...
import { clickOnSave, clickOnEditAndWaitEditMode } from "@website/js/tours/tour_utils";

/**
 * Makes sure that blog are only managable by Blog Manager Group.
 */
registry.category("web_tour.tours").add("blog_manager", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("blog_no_manager", {
    steps: () => [
        {
            content: "Open create content menu.",
            trigger: ".o_menu_systray .o_new_content_container button",
