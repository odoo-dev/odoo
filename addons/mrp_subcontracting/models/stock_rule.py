...
class ProcurementGroup(models.Model):
    ...
    def _get_product_routes(self, product):
        ...
        resupply_subcontractor_routes = self.env['stock.rule'].search([('action', '=', 'pull'), ('picking_type_id.code', '=', 'internal'), ('location_src_id.is_subcontracting_location', '=', True)]).route_id
