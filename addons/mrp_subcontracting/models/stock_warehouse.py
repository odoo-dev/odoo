...
class StockWarehouse(models.Model):
    ...
    def _inverse_subcontracting_to_resupply(self):
        for warehouse in self:
            ...
            if not subcontracting_route:
                continue
            if warehouse.subcontracting_to_resupply:
    ...
    def _create_or_update_route(self):
        subcontracting_route = self._find_or_create_global_route('mrp_subcontracting.route_resupply_subcontractor_mto', _('Resupply Subcontractor on Order'))
        for warehouse in self:
            if warehouse.subcontracting_to_resupply:
                subcontracting_route.warehouse_ids = [Command.link(warehouse.id)]
