...
from odoo.addons.iot_drivers.iot_handlers.drivers.usb_interface_L import USBInterface
...
class L10nEgEdaUsbDriver(Driver):
    ...
    def __init__(self, identifier, device):
        ...
        self._actions.update({
            'l10n_eg_eta_sign_invoice': self.eta_sign,
            'l10n_eg_eta_get_certificate': self.eta_certificate,
        })
