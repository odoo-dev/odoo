...
class ProjectClient(http.Controller):
    @http.route('/mail_plugin/project/search', type='rpc', auth='outlook', cors="*")
    ...
    @http.route('/mail_plugin/task/create', type='rpc', auth='outlook', cors="*")
    ...
    @http.route('/mail_plugin/project/create', type='rpc', auth='outlook', cors="*")
