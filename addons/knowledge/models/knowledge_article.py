...
class Article(models.Model):
    ...
    def _search_user_can_write(self, operator, value):
        ...
        articles_with_no_member_access = [article_id for article_id, perm in member_permissions.items() if perm != 'write']
  ...
  GROUP BY article_id''' % (partner_id, domain)
    ...
    def _get_descendants(self):
        ...
        return self.env['knowledge.article'].search([('parent_id', 'child_of', self.ids)])
