...
class Article(models.Model):
    ...
    def _set_internal_permission(self, permission):
        ...
        current_user_member = self.article_member_ids.filtered(lambda m: m.partner_id == self.env.user.partner_id)
        if self.user_can_write and permission != "write" \
                and current_user_member and not current_user_member.permission == 'write':
