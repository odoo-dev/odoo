...
class HrAttendance(http.Controller):
    ...
    @http.route('/hr_attendance/kiosk_keepalive', auth='user', type='rpc')
    ...
    @http.route('/hr_attendance/attendance_employee_data', type="rpc", auth="public")
    ...
    @http.route('/hr_attendance/attendance_barcode_scanned', type="rpc", auth="public")
    ...
    @http.route('/hr_attendance/manual_selection', type="rpc", auth="public")
    ...
    @http.route('/hr_attendance/employees_infos', type="rpc", auth="public")
    ...
    @http.route('/hr_attendance/systray_check_in_out', type="rpc", auth="user")
    ...
    @http.route('/hr_attendance/attendance_user_data', type="rpc", auth="user")
    ...
    @http.route('/hr_attendance/is_fresh_db', type="rpc", auth="public")
    ...
    @http.route('/hr_attendance/set_user_barcode', type="rpc", auth="public")
    ...
    @http.route('/hr_attendance/set_settings', type="rpc", auth="public")
