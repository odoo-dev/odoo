...
class account_invoice(osv.osv):
    ...
    def invoice_line_move_line_get(self, cr, uid, ids, context=None):
        res = super(account_invoice,self).invoice_line_move_line_get(cr, uid, ids, context=context)
        inv = self.browse(cr, uid, ids, context=context)
        if inv and inv.company_id.anglo_saxon_accounting and inv.type in ('out_invoice','out_refund'):
