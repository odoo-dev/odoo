...
class StockValuationLayer(models.Model):
    ...
    quantity = fields.Float('Quantity', readonly=True, min_display_digits='Product Unit of Measure')
    ...
    remaining_qty = fields.Float(readonly=True, min_display_digits='Product Unit of Measure')
