...
class StockLot(models.Model):
    ...
    def action_revaluation(self):
        ...
        self.ensure_one()
        ctx = dict(self._context, default_lot_ids=self.ids, default_company_id=self.env.company.id, show_lot=self.lot_valuated, active_ids=self.stock_valuation_layer_ids.ids)
        return {
