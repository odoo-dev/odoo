    ...
    def write(self, vals):
        ...
        for product_template, (products, description, products_orig_quantity_svl) in impacted_templates.items():
            ...
            if not products.exists():
                out_svl_vals_list, products_orig_quantity_svl, new_products = Product \
                    ._svl_empty_stock(description, product_template=product_template)
            # Replenish the stock with the new cost method.
            in_svl_vals_list = new_products._svl_replenish_stock(description, products_orig_quantity_svl)
            ...
            new_products._update_lots_standard_price()
