...
class ResCompany(models.Model):
    ...
    account_stock_journal_id = fields.Many2one(
        ...
        compute=lambda self: self._compute_from_ir_default('account_stock_journal_id', 'product.category', 'property_stock_journal'),
        inverse=lambda self: self._inverse_to_ir_default('account_stock_journal_id', 'product.category', 'property_stock_journal'),
        check_company=True,
    )
    ...
    account_stock_valuation_id = fields.Many2one(
        ...
        compute=lambda self: self._compute_from_ir_default('account_stock_valuation_id', 'product.category', 'property_stock_valuation_account_id'),
        inverse=lambda self: self._inverse_to_ir_default('account_stock_valuation_id', 'product.category', 'property_stock_valuation_account_id'),
        check_company=True,
    )
    ...
    inventory_valuation = fields.Selection(
        ...
        compute=lambda self: self._compute_from_ir_default('inventory_valuation', 'product.category', 'property_valuation'),
        inverse=lambda self: self._inverse_to_ir_default('inventory_valuation', 'product.category', 'property_valuation'),
        default='periodic',
    )
    ...
    cost_method = fields.Selection(
        ...
        compute=lambda self: self._compute_from_ir_default('cost_method', 'product.category', 'property_cost_method'),
        inverse=lambda self: self._inverse_to_ir_default('cost_method', 'product.category', 'property_cost_method'),
        default='standard',
        required=True,
    )
