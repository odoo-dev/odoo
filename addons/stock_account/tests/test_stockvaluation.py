...
class TestStockValuation(TestStockValuationCommon):
    ...
    def test_average_perpetual_6(self):
        ...
        move1 = self._make_in_move(product, 1, 10, is_done=False)
        move2 = self._make_in_move(product, 1, 5, is_done=False)
    ...
    def test_average_stock_user(self):
        ...
        # sell 15
        move2 = self._make_out_move(product, 15, is_done=False)
    ...
    def test_standard_manual_2(self):
        ...
        move1 = self._make_in_move(product, 10, is_done=False)
    ...
    def test_diff_uom_quantity_update_after_done(self):
        ...
        move = self._make_in_move(product, quantity=12, is_done=False)
    ...
    def test_inventory_user_can_validate_avco_picking(self):
        ...
        """
        move = self._make_in_move(self.product_avco_auto, 1, is_done=False)
