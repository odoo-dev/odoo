...
class TestStockValuationAVCO(TestStockValuationCommon):
    ...
    def test_change_in_past_increase_in_1(self): # HERE
        # ppp(t='This will fail!')
        move1 = self._make_in_move(self.product1, 10, unit_cost=10)
        move2 = self._make_in_move(self.product1, 10, unit_cost=20)
        move3 = self._make_out_move(self.product1, 15)
        move1.move_line_ids.quantity = 15
    ...
    def test_change_in_past_add_ml_in_1(self): # HERE
        # ppp(t='This will fail!')
        move1 = self._make_in_move(self.product1, 10, unit_cost=10)
        move2 = self._make_in_move(self.product1, 10, unit_cost=20)
        move3 = self._make_out_move(self.product1, 15)
    ...
    def test_change_in_past_decrease_out_1(self):
        ...
        self.assertEqual(self._get_remaining_qty(self.product1), 10)
        self.assertEqual(self.product1.total_value, 150)
        self.assertEqual(self.product1.qty_available, 10)
        self.assertEqual(self.product1.standard_price, 15)

    def test_negative_1(self): # HERE
    ...
    def test_negative_3(self):
        ...
        move1.value_manual = 0
        move2.value_manual = -6.66

        self.assertEqual(self.product1.standard_price, 3.33)
        self.assertEqual(self.product1.total_value, 59.94)
    ...
    def test_return_delivery_1(self):
        ...
        self.assertEqual(self.product1.standard_price, 15)
        self.assertEqual(self._get_remaining_qty(self.product1), 2)
    ...
    def test_rereturn_receipt_1(self):
        ...
        self.assertEqual(self.product1.standard_price, 15)
        self.assertEqual(self._get_remaining_qty(self.product1), 1)
    ...
    def test_rounding_5(self): # HERE
        # ppp(t='This will fail! And that\'s okay.')
        return
        self.product1.categ_id.property_cost_method = 'average'
    ...
    def test_return_delivery_rounding(self): # HERE
        # ppp(t='This will fail! And that\'s okay.')
        return
        self.product1.product_tmpl_id.categ_id.property_valuation = 'periodic'
        self.product1.write({"standard_price": 1})
...
class TestStockValuationFIFO(TestStockValuationCommon):
    ...
    def test_change_in_past_increase_in_2(self): # HERE
        # ppp(t='This will fail!')
        self.product1.product_tmpl_id.categ_id.property_valuation = 'periodic'
        move1 = self._make_in_move(self.product1, 10, unit_cost=10)
    ...
    def test_change_in_past_decrease_out_1(self): # HERE
        ...
        self.assertEqual(self._get_remaining_qty(self.product1), 35)
    ...
    def test_return_delivery_1(self): # HERE
        # ppp(t='This will fail!')
        self.product1.product_tmpl_id.categ_id.property_valuation = 'periodic'
        move1 = self._make_in_move(self.product1, 10, unit_cost=10)
    ...
    def test_rereturn_receipt_1(self): # HERE
        # ppp(t='This will fail!')
        move1 = self._make_in_move(self.product1, 1, unit_cost=10, create_picking=True)
        move2 = self._make_in_move(self.product1, 1, unit_cost=20)
        move3 = self._make_out_move(self.product1, 1)
    ...
    def test_rereturn_delivery_1(self): # HERE
        # ppp(t='This will fail!')
        move1 = self._make_in_move(self.product1, 1, unit_cost=10)
        move2 = self._make_in_move(self.product1, 1, unit_cost=20)
        move3 = self._make_out_move(self.product1, 1, create_picking=True)
    ...
    def test_return_delivery_2(self): # HERE
        # ppp(t='This will fail!')
...
class TestStockValuationChangeCostMethod(TestStockValuationCommon):
    ...
    def test_avco_to_fifo(self): # HERE
        """ The accounting impact of this cost method change is neutral.
        """
        # ppp(t='This will fail!')
    ...
    def test_fifo_to_standard(self): # HERE
    ...
    def test_fifo_to_avco(self): # HERE
        """ The accounting impact of this cost method change is not neutral as we will use the last
...
class TestStockValuationChangeValuation(TestStockValuationCommon): # TODO
    @classmethod
    def setUpClass(cls):
