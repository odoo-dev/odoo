...
class HTML_Editor(http.Controller):
    ...
    @http.route(['/web_editor/get_image_info', '/html_editor/get_image_info'], type='rpc', auth='user', website=True)
    ...
    @http.route(['/web_editor/video_url/data', '/html_editor/video_url/data'], type='rpc', auth='user', website=True)
    ...
    @http.route(['/web_editor/attachment/add_data', '/html_editor/attachment/add_data'], type='rpc', auth='user', methods=['POST'], website=True)
    ...
    @http.route(['/web_editor/attachment/add_url', '/html_editor/attachment/add_url'], type='rpc', auth='user', methods=['POST'], website=True)
    ...
    @http.route(['/web_editor/modify_image/<model("ir.attachment"):attachment>', '/html_editor/modify_image/<model("ir.attachment"):attachment>'], type="rpc", auth="user", website=True)
    ...
    @http.route(['/web_editor/save_library_media', '/html_editor/save_library_media'], type='rpc', auth='user', methods=['POST'])
    ...
    @http.route(["/web_editor/generate_text", "/html_editor/generate_text"], type="rpc", auth="user")
    ...
    @http.route(["/web_editor/get_ice_servers", "/html_editor/get_ice_servers"], type='rpc', auth="user")
    def get_ice_servers(self):
        return request.env['mail.ice.server']._get_ice_servers()

    @http.route(["/web_editor/bus_broadcast", "/html_editor/bus_broadcast"], type="rpc", auth="user")
    ...
    @http.route('/html_editor/link_preview_external', type="rpc", auth="public", methods=['POST'])
    def link_preview_metadata(self, preview_url):
        return link_preview.get_link_preview_from_url(preview_url)

    @http.route('/html_editor/link_preview_internal', type="rpc", auth="user", methods=['POST'])
