...
export class DynamicFieldPlugin extends Plugin {
    ...
    resources = {
        ...
        on_model_change_handlers: this.updateDynamicModel.bind(this),
        on_normalize_handlers: withSequence(11, this.normalizeQwebPlaceholders.bind(this)),
                    ...
                    if (label !== initialLabel) {
                        ...
                        this.dependencies.history.applyCustomMutation({
                            apply: () => {
                                ...
                                this.trigger("on_dynamic_field_edit_apply_handlers", target);
                            },
                            revert: () => {
