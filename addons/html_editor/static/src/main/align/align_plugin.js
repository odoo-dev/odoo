...
export class AlignPlugin extends Plugin {
    ...
    resources = {
        ...
        on_after_undo_handlers: this.updateAlignmentParams.bind(this),
        on_after_redo_handlers: this.updateAlignmentParams.bind(this),
        on_remove_all_formats_handlers: this.setAlignment.bind(this),
