 ...
 * @typedef {((movableElement: HTMLElement) => void)[]} on_set_movable_element_handlers
 * @typedef {(() => void)[]} on_unset_movable_element_handlers
 */
...
export class MoveNodePlugin extends Plugin {
    ...
    setMovableElement(movableElement) {
        ...
        this.trigger("on_set_movable_element_handlers", movableElement);
    ...
    removeMoveWidget() {
        this.trigger("on_unset_movable_element_handlers");
