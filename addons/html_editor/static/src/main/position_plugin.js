...
export class PositionPlugin extends Plugin {
    ...
    resources = {
        // todo: it is strange that the position plugin is aware of on_external_history_step_handlers and on_history_reset_from_steps_handlers.
        on_external_history_step_handlers: this.layoutGeometryChange.bind(this),
        ...
        on_before_filter_mutation_record_handlers:
