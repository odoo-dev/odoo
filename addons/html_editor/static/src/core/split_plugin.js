...
/**
 * @typedef {(({element: HTMLElement, secondPart: HTMLElement}) => void)[]} on_after_split_element_handlers
 * @typedef {(() => void)[]} on_before_split_block_handlers
 *
...
export class SplitPlugin extends Plugin {
    ...
    // --------------------------------------------------------------------------
    splitBlock() {
        this.trigger("on_before_split_block_handlers");
    ...
    splitElement(element, offset) {
        ...
        this.trigger("on_after_split_element_handlers", { element, secondPart });
