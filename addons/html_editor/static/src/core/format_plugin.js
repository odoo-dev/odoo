 ...
 *      formatProps: object,
 *      applyStyle: boolean,
 * }) => void | boolean)[]} on_format_selection_handlers
 * @typedef {(() => void)[]} on_remove_all_formats_handlers
 *
...
export class FormatPlugin extends Plugin {
    ...
    resources = {
        ...
        on_before_set_tag_handlers: this.removeFontSizeFormat.bind(this),
    ...
    removeAllFormats() {
        ...
        this.trigger("on_remove_all_formats_handlers");
    ...
    formatSelection(formatName, options) {
        this.trigger("on_format_selection_handlers", formatName, options);
