declare module "plugins" {
    ...
    import { on_inserted_handlers, normalize_processors, before_insert_processors, on_will_set_tag_handlers, DomShared, node_to_insert_processors, system_attributes, system_classes, system_style_properties, are_inlines_allowed_at_root_predicates } from "@html_editor/core/dom_plugin";
    ...
    import { expandable_toolbar_namespaces_providers, toolbar_groups, toolbar_items, toolbar_namespace_providers, ToolbarShared } from "@html_editor/main/toolbar/toolbar_plugin";
    ...
    export interface EditorResourcesList {
        ...
        toolbar_namespace_providers: toolbar_namespace_providers;
