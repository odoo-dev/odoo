...
import { ReadonlyFileEmbeddedComponent } from "./readonly_file";

export class FileEmbeddedComponent extends ReadonlyFileEmbeddedComponent {
    static template = "html_editor.FileEmbeddedComponent";
...
export const fileEmbedding = {
    name: "file",
    Component: FileEmbeddedComponent,
    getProps: (host) => {
