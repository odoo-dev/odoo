...
export class CaptionPlugin extends Plugin {
    ...
    resources = {
        ...
        on_mount_component_handlers: this.setupNewCaption.bind(this),
        on_delete_handlers: this.afterDelete.bind(this),
        on_before_cut_handlers: this.expandSelectionToCaption.bind(this),
        on_before_drag_handlers: this.expandSelectionToCaption.bind(this),
        delete_image_overrides: this.handleDeleteImage.bind(this),
        on_after_save_media_dialog_handlers: this.onImageReplaced.bind(this),
