...
export class TableOfContentPlugin extends Plugin {
    ...
    resources = {
        ...
        restore_savepoint_handlers: this.delayedUpdateTableOfContents.bind(this),
        history_reseted_handlers: () => this.delayedUpdateTableOfContents(),
        history_reseted_from_steps_handlers: this.delayedUpdateTableOfContents.bind(this),
        step_added_handlers: ({ stepCommonAncestor }) =>
            this.delayedUpdateTableOfContents(stepCommonAncestor),
        external_step_added_handlers: this.delayedUpdateTableOfContents.bind(this),
