    ...
    handleCommand(commandName, payload) {
        switch (commandName) {
            ...
            case "CLEAN":
                ...
                break;
            // todo: shouldn't it be also called when reseting from steps?
            case "HISTORY_RESET":
        ...
        const collaborationBusListener = (payload) => {
            if (
                ...
                if (payload.notificationName === "html_field_write") {
                    ...
                    // todo: do we wait for peertopeerloading? the
                    // remoteconnection should not be loaded at this time?
                    // this.remoteConnections.handleNotification();
