...
/**
 * @typedef {((arg: { name, env, props }) => void)[]} on_mount_component_handlers
 * @typedef {(() => void)[]} on_after_mount_component_handlers
 */
...
export class EmbeddedComponentPlugin extends Plugin {
    ...
    resources = {
        /** Handlers */
        on_attribute_change_handlers: this.onChangeAttribute.bind(this),
        on_restore_savepoint_handlers: () => this.handleComponents(this.editable),
    ...
    setup() {
        ...
        // when on_start_edition_handlers are called.
    }
    ...
    mountComponent(
        ...
        this.trigger("on_mount_component_handlers", { name, env, props });
        ...
        fiber.complete = () => {
            ...
            this.trigger("on_after_mount_component_handlers");
        };
