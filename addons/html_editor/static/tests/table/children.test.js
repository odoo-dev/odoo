...
describe("tab", () => {
    test("should add a new row on press tab at the end of a table", async () => {
        ...
        const expectedContent = unformat(
            `<p data-selection-placeholder=""><br></p>
            <table>
                <colgroup><col style="width: 20px;"><col style="width: 16.5938px;"><col style="width: 15.2344px;"></colgroup>
                <tbody>
                    <tr style="height: 20px;">
                        <td style="">ab</td>
                        <td>cd</td>
    ...
    test("should not select whole text of the next cell", async () => {
        await testEditor({
            ...
            contentAfter:
                '<table><colgroup><col style="width: 20px;"><col style="width: 16.5938px;"><col style="width: 15.2344px;"></colgroup><tbody><tr style="height: 20px;"><td>ab</td><td>cd</td><td>ef[]</td></tr></tbody></table>',
        });
    });
});
