...
describe("links with inline image", () => {
    ...
    test("when link image the toolbar should disapear and only the linkpopover should be visible", async () => {
        ...
        await contains(".o-we-linkpopover input.o_we_href_input_link").edit("#");
        expect('.o-we-linkpopover a[href="https://www.hoot.test/#"]').toHaveCount(1);
        const pNode = queryOne("p");
