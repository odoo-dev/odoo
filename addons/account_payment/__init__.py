...
def post_init_hook(env):
    ...
    installed_providers = PaymentProvider.search_fetch([('module_id.state', '=', 'installed')])
...
def uninstall_hook(env):
    ...
    installed_providers = env['payment.provider'].search_fetch([('module_id.state', '=', 'installed')])
