...
class IrQweb(models.AbstractModel):
    ...
    def _compile_directive_snippet(self, el, compile_context, indent):
        ...
        div = Markup('<div name="%s" data-oe-type="snippet" data-o-image-preview="%s" data-oe-thumbnail="%s" data-oe-snippet-id="%s" data-oe-snippet-key="%s" data-oe-keywords="%s" %s %s %s %s %s %s %s>') % (
            name,
            ...
            Markup('data-oe-description="%s"') % escape_silent(' '.join(description.split())) if description else '',
