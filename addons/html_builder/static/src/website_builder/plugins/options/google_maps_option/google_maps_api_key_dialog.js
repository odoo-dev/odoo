...
export class GoogleMapsApiKeyDialog extends Component {
    ...
    setup() {
        ...
        console.warn("setup dialog", this.googleMapsService);
    }

    async onClickSave() {
        console.warn("save dialog");
        debugger;
        if (this.state.apiKey) {
            ...
            const apiKeyValidation = await this.googleMapsService.validateGMapsApiKey(this.state.apiKey);
