...
export class VisibilityPlugin extends Plugin {
    ...
    ensureSelectionVisible(selectionData) {
        const selection = selectionData.documentSelection;
        const hiddenEl = closestElement(selection.commonAncestorContainer, "[data-invisible='1']");
        if (hiddenEl) {
            this.toggleTargetVisibility(hiddenEl, true);
