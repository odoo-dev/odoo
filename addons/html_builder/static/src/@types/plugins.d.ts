declare module "plugins" {
    ...
    import { builder_header_middle_buttons, builder_options, BuilderOptionsShared, on_change_current_options_containers_handlers, clone_disabled_reason_processors, container_title, elements_to_options_title_components, get_options_container_top_buttons, has_overlay_options, keep_overlay_options, no_parent_containers, on_restore_containers_handlers, remove_disabled_reason_processors } from "@html_builder/core/builder_options_plugin";
    ...
    import { on_after_replication_handlers } from "@html_builder/core/field_change_replication_plugin";
    ...
    import { on_after_save_handlers, on_before_save_handlers, get_dirty_els, on_save_element_handlers, save_elements_overrides, on_save_handlers, SaveShared } from "@html_builder/core/save_plugin";
    import { after_setup_editor_overrides, on_before_setup_editor_handlers, savable_selectors, SetupEditorShared } from "@html_builder/core/setup_editor_plugin";
    import { target_hide, target_show, VisibilityShared } from "@html_builder/core/visibility_plugin";
    import { default_shape_providers, image_shape_groups_providers, on_after_compute_shape_handlers } from "@html_builder/plugins/image/image_shape_option_plugin";
    ...
    import { is_draggable_predicates, on_element_dragged_handlers, on_element_dropped_sequential_async_handlers, on_element_dropped_near_handlers, on_element_dropped_over_handlers, on_element_move_handlers, on_element_out_dropzone_handlers, on_element_over_dropzone_handlers, on_prepare_drag_handlers } from "@html_builder/core/drag_and_drop_plugin";
    ...
    import { snippet_preview_dialog_bundles, on_snippet_preview_dialog_stylesheets_handlers } from "@html_builder/snippets/add_snippet_dialog";
    ...
    export interface BuilderResourcesList {
        // Listeners
        on_after_replication_handlers: on_after_replication_handlers;
        on_after_save_handlers: on_after_save_handlers;
        background_shape_groups_providers: background_shape_groups_providers;
        on_before_setup_editor_handlers: on_before_setup_editor_handlers;
        on_change_current_options_containers_handlers: on_change_current_options_containers_handlers;
        ...
        on_after_compute_shape_handlers: on_post_compute_shape_handlers;
        on_snippet_preview_dialog_stylesheets_handlers: on_snippet_preview_dialog_stylesheets_handlers;
        target_hide: target_hide;
        target_show: target_show;
        on_dom_updated_handlers: on_dom_updated_handlers;

        // Handlers
        on_before_save_handlers: on_before_save_handlers;
        ...
        on_element_dropped_sequential_async_handlers: on_element_dropped_sequential_async_handlers;
        on_prepare_drag_handlers: on_prepare_drag_handlers;
        on_snippet_dropped_handlers: on_snippet_dropped_handlers;
        on_save_element_handlers: on_save_element_handlers;
        on_save_handlers: on_save_handlers;
