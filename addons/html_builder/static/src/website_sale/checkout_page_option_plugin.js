        ...
        return {
            get setExtraStep() {
                ...
                return {
                    ...websiteConfigAction,
                    apply: async (...args) => {
                        await websiteConfigAction.apply(...args);
                        await rpc("/shop/config/website", { extra_step: "true" });
                    },
                    clean: async (...args) => {
                        await websiteConfigAction.clean(...args);
                        await rpc("/shop/config/website", { extra_step: "false" });
                    },
                };
            },
        };
