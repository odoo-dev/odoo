...
export class AddElementOption extends Component {
    ...
    static props = {
        ...
        getLevel: { type: Function, optional: true },
    };
    static defaultProps = {
        level: "0",
    };
        ...
        return {
            addElText: {
                apply: (target) => {
                    ...
                    this.addElement(target.editingElement, newElement, colSize, rowSize, [
                        "col-lg-4",
                        "g-col-lg-4",
                        "g-height-2",
                    ]);
            ...
            addElImage: {
                apply: async (target) => {
                    ...
                    this.addElement(target.editingElement, newImage, colSize, rowSize, [
                        "col-lg-6",
                        "g-col-lg-6",
                        "g-height-6",
                        "o_grid_item_image",
            ...
            addElButton: {
                apply: (target) => {
                    ...
                    this.addElement(target.editingElement, newButton, colSize, rowSize, [
                        "col-lg-2",
                        "g-col-lg-2",
                        "g-height-1",
                    ]);
