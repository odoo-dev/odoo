...
patch(Navbar.prototype, {
     ...
     */
    get orderCount() {
        if (this.pos["pos.config"].module_pos_restaurant && this.pos.table) {
            return this.pos.getTableOrders(this.pos.table.id).length;
        }
        return super.orderCount;
    },
    _shouldLoadOrders() {
        return super._shouldLoadOrders() || this.pos["pos.config"].module_pos_restaurant;
    },
    onSwitchButtonClick() {
    ...
    showBackButton() {
        return (
            ...
            (this.pos.showBackButton() && this.pos["pos.config"].module_pos_restaurant)
        );
    },
});
