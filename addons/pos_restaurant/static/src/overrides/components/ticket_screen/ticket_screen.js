...
patch(TicketScreen.prototype, {
    _getScreenToStatusMap() {
        return Object.assign(super._getScreenToStatusMap(...arguments), {
            PaymentScreen: this.pos["pos.config"].set_tip_after_payment
                ? "OPEN"
    ...
    async _setOrder(order) {
        if (!this.pos["pos.config"].module_pos_restaurant || this.pos.table || !order.tableId) {
    ...
    _getOrderStates() {
        ...
        if (this.pos["pos.config"].set_tip_after_payment) {
    ...
    async onDoRefund() {
        ...
        if (this.pos["pos.config"].module_pos_restaurant && order && !this.pos.table) {
