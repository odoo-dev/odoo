...
class HrEmployeePublic(models.Model):
    ...
    phone_formatted = fields.Char(related='employee_id.phone_formatted', related_sudo=True)
    work_phone_sanitized = fields.Char(related='employee_id.work_phone_sanitized', related_sudo=True)
    work_phone_formatted = fields.Char(related='employee_id.work_phone_formatted', related_sudo=True)
    mobile_phone_sanitized = fields.Char(related='employee_id.mobile_phone_sanitized', related_sudo=True)
    mobile_phone_formatted = fields.Char(related='employee_id.mobile_phone_formatted', related_sudo=True)
    work_email = fields.Char(readonly=True)
    share = fields.Boolean(related='employee_id.share', related_sudo=True)
    phone = fields.Char(related='employee_id.phone', related_sudo=True)
    email = fields.Char(related='employee_id.email', related_sudo=True)
    ...
    tz = fields.Selection(related='resource_id.tz', related_sudo=True)
    ...
    is_subordinate = fields.Boolean(related='employee_id.is_subordinate', related_sudo=True)
    ...
    birthday_public_display_string = fields.Char("Public Date of Birth", related='employee_id.birthday_public_display_string', related_sudo=True)
