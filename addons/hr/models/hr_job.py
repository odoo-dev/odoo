...
class HrJob(models.Model):
    ...
    company_id = fields.Many2one('res.company', string='Company', default=lambda self: self.env.company, tracking=True, required=True, index=True, ui_domain=lambda self: [('id', 'in', self.env.companies.ids)])
