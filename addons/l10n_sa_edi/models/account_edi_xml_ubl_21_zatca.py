...
class AccountEdiXmlUbl_21Zatca(models.AbstractModel):
    ...
    _inherit = ['zatca.edi.common.mixin', 'account.edi.xml.ubl_21']
    ...
    def _l10n_sa_get_payment_means_code(self, invoice):
        ...
        # This could be extended to check payment journals, payment terms, etc.
    ...
    def _add_invoice_header_nodes(self, document_node, vals):
        ...
        document_node.update({
            ...
            'cbc:InvoiceTypeCode': {
                ...
                'name': self._get_invoice_type_code_name(invoice),
            },
            ...
            'cac:AdditionalDocumentReference': self._get_zatca_additional_document_references(invoice),
            'cac:Signature': self._get_zatca_signature_node(invoice),
