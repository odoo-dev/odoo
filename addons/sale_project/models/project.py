...
class Project(models.Model):
    ...
    sale_order_id = fields.Many2one(string='Sales Order', related='sale_line_id.order_id', copy=False, help="Sales order to which the project is linked.")
    ...
    def _compute_sale_line_id(self):
        self.filtered(
            lambda p:
                p.sale_line_id and (
                    not p.partner_id or p.sale_order_id.partner_id.commercial_partner_id != p.partner_id.commercial_partner_id
                )
