...
class ProjectProject(models.Model):
    ...
    def get_sale_items_data(self, offset=0, limit=None, with_action=True, section_id=None):
        ...
        return {
            ...
            } for sol_read in all_sols.with_context(with_price_unit=True)._read_format(['display_name', 'product_uom_qty', 'qty_delivered', 'qty_invoiced', 'product_uom', 'product_id'])],
