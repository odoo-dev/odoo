...
class PaymentAcquirer(models.Model):
    ...
    authorize_login = fields.Char(
        string="API Login ID", required_if_provider='authorize', groups='base.group_system')
    ...
    def action_update_merchant_details(self):
        ...
        _logger.info(f"test_authenticate request response:\n{pprint.pformat(res_content)}")
        ...
        _logger.info(f"merchant_details request response:\n{pprint.pformat(res_content)}")
        if res_content.get('err_msg'):
