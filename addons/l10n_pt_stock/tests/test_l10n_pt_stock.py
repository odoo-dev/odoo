...
class TestL10nPtStockHashing(TestL10nPtStockCommon):
    def test_l10n_pt_stock_hash_sequence(self):
        ...
        # The 1st patch is necessary because our sequence in l10n_pt_document_number has padding,
        # resulting in a value different from the one used in the link (1G 5A/1, 1G 5A/2...)
