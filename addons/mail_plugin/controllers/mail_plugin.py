...
class MailPluginController(http.Controller):
    ...
    @http.route('/mail_client_extension/modules/get', type="rpc", auth="outlook", csrf=False, cors="*")
    ...
    @http.route('/mail_plugin/partner/enrich_and_update_company', type='rpc', auth='outlook', cors='*')
    ...
    @http.route('/mail_plugin/partner/search', type="rpc", auth="outlook", cors="*")
    ...
    @http.route('/mail_plugin/log_mail_content', type="rpc", auth="outlook", cors="*")
    ...
    @http.route('/mail_plugin/get_translations', type="rpc", auth="outlook", cors="*")
