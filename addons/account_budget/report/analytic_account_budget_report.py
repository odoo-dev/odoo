...
class AnalyticAccountBudgetReport(models.AbstractModel):
    ...
    def funct(self, object, form):
        ...
        for account in object:
            ...
            for budget in budgets:
                ...
                lines = self.env['crossovered.budget.lines'].search([('id', 'in', budget_lines.ids), ('crossovered_budget_id', '=', budget.id)])
    ...
    def render_html(self, data=None):
        ...
        selected_records = self.env['account.analytic.account'].browse(data['ids'])
        docargs = {
            'doc_ids': self.ids,
