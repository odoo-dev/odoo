...
class TestLeadMerge(TestLeadMergeCommon):
    ...
    def test_merge_method_followers(self):
        ...
        self.env['mail.message'].create([{
            ...
            'date': self.env.now - timedelta(days=1),
            ...
            'model': 'crm.lead',
            'res_id': self.lead_w_email.id,
            'date': self.env.now - timedelta(days=20),
            'subtype_id': self.ref('mail.mt_comment'),
            'reply_to': False,
            'body': 'Test follower',
        }, {
            ...
            'model': 'crm.lead',
            'res_id': self.lead_w_email.id,
            'date': self.env.now - timedelta(days=15),
            'subtype_id': self.ref('mail.mt_comment'),
            'reply_to': False,
            'body': 'Test follower',
        }, {
            ...
            'date': self.env.now - timedelta(days=29),
            'subtype_id': self.ref('mail.mt_comment'),
            'reply_to': False,
            'body': 'Test follower',
        }, {
            ...
            'model': 'crm.lead',
            'res_id': self.lead_w_email.id,
            'date': self.env.now - timedelta(days=35),
            'subtype_id': self.ref('mail.mt_comment'),
            'reply_to': False,
            'body': 'Test follower',
        }, {
