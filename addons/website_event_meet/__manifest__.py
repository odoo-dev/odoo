...

{
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'website_event_meet/static/src/interactions/website_event_meeting_room.js',
            'website_event_meet/static/src/interactions/website_event_create_meeting_room_button.js',
