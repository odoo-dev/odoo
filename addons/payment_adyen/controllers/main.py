...
class AdyenController(http.Controller):
    ...
    @http.route('/payment/adyen/payment_methods', type='rpc', auth='public')
    ...
    @http.route('/payment/adyen/payments', type='rpc', auth='public')
    def adyen_payments(
    ...
    @http.route('/payment/adyen/payments/details', type='rpc', auth='public')
