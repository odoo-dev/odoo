...
class Web_Editor(http.Controller):
    ...
    #------------------------------------------------------
    @http.route('/web_editor/checklist', type='rpc', auth='user')
    ...
    #------------------------------------------------------
    @http.route('/web_editor/stars', type='rpc', auth='user')
    ...
    @http.route('/web_editor/attachment/remove', type='rpc', auth='user', website=True)
    ...
    @http.route("/web_editor/get_assets_editor_resources", type="rpc", auth="user", website=True)
    ...
    @http.route(['/web_editor/media_library_search'], type='rpc', auth="user", website=True)
