...
class RepairOrder(models.Model):
    ...
    can_create_invoice = fields.Boolean(compute='_compute_can_create_sale_or_invoice')
    ...
    can_create_sale = fields.Boolean(compute='_compute_can_create_sale_or_invoice')
