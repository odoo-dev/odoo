...
test("Tour backward when the pointed element disappear", async () => {
    ...
    class Dummy extends Component {
        ...
        static template = xml`
            ...
            <button class="foo w-100" t-if="this.state.bool" t-on-click="() => { state.bool = false; }">Foo</button>
...
test("Tour backward when the pointed element disappear and ignore warn step", async () => {
    ...
    class Dummy extends Component {
        ...
        static template = xml`
            ...
            <button class="foo" t-if="this.state.bool" t-on-click="() => { state.bool = false; }">Foo</button>
