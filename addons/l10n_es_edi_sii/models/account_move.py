...
class AccountMove(models.Model):
    ...
    def _compute_l10n_es_edi_sii_data(self):
        for move in self:
            ...
            if latest_doc.state == 'accepted':
                move.l10n_es_edi_sii_state = 'sent'
                move.l10n_es_edi_sii_error = False
            elif latest_doc.state == 'accepted_with_errors':
                move.l10n_es_edi_sii_state = 'accepted_with_errors'
                ...
                move.l10n_es_edi_sii_state = latest_doc.state
                move.l10n_es_edi_sii_error = latest_doc.response_message
