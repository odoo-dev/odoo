...
class TestValuationReconciliation(TestValuationReconciliationCommon):
    ...
    def test_fifo_multiple_products(self):
        ...
        stock_valaution_account = self.env.company.account_stock_valuation_id
        ...
        self.assertRecordValues(inv.line_ids, [
            ...
            {'account_id': stock_valaution_account.id, 'credit': 20.0, 'debit': 0.0},
            {'account_id': self.company_data['default_account_expense'].id, 'credit': 0.0, 'debit': 20.0},
            {'account_id': stock_valaution_account.id, 'credit': 20.0, 'debit': 0.0},
            {'account_id': self.company_data['default_account_expense'].id, 'credit': 0.0, 'debit': 20.0},
            {'account_id': stock_valaution_account.id, 'credit': 40.0, 'debit': 0.0},
            {'account_id': self.company_data['default_account_expense'].id, 'credit': 0.0, 'debit': 40.0},
        ])
