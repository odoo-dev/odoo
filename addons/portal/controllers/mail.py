...
class PortalChatter(http.Controller):
    ...
    @http.route("/portal/chatter_init", type="rpc", auth="public", website=True)
    ...
    @http.route('/mail/chatter_fetch', type='rpc', auth='public', website=True)
    ...
    @http.route(['/mail/update_is_internal'], type='rpc', auth="user", website=True)
