...
class AccountMove(models.Model):
    ...
    def button_request_cancel(self):
        ...
        active_myinvois_document = self.l10n_my_edi_document_ids._get_active_document()
    ...
    def _need_cancel_request(self):
        ...
        return super()._need_cancel_request() or self.l10n_my_edi_document_ids._get_active_document()

    def _get_name_invoice_report(self):
        # EXTENDS 'account'
        # Meaning we are a myinvois invoice, meaning we need to embed the qr code.
        if self.l10n_my_edi_document_ids._get_active_document():
    ...
    def _generate_myinvois_qr_code(self):
        ...
        myinvois_document = self.l10n_my_edi_document_ids._get_active_document()
