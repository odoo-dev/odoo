odoo.define('website_event_track_live.website_event_replay_suggestion', function (require) {
'use strict';
...
var WebsiteEventReplaySuggestion = Widget.extend({
    template: 'website_event_track_live.website_event_replay_suggestion',
