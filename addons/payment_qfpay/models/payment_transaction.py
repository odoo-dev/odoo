...
class PaymentTransaction(models.Model):
    ...
    def _qfpay_prepare_payment_intent_payload(self, txamt, return_url):
        """Prepare payload for creating a QFPay payment intent."""
        payload = {
            "txamt": txamt,
            "txcurrcd": self.currency_id.name,
    ...
    def _qfpay_create_payment_intent(self, txamt, return_url):
        ...
        payload = self._qfpay_prepare_payment_intent_payload(txamt, return_url)
