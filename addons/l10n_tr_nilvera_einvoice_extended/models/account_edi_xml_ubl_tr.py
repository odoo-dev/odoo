...
class AccountEdiXmlUblTr(models.AbstractModel):
    ...
    def _export_invoice_vals(self, invoice):
        ...
        if invoice.l10n_tr_gib_invoice_scenario == "IHRACAT":
    ...
    def _get_tr_profile_id(self, invoice):
        ...
        elif invoice.l10n_tr_gib_invoice_scenario == "IHRACAT":
            return invoice.l10n_tr_gib_invoice_scenario
        return "EARSIVFATURA"
    ...
    def _get_invoice_line_vals(self, line, line_id, taxes_vals):
        ...
        Adds line-level delivery details if the invoice is marked as 'IHRACAT'.
        ...
        if line.move_id.l10n_tr_gib_invoice_scenario == "IHRACAT":
    ...
    def _get_invoice_line_delivery_vals(self, line):
        ...
        return {
            ...
            "product_customs_code": line.l10n_tr_gibp_number or line.product_id.l10n_tr_gibp_number,
