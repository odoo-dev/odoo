...
class SelectPrinterWizard(models.TransientModel):
    ...
    display_printer_ids = fields.Many2many('printers.printer', relation='display_printer_id_select_printer')
    printer_ids = fields.Many2many('printers.printer', domain="[('id', 'in', display_printer_ids), ('company_id', 'in', allowed_company_ids)]")
