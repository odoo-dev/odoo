...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_rendering_values(self, processing_values):
        ...
        signature = payment_utils.generate_access_token(
            db_secret, converted_amount, self.currency_id.name, self.reference
        )
        data = {
    ...
    def _send_payment_request(self):
        """ Request the provider to execute the payment.
    ...
    def _process_feedback_data(self, data):
        ...
        :param dict data: The feedback data sent by the provider through a notification
        :return: None
        :raise: ValidationError if inconsistent data were received
        """
