...
QUnit.module("im_livechat", {}, function () {
    QUnit.module("components", {}, function () {
        ...
        QUnit.skipRefactoring(
            ...
            async function (assert) {
                ...
                const initialLivechats = document.querySelectorAll(
                    ".o_DiscussSidebarView_categoryLivechat .o_DiscussSidebarCategory_item"
                );
                assert.strictEqual(initialLivechats.length, 2, "should have 2 livechat items");
                assert.strictEqual(
                ...
                const newLivechats = document.querySelectorAll(
                    ".o_DiscussSidebarView_categoryLivechat .o_DiscussSidebarCategory_item"
                );
        ...
        QUnit.skipRefactoring(
            "call buttons should not be present on livechat",
            async function (assert) {
                assert.expect(1);
        ...
        QUnit.skipRefactoring(
            "reaction button should not be present on livechat",
            async function (assert) {
                assert.expect(1);
