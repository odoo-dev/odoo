        ...
        QUnit.module("components", {}, function () {
            QUnit.module("thread_textual_typing_status", {}, function () {
                ...
                QUnit.test('receive visitor typing status "is typing"', async function (assert) {
                    ...
                    assert.strictEqual(document.querySelector(".o_ThreadTextualTypingStatus").textContent, "", "Should display no one is currently typing");
                    ...
                    assert.strictEqual(document.querySelector(".o_ThreadTextualTypingStatus").textContent, "Visitor is typing...", "Should display that visitor is typing");
                });
            });
        });
    });
