        ...
        QUnit.module("components", {}, function () {
            QUnit.module("thread_icon", {}, function () {
                ...
                QUnit.test("livechat: public website visitor is typing", async function (assert) {
                    ...
                    assert.containsOnce(document.body, ".o_ThreadIcon .fa.fa-comments", "should have default livechat icon");
                    ...
                    assert.containsOnce(document.body, ".o_ThreadIcon_typing", "should have thread icon with visitor currently typing");
                    assert.strictEqual(document.querySelector(".o_ThreadIcon_typing").title, "Visitor is typing...", "title of icon should tell visitor is currently typing");
                });
            });
        });
    });
