odoo.define("im_livechat/static/src/models/thread/thread.js", function (require) {
    ...
    const { registerClassPatchModel, registerInstancePatchModel } = require("mail/static/src/model/model_core.js");
        ...
        convertData(data) {
            ...
            if ("livechat_visitor" in data) {
                ...
                if (!data.livechat_visitor.id) {
                    ...
                    const partner = this.env.models["mail.partner"].create(Object.assign(this.env.models["mail.partner"].convertData(data.livechat_visitor), { id: this.env.models["mail.partner"].getNextPublicId() }));
