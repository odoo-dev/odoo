...
class TestCall(HttpCase):
    def test_guest_visitor_cannot_start_call(self):
        ...
        for pseudo_user in [
            ...
            new_test_user(self.env, "internal_user", groups="base.group_user"),
            ...
            with self.assertRaises(JsonRpcException, msg="werkzeug.exceptions.Forbidden"):
