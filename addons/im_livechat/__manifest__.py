...
Help your customers with this chat, and analyse their feedback.
    ...
    'assets': {
        ...
        'web.qunit_suite_tests': [
            'im_livechat/static/src/components/discuss_sidebar_category/discuss_sidebar_category_tests.js',
            'im_livechat/static/src/components/discuss_sidebar_category_item/discuss_sidebar_category_item_tests.js',
