...
class LivechatChannelController(ChannelController):
    @route("/im_livechat/cors/channel/messages", methods=["POST"], type="rpc", auth="public", cors="*")
    ...
    @route("/im_livechat/cors/channel/mark_as_read", methods=["POST"], type="rpc", auth="public", cors="*")
    def livechat_channel_mark_as_read(self, guest_token, **kwargs):
        force_guest_env(guest_token)
        return self.discuss_channel_mark_as_read(**kwargs)

    @route("/im_livechat/cors/channel/fold", methods=["POST"], type="rpc", auth="public", cors="*")
    ...
    @route("/im_livechat/cors/channel/notify_typing", methods=["POST"], type="rpc", auth="public", cors="*")
