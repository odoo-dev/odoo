...
class CorsLivechatChatbotScriptController(LivechatChatbotScriptController):
    @route("/chatbot/cors/restart", type="rpc", auth="public", cors="*")
    ...
    @route("/chatbot/cors/answer/save", type="rpc", auth="public", cors="*")
    ...
    @route("/chatbot/cors/step/trigger", type="rpc", auth="public", cors="*")
    ...
    @route("/chatbot/cors/step/validate_email", type="rpc", auth="public", cors="*")
