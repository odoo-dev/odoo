...
class CorsLivechatController(LivechatController):
    ...
    @route("/im_livechat/cors/email_livechat_transcript", type="rpc", auth="public", cors="*")
    ...
    @route("/im_livechat/cors/get_session", methods=["POST"], type="rpc", auth="public", cors="*")
    ...
    @route("/im_livechat/cors/init", type="rpc", auth="public", cors="*")
