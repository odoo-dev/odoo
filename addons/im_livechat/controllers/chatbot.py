...
class LivechatChatbotScriptController(http.Controller):
    @http.route("/chatbot/restart", type="rpc", auth="public")
    ...
    @http.route("/chatbot/answer/save", type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/chatbot/step/trigger", type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/chatbot/step/validate_email", type="rpc", auth="public")
    @add_guest_to_context
