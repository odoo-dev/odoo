...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/init', type='rpc', auth="public")
    ...
    @http.route('/im_livechat/get_session', methods=["POST"], type="rpc", auth='public')
    @add_guest_to_context
    ...
    @http.route("/im_livechat/feedback", type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/im_livechat/history", type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/im_livechat/email_livechat_transcript", type="rpc", auth="public")
    @add_guest_to_context
    def email_livechat_transcript(self, channel_id, email):
        if channel := request.env["discuss.channel"].search([("id", "=", channel_id)]):
            channel._email_livechat_transcript(email)

    @http.route("/im_livechat/visitor_leave_session", type="rpc", auth="public")
    @add_guest_to_context
