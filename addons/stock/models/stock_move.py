...
class StockMove(models.Model):
    ...
    quantity = fields.Float(
        'Quantity', compute='_compute_quantity', min_display_digits='Product Unit', inverse='_set_quantity', store=True)
    ...
    forecast_availability = fields.Float('Forecast Availability', compute='_compute_forecast_information', min_display_digits='Product Unit', compute_sudo=True)
