...
Please change the quantity done or the rounding precision in your settings.""",
    ...
    def _get_forecast_availability_outgoing(self, warehouse, location_id=False):
        ...
        warehouse_by_location = defaultdict(lambda: warehouse.id)
        forecast_lines = self.env['stock.forecasted_product_product']._get_report_lines(False, self.product_id.ids, wh_location_query, location_id or warehouse.lot_stock_id, warehouse_by_location, read=False)
