...
class StockPicking(models.Model):
    ...
    def _compute_products_availability(self):
        ...
        for picking in pickings:
            ...
            if any(move.product_id and move.product_id.uom_id.compare(move.forecast_availability, 0 if move.state == 'draft' else move.product_qty) == -1 for move in picking.move_ids):
