...
class StockPicking(models.Model):
    ...
    def _get_autoprint_report_actions(self):
        ...
        reception_reports_to_print = self.filtered(
            lambda p: (
                p.picking_type_id.auto_show_reception_report
                and p.picking_type_id.auto_print_reception_report
        ...
        if reception_reports_to_print:
            ...
            clean_action(action, self.env)
            report_actions.append(action)
        reception_labels_to_print = self.filtered(lambda p: p.picking_type_id.auto_show_reception_report and p.picking_type_id.auto_print_reception_report_labels and p.picking_type_id.code != 'outgoing')
