...
class ProductTemplate(models.Model):
    ...
    property_stock_production = fields.Many2one(
        ...
        company_dependent=True, check_company=True, ui_domain="[('usage', '=', 'production'), '|', ('company_id', '=', False), ('company_id', '=', allowed_company_ids[0])]",
    ...
    property_stock_inventory = fields.Many2one(
        ...
        company_dependent=True, check_company=True, ui_domain="[('usage', '=', 'inventory'), '|', ('company_id', '=', False), ('company_id', '=', allowed_company_ids[0])]",
