                ...
                while orderpoints_batch:
                    ...
                    for orderpoint in orderpoints_batch:
                        ...
                        if orderpoint.uom_id.compare(orderpoint.qty_to_order, 0.0) == 1:
                            ...
                            replenishment_uom_id = orderpoint.replenishment_uom_id
                            if values.get('force_uom') and replenishment_uom_id != product_uom:
                                qty_to_order = product_uom._compute_quantity(qty_to_order, replenishment_uom_id)
                                product_uom = replenishment_uom_id
