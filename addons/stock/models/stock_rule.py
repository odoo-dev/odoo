...
class ProcurementGroup(models.Model):
    ...
    def _get_rule(self, product_id, location_id, values):
        ...
        while (not result) and location:
            ...
            result = self._search_rule(values.get('route_ids', False), product_id, values.get('warehouse_id', location.warehouse_id), domain)
    ...
    def _get_push_rule(self, product_id, location_dest_id, values):
        ...
        while (not found_rule) and location:
            ...
            found_rule = self._search_rule(values.get('route_ids'), product_id, values.get('warehouse_id'), domain)
            location = location.location_id
        return found_rule
