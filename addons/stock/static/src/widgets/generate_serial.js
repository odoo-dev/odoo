...
export class GenerateDialog extends Component {
    ...
    async _onGenerateCustomSerial() {
        const product = (await this.orm.searchRead("product.product", [["id", "=", this.props.move.data.product_id[0]]], ["serial_sequence_id"]))[0];
        this.sequence = product.serial_sequence_id;
