...
class MassMailController(http.Controller):
    ...
    @http.route('/mailing/list/update', type='rpc', auth='public', csrf=True)
    ...
    @http.route('/mailing/feedback', type='rpc', auth='public', csrf=True)
    ...
    @http.route('/mailing/blocklist/add', type='rpc', auth='public')
    ...
    @http.route('/mailing/blocklist/remove', type='rpc', auth='public')
