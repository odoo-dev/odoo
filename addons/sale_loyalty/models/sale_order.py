...
class SaleOrder(models.Model):
        ...
        for order in self:
            ...
            groups.append({
                ...
                "lines": [
                    {
                        "label": self.env._(
                            "%(points_name)s Issued", points_name=loyalty_data["point_name"]
                        ),
                    ...
                    {
                        "label": self.env._(
                            "%(points_name)s Used", points_name=loyalty_data["point_name"]
                        ),
    ...
    def _get_loyalty_data(self):
        ...
        if self.state != "sale" or not self.id:
            return False
        ...
        loyalty_history_data = (
            ...
            .sudo()
            ._read_group(
                domain=[("order_id", "=", self.id), ("order_model", "=", self._name)],
                groupby=["order_id"],
