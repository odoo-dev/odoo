...
class PosPaymentMethod(models.Model):
    ...
    dpopay_allowed_payment_modes = fields.Selection(
    ...
    def _is_write_forbidden(self, fields):
        ...
        whitelisted_fields = {'dpopay_bearer_token', 'dpopay_allowed_payment_modes'}
        return super()._is_write_forbidden(fields - whitelisted_fields)

    def _get_transaction_type(self):
        if self.dpopay_allowed_payment_modes == 'momo':
    ...
    def send_dpopay_request(self, data, endpoint):
        ...
        return self.execute_dpopay_api_request(data, endpoint)
    ...
    def _generate_dpopay_token(self):
        ...
        self.dpopay_bearer_token = access_token
        return access_token

    def execute_dpopay_api_request(self, payload, endpoint):
        self.ensure_one()
        ...
        except (ConnectionError, RequestException, Timeout, JSONDecodeError) as error:
