...
class CloudStorageMigrationReport(models.Model):
    ...
    def get_progress(self):
        max_attachment_id = int(self.env['ir.config_parameter'].get_param('cloud_storage_migration_max_attachment_id', 1))
        ...
        return min_attachment_id * 100 // max_attachment_id
