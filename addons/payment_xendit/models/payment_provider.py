...
class PaymentProvider(models.Model):
    ...
    xendit_api_key = fields.Char(string="API Key", groups='base.group_system', required_if_provider='xendit')
    xendit_webhook_token = fields.Char(string="Webbhook Token", groups='base.group_system', required_if_provider='xendit')
