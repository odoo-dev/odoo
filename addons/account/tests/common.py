...
class TestTaxCommon(AccountTestInvoicingHttpCommon):
    ...
    def _jsonify_document_line(self, document, index, line):
        ...
        if '_combo_extra_price' in line:
            base_line['_combo_extra_price'] = line['_combo_extra_price']
    ...
    def _create_py_sub_test_combo_product(self, document, line_indexes_combo_price, soft_checking):
        ...
        for line_indexes, combo_price in line_indexes_combo_price:
            sorted_line_indexes = sorted(line_indexes)
            ...
            for index, combo_base_line in zip(sorted_line_indexes, combo_base_lines):
    ...
    def _create_js_sub_test_combo_product(self, document, line_indexes_combo_price, soft_checking):
        return {
            'test': 'combo_product',
            'document': self._jsonify_document(document),
            'line_indexes_combo_price': [
                (list(line_indexes), combo_price)
                for line_indexes, combo_price in line_indexes_combo_price
            ],
            'soft_checking': soft_checking,
        }
    ...
    def assert_combo_product(self, document, line_indexes_combo_price, expected_values, soft_checking=False):
        self._create_assert_test(
            ...
            self._create_js_sub_test_combo_product,
