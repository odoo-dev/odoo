...
class PortalAccount(CustomerPortal):
    ...
    def _get_checkout_additional_identifiers_metadata(self, country, vat=False, **kwargs):
        ...
        mandatory_keys = ResPartner._filter_mandatory_additional_identifiers(
            ResPartner._get_mandatory_additional_identifiers(country, **kwargs), vat,
        )
        return {
            key: {
    ...
    def _prepare_address_form_values(self, partner_sudo, *args, **kwargs):
        ...
        if rendering_values['is_used_as_billing']:
            metadata = self._get_checkout_additional_identifiers_metadata(
                rendering_values['country'], vat=partner_sudo.vat, **kwargs,
            )
