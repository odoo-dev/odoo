...
class ResCompany(models.Model):
    ...
    income_account_id = fields.Many2one(
        ...
        compute=lambda self: self._compute_from_ir_default('income_account_id', 'product.category', 'property_account_income_categ_id'),
        inverse=lambda self: self._inverse_to_ir_default('income_account_id', 'product.category', 'property_account_income_categ_id'),
    ...
    expense_account_id = fields.Many2one(
        ...
        compute=lambda self: self._compute_from_ir_default('expense_account_id', 'product.category', 'property_account_expense_categ_id'),
        inverse=lambda self: self._inverse_to_ir_default('expense_account_id', 'product.category', 'property_account_expense_categ_id'),
        domain=ACCOUNT_DOMAIN,
    ...
    receivable_account_id = fields.Many2one(
        ...
        compute=lambda self: self._compute_from_ir_default('receivable_account_id', 'res.partner', 'property_account_receivable_id'),
        inverse=lambda self: self._inverse_to_ir_default('receivable_account_id', 'res.partner', 'property_account_receivable_id'),
        domain=[('account_type', '=', 'asset_receivable')],
    )
    payable_account_id = fields.Many2one(
        comodel_name='account.account',
        string='Payable Account',
        compute=lambda self: self._compute_from_ir_default('payable_account_id', 'res.partner', 'property_account_payable_id'),
        inverse=lambda self: self._inverse_to_ir_default('payable_account_id', 'res.partner', 'property_account_payable_id'),
