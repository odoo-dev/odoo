...
class AccountTax(models.Model):
    ...
    def _get_base_line_tax_details(self, base_line, company, rounding_method=None):
        """ Hook allowing to post-process the tax details to be added on the base line before the applicability of the multi-currency.
    ...
    def _add_tax_details_in_base_line(self, base_line, company, rounding_method=None):
        ...
        :param rounding_method: The rounding method to be used. If not specified, it will be taken from the company.
        """
        taxes_computation = self._get_base_line_tax_details(base_line, company, rounding_method=rounding_method)
        rate = base_line['rate']
