...
class AccountJournal(models.Model):
    ...
    def _fill_sale_purchase_dashboard_data(self, dashboard_data):
        ...
        bills_field_list = [
            ...
            "(CASE WHEN account_move.move_type IN ('out_refund', 'in_refund') THEN -1 ELSE 1 END) * account_move.amount_total::float AS amount_total",
            "(CASE WHEN account_move.move_type IN ('in_invoice', 'in_refund', 'in_receipt') THEN -1 ELSE 1 END) * account_move.amount_total_signed::float AS amount_total_company",
