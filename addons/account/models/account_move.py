...
class AccountMove(models.Model):
    ...
    def _autopost_draft_entries(self, batch_size=100):
        ...
        '''
        api.process.cron_implementation(self.with_context(_post_batch_size=batch_size), '_post')
    ...
    def _cron_account_move_send(self, job_count=10):
        ...
        api.process.cron_implementation(
            self.with_context(_generate_and_send_invoices_batch_size=job_count, from_cron=True),
    ...
    _generate_and_send_invoices_batch_size = 10
