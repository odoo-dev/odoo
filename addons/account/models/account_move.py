...
class AccountMove(models.Model):
    ...
    move_sending_status = fields.Selection(
        selection=[
            ('sent', "Sent"),
            ('not_sent', "Not Sent"),
        ],
        compute='_compute_move_sending_status',
        copy=False,
    )
    ...
    def _compute_move_sending_status(self):
        for move in self:
            move.move_sending_status = 'sent' if move.is_move_sent else 'not_sent'
