        ...
        for account in self:
            if formatted_display_name:
                account.display_name = (
                    f"""{(self.env.has_group('account.group_account_readonly') and account.code) or ''} {account.name_path}"""
                ...
                account.display_name = f"{account.code} {account.name}" if account.code and self.env.has_group('account.group_account_readonly') else account.name
