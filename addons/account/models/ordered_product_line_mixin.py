...
class OrderedProductLine(models.AbstractModel):
    ...
    #  * display_type : section field with 'line_section', 'line_subsection' & 'line_note'
    #  could have been specified in the mixin but requires tricks for the AML display_type field.
