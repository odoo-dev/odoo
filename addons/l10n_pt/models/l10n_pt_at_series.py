...
class L10nPtATSeries(models.Model):
    ...
    name = fields.Char("Name of the Series", required=True, help="The name of the series will be part of the sequence of the document name.")
        ...
        for series in self:
            if not re.match(r'^[a-zA-Z0-9]+$', series.name):
                raise ValidationError(_(
                    "The name of the series (%s) is invalid. It must consist of only letters and numbers (e.g. INV, RINV).",
                    series.name
                ))
