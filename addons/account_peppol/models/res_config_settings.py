...
class ResConfigSettings(models.TransientModel):
    ...
    def button_create_peppol_proxy_user(self):
        ...
        register_sender_only = should_offer_sender_only and self.env.context.get('account_peppol_register_sender_only')

        if should_offer_sender_only and not register_sender_only:
            error_msg = _(
