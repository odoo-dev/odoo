...
class ResCompany(models.Model):
    ...
    def _get_peppol_edi_mode(self, temporary_eas=False):
        ...
        peppol_user = self.sudo().account_edi_proxy_client_ids.filtered(lambda u: u.active and u.proxy_type in self.env['account_edi_proxy_client.user']._get_peppol_proxy_types())
