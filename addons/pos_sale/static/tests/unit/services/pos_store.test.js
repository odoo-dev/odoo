...
describe("pos_sale > pos_store: onClickSaleOrder", () => {
    test.tags("pos");
    ...
    test("dpPercentage → calls downPaymentSO", async () => {
        ...
        expect(currentOrder.lines[2].product_id.id).toBe(7);
        ...
        const comp = await mountWithCleanup(Orderline, { props: { line: currentOrder.lines[2] } });
