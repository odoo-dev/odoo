...
describe("pos_sale > models/pos_order_line: getSaleOrder", () => {
    test.tags("pos");
...
describe("pos_sale > models/pos_order_line: saleDetails", () => {
    test.tags("pos");
...
describe("pos_sale > models/pos_order_line: setQuantityFromSOL", () => {
    test.tags("pos");
