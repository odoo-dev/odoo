...
class PurchaseOrderLine(models.Model):
    ...
    product_qty = fields.Float(string='Quantity', min_display_digits='Product Unit of Measure', required=True,
    ...
    qty_invoiced = fields.Float(compute='_compute_qty_invoiced', string="Billed Qty", min_display_digits='Product Unit of Measure', store=True)
    ...
    qty_received = fields.Float("Received Qty", compute='_compute_qty_received', inverse='_inverse_qty_received', compute_sudo=True, store=True, min_display_digits='Product Unit of Measure')
    qty_received_manual = fields.Float("Manual Received Qty", min_display_digits='Product Unit of Measure', copy=False)
