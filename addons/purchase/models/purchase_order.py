    ...
    def _add_supplier_to_product(self):
        ...
        for line in self.order_line:
            ...
            if line.product_id and not already_seller and len(line.product_id.seller_ids) <= 10:
                ...
                if not seller_vals:
                    supplierinfo['product_id'] = line.product_id.id if line.product_id.product_variant_count > 1 else False
        ...
        for template_id, vals in vals_by_template.items():
            ...
            # Skip creation if a template-level pricelist already exists for this partner
            if already_seller and not vals['seller_ids'][0].get('product_id'):
                continue
