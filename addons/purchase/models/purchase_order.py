...
class PurchaseOrder(models.Model):
    ...
    def _get_product_catalog_seller_data(self, product, *, uom=None, **kwargs):
        ...
        if self.partner_id:
            ...
            if not seller and not product._has_vendor_pricelist(self.partner_id, self.company_id):
                seller = product._get_last_po_supplierinfo(self.partner_id, self.company_id)
            if seller:
