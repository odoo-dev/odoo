...
class TestPurchaseToInvoice(TestPurchaseToInvoiceCommon):
    ...
    def test_import_bill_from_attachment_ignores_purchase_auto_complete(self):
        """
        Ensure that bills created from attachments do not trigger the purchase auto-complete.
