...
class CustomerPortal(portal.CustomerPortal):
    ...
    @route(['/my/orders/<int:order_id>/update_line_dict'], type='rpc', auth="public", website=True)
    ...
    @route(["/my/orders/<int:order_id>/add_option/<int:option_id>"], type='rpc', auth="public", website=True)
