...
# This edi_format is "abstract" meaning that it provides an additionnal layer for similar edi_format (formats deriving from
...
class AccountEdiFormat(models.Model):
    ...
    def _get_ubl_values(self, invoice):
        ...
        for line in invoice.invoice_line_ids.filtered(lambda line: not line.display_type):
            ...
            line_taxes = line.tax_ids._origin.compute_all(
