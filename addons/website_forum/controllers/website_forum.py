...
class WebsiteForum(WebsiteProfile):
    ...
    @http.route('/forum/get_url_title', type='rpc', auth="user", methods=['POST'], website=True)
    ...
    @http.route('/forum/<model("forum.forum"):forum>/question/<model("forum.post"):question>/toggle_favourite', type='rpc', auth="user", methods=['POST'], website=True)
    ...
    @http.route('/forum/<model("forum.forum"):forum>/post/<model("forum.post"):post>/toggle_correct', type='rpc', auth="user", website=True)
    ...
    @http.route('/forum/<model("forum.forum"):forum>/post/<model("forum.post"):post>/upvote', type='rpc', auth="user", website=True)
    ...
    @http.route('/forum/<model("forum.forum"):forum>/post/<model("forum.post"):post>/downvote', type='rpc', auth="user", website=True)
    ...
    @http.route('/forum/<model("forum.forum"):forum>/post/<model("forum.post"):post>/flag', type='rpc', auth="user", website=True)
    def post_flag(self, forum, post, **kwargs):
        return post._flag()[0]

    @http.route('/forum/<model("forum.post"):post>/ask_for_mark_as_offensive', type='rpc', auth="user", website=True)
    ...
    @http.route('/forum/<model("forum.forum"):forum>/post/<model("forum.post"):post>/comment/<model("mail.message"):comment>/delete', type='rpc', auth="user", website=True)
