...
class MailActivityMixin(models.AbstractModel):
    ...
    def _get_call_log_priority_domains(self):
        ...
        A tier matching nothing is left out, so that a model about no partner at all ranks
        nothing and is searched exactly as it would be without a call being logged.
