...
class MailUserSettings(models.Model):
    ...
    def mail_user_settings_format(self):
        ...
        return {
            'id': self.id,
            'is_discuss_sidebar_category_channel_open': self.is_discuss_sidebar_category_channel_open,
            'is_discuss_sidebar_category_chat_open': self.is_discuss_sidebar_category_chat_open,
            'push_to_talk_key': self.push_to_talk_key,
            'voice_active_duration': self.voice_active_duration,
            'use_push_to_talk': self.use_push_to_talk,
            'volume_settings': self.volume_settings_ids.read(),
        }
