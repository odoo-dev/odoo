...
class Channel(models.Model):
        ...
        for channel in self:
            ...
            if self.env.user and self.env.user.partner_id:
                ...
                if partner_channel:
                    ...
                    info['members'] = partner_channel.mail_channel_partner_format(partner_infos)
            ...
            if channel.channel_type != 'channel':
                ...
                info['members'] = channel_partners.mail_channel_partner_format(partner_infos)
            if channel.channel_type != 'channel':
    ...
    def channel_rename(self, name):
        self.ensure_one()
        if self.channel_type == 'chat':
            domain = [('partner_id', '=', self.env.user.partner_id.id), ('channel_id.id', '=', self.id)]
            channel_partners = self.env['mail.channel.partner'].search(domain, limit=1)
            channel_partners.write({'custom_channel_name': name})
