   ...
   Only allowed people can contact us at this address.</p>
        ...
        if alias:
            ...
            if check_result is not True:
                ...
                self._routing_create_bounce_email(email_from, check_result.get('error_template', _generic_bounce_body_html.format(to=alias.display_name.lower(), body=message_dict.get('body'))), message)
                return False
