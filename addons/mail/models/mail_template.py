...
class MailTemplate(models.Model):
    ...
    @api.model
    def _merge_partner_fields(self, rendered):
        """ Merge rendered partner values from _generate_template for code not handling partner_cc_ids. """
    ...
    def send_mail_batch(self, res_ids, force_send=False, raise_exception=False, email_values=None,
        ...
        for res_ids_chunk in tools.split_every(batch_size, res_ids):
            ...
            values_list = [self._merge_partner_fields(res_ids_values[res_id]) for res_id in res_ids_chunk]
