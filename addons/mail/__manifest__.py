...

{
    ...
    'qweb': [
        ...
        'static/src/components/partner_selector/partner_selector.xml',
        'static/src/components/selectable_partner/selectable_partner.xml',
        'static/src/components/selectable_partners_list/selectable_partners_list.xml',
        ...
        'static/src/components/top_bar/top_bar.xml',
