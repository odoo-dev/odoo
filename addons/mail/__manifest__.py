...

{
    ...
    'qweb': [
        ...
        'static/src/owl/components/activity/activity.xml',
        'static/src/owl/components/activity_box/activity_box.xml',
        'static/src/owl/components/activity_mark_done_popover/activity_mark_done_popover.xml',
        ...
        'static/src/owl/components/moderation_ban_dialog/moderation_ban_dialog.xml',
        'static/src/owl/components/moderation_discard_dialog/moderation_discard_dialog.xml',
        'static/src/owl/components/moderation_reject_dialog/moderation_reject_dialog.xml',
        ...
        'static/src/owl/components/popover_button/popover_button.xml',
