...

{
    ...
    'qweb': [
        ...
        'static/src/components/category/category.xml',
        'static/src/components/category_item/category_item.xml',
        'static/src/components/category_title/category_title.xml',
        'static/src/components/category_channel_item/category_channel_item.xml',
        'static/src/components/category_channel_title/category_channel_title.xml',
        'static/src/components/category_chat_item/category_chat_item.xml',
        'static/src/components/category_chat_title/category_chat_title.xml',
