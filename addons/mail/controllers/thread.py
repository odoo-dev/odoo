...
class ThreadController(http.Controller):
    @http.route("/mail/thread/data", methods=["POST"], type="rpc", auth="public")
    ...
    @http.route("/mail/thread/messages", methods=["POST"], type="rpc", auth="user")
    ...
    @http.route("/mail/partner/from_email", methods=["POST"], type="rpc", auth="user")
    ...
    @http.route("/mail/read_subscription_data", methods=["POST"], type="rpc", auth="user")
    ...
    @http.route("/mail/message/post", methods=["POST"], type="rpc", auth="public")
    ...
    @http.route("/mail/message/update_content", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
