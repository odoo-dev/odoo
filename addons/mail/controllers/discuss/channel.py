...
class ChannelController(http.Controller):
    @http.route("/discuss/channel/members", methods=["POST"], type="rpc", auth="public", readonly=True)
    ...
    @http.route("/discuss/channel/update_avatar", methods=["POST"], type="rpc")
    ...
    @http.route("/discuss/channel/info", methods=["POST"], type="rpc", auth="public", readonly=True)
    @add_guest_to_context
    ...
    @http.route("/discuss/channel/messages", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/discuss/channel/pinned_messages", methods=["POST"], type="rpc", auth="public", readonly=True)
    @add_guest_to_context
    ...
    @http.route("/discuss/channel/mark_as_read", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/discuss/channel/mark_as_unread", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/discuss/channel/notify_typing", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/discuss/channel/attachments", methods=["POST"], type="rpc", auth="public", readonly=True)
    @add_guest_to_context
    ...
    @http.route("/discuss/channel/fold", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/discuss/channel/join", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/discuss/channel/sub_channel/create", methods=["POST"], type="rpc", auth="public")
    ...
    @http.route("/discuss/channel/sub_channel/fetch", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
