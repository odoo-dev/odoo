...
class DiscussGifController(Controller):
    ...
    @route("/discuss/gif/search", type="rpc", auth="user")
    ...
    @route("/discuss/gif/categories", type="rpc", auth="user", readonly=True)
    ...
    @route("/discuss/gif/add_favorite", type="rpc", auth="user")
    ...
    @route("/discuss/gif/favorites", type="rpc", auth="user", readonly=True)
    ...
    @route("/discuss/gif/remove_favorite", type="rpc", auth="user")
