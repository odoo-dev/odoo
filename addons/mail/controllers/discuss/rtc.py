...
class RtcController(http.Controller):
    @http.route("/mail/rtc/session/notify_call_members", methods=["POST"], type="rpc", auth="public")
    ...
    @http.route("/mail/rtc/session/update_and_broadcast", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/mail/rtc/channel/join_call", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/mail/rtc/channel/leave_call", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/mail/rtc/channel/cancel_call_invitation", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
    ...
    @http.route("/discuss/channel/ping", methods=["POST"], type="rpc", auth="public")
    @add_guest_to_context
