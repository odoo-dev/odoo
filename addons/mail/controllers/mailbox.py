...
class MailboxController(http.Controller):
    @http.route("/mail/inbox/messages", methods=["POST"], type="rpc", auth="user")
    ...
    @http.route("/mail/history/messages", methods=["POST"], type="rpc", auth="user")
    ...
    @http.route("/mail/starred/messages", methods=["POST"], type="rpc", auth="user")
