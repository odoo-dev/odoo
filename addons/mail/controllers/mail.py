...
class MailController(http.Controller):
    ...
    #Adapt the code to make it work with Material Symbol library
    def export_icon_to_png(self, icon, color='#000', bg=None, size=100, alpha=255, font='fontawesome/fonts/fontawesome-webfont.ttf', width=None, height=None):
