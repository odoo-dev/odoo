...
QUnit.test('default', async function (assert) {
    ...
    assert.strictEqual(
        message
            ...
            .dataset
            .src,
        '/web/image/res.partner/7/image_64',
...
QUnit.test('deleteAttachment', async function (assert) {
    // crash at the end because of this
    // https://github.com/odoo/owl/issues/268
    assert.expect(2);
    ...
    await this.store.dispatch('_updateAttachment', attachmentLocalId, {
