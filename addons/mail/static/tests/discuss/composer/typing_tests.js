...
import { LONG_TYPING, SHORT_TYPING } from "@mail/discuss/composer/composer";
import { OTHER_LONG_TYPING } from "@mail/discuss/core/messaging_service";
...
QUnit.test("chat: correspondent is typing", async (assert) => {
    ...
    assert.containsOnce($, ".o-mail-ThreadIcon-online");
