...
Multi line text`;
    ...
    expect(result).toEqual([
        ...
        { startTime: 5, endTime: 9, text: "Second line\nMulti line text" },
    ]);
});
...
Short timestamp`;
    ...
    const result = parseTimedText(vtt);
    expect(result).toEqual([{ startTime: 1, endTime: 4, text: "Short timestamp" }]);
});
...
Hello world`;
    ...
    const result = parseTimedText(srt);
    expect(result).toEqual([{ startTime: 1, endTime: 4, text: "Hello world" }]);
});
