...
test("[text composer] mention a channel thread", async () => {
    ...
    await contains(".o-mail-Composer-suggestion:eq(0):has(i[data-icon='tag']):text('General')");
    await contains(
        ".o-mail-Composer-suggestion:eq(1):has(i[data-icon='forum']):text('GeneralThreadOne')"
    );
    await click(".o-mail-Composer-suggestion:eq(1)");
    await contains(".o-mail-Composer-input", { value: "#General > ThreadOne " });
    await press("Enter");
    await contains(
        ".o-mail-Message a.o_channel_redirect:has(i[data-icon='forum']):text('General > ThreadOne')"
    );
...
test("mention a channel thread", async () => {
    ...
    await contains(
        ".o-mail-Composer-html.odoo-editor-editable a.o_channel_redirect:has(i[data-icon='tag']):text('General')"
    );
    await press("Enter");
    await contains(".o-mail-Message a.o_channel_redirect:text('General')");
    await contains(".o-mail-Composer-html.odoo-editor-editable");
    await focus(".o-mail-Composer-html.odoo-editor-editable");
    await htmlInsertText(editor, "#");
    await contains(".o-mail-Composer-suggestion", { count: 2 });
    ...
    await click(".o-mail-Composer-suggestion:eq(1)");
    await contains(
        ".o-mail-Composer-html.odoo-editor-editable a.o_channel_redirect:has(i[data-icon='forum']):text('General > ThreadOne')"
    );
    await press("Enter");
    await contains(
        ".o-mail-Message a.o_channel_redirect:has(i[data-icon='forum']):text('General > ThreadOne')"
