...
QUnit.module("mail", {}, function () {
    QUnit.module("components", {}, function () {
        ...
        QUnit.skipRefactoring("basic rendering", async function (assert) {
            ...
            await openDiscuss();
            assert.strictEqual(
                document.querySelectorAll(".o_DiscussView_sidebar").length,
                1,
                "should have a sidebar section"
            );
            assert.strictEqual(
                document.querySelectorAll(".o_DiscussView_content").length,
                1,
                "should have content section"
            );
            assert.strictEqual(
                document.querySelectorAll(".o_DiscussView_thread").length,
                1,
                "should have thread section inside content"
            );
            assert.ok(
                document.querySelector(".o_DiscussView_thread").classList.contains("o_ThreadView"),
        ...
        QUnit.skipRefactoring("basic rendering: sidebar", async function (assert) {
            ...
            .o_DiscussSidebarView_categoryMailbox .o_DiscussSidebarMailboxView
        `).length,
                3,
        ...
        `).length,
            ...
            assert.strictEqual(
                document.querySelectorAll(`.o_DiscussView_sidebar .o_DiscussSidebarView_separator`)
                    .length,
                2,
    ...
    `);
            ...
            assert.strictEqual(
                inbox.querySelectorAll(`:scope .o_DiscussSidebarMailboxView_name`).length,
                1,
                "mailbox should have a name"
            );
            assert.strictEqual(
                inbox.querySelector(`:scope .o_DiscussSidebarMailboxView_name`).textContent,
                "Inbox",
            ...
            assert.strictEqual(
                document.querySelectorAll(`
            .o_DiscussSidebarMailboxView[data-mailbox-local-id="${messaging.inbox.localId}"]
            .o_DiscussSidebarMailboxView_counter
        `).length,
                0,
    ...
    `);
            ...
            assert.notOk(channel.classList.contains("o-active"), "should not be active by default");
            assert.strictEqual(
            ...
            assert.strictEqual(
                document.querySelectorAll(`.o_DiscussView_thread .o_ThreadView_composer`).length,
                1,
    ...
    `);
        ...
        `
            ...
            assert.strictEqual(
                document.querySelectorAll(`
            .o_DiscussView_thread .o_ThreadView_messageList .o_MessageListView_empty
        `).length,
                1,
    ...
    `);
        ...
        `).length,
            ...
            assert.strictEqual(
                document
                    .querySelector(`.o_DiscussView_thread .o_MessageListView_empty`)
                    .textContent.trim(),
    ...
    `);
            ...
            assert.strictEqual(
                document.querySelector(`.o_DiscussView_thread .o_ThreadView_messageList`).scrollTop,
                0,
    ...
    `);
            ...
            assert.ok(
                msg1
                    .querySelector(`:scope .o_MessageView_authorAvatar`)
                    .classList.contains("o_redirect"),
                "message1 should have redirect to author"
            );

            await afterNextRender(() =>
                msg1.querySelector(`:scope .o_MessageView_authorAvatar`).click()
            );
            assert.notOk(
                document
                    .querySelector(
        ...
        QUnit.skipRefactoring("sidebar quick search", async function (assert) {
            ...
            assert.strictEqual(
                document.querySelectorAll(
                    `.o_DiscussView_sidebar input.o_DiscussSidebarView_quickSearch`
                ).length,
                1,
    ...
    `);
        ...
        `).textContent,
            ...
            const markAllReadButton = document.querySelector(
                `.o_ThreadViewTopbar_markAllReadButton`
            );
            assert.isVisible(
                markAllReadButton,
    ...
    `);
        ...
        QUnit.skipRefactoring("rendering of inbox message", async function (assert) {
            ...
            assert.strictEqual(
                message.querySelector(`:scope .o_MessageView_originThread`).textContent,
                " on Refactoring",
    ...
    `);
        ...
        QUnit.skipRefactoring("auto-focus composer on opening thread", async function (assert) {
            ...
            assert.strictEqual(
                document.querySelectorAll(`
            .o_DiscussSidebarMailboxView[data-mailbox-name="Inbox"]
        `).length,
                1,
