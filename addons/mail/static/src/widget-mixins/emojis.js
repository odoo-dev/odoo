/** @odoo-module alias=mail.widgetMixins.emojis **/
 ...
 *
 * Methods are based on the collections of emojis available in mail.utils.emojis
 *
 */
export default {
    //--------------------------------------------------------------------------
    ...
    _onEmojiClick(ev) {
        ...
        const textInput = this._getTargetTextElement($(ev.currentTarget))[0];
    ...
    /**
     * Will use the mail.utils.emojis library to wrap emojis unicode around a span with a special font
