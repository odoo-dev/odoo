odoo.define("mail/static/src/models/follower.follower.js", function (require) {
    ...
    function factory(dependencies) {
        class Follower extends dependencies["mail.model"] {
             ...
             */
            async showSubtypes() {
                const subtypesData = await this.async(() =>
                    this.env.services.rpc({
                ...
                for (const data of subtypesData) {
                    const subtype = this.env.models["mail.follower_subtype"].insert(this.env.models["mail.follower_subtype"].convertData(data));
        ...
        Follower.fields = {
            resId: attr({
                ...
                default: 0,
                dependencies: ["channelId", "partnerId"],
            }),
            ...
            name: attr({
                ...
                dependencies: ["channelName", "partnerName"],
            }),
            ...
            resModel: attr({
                ...
                default: "",
                dependencies: ["channelModel", "partnerModel"],
            }),
