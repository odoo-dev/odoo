    ...
    function factory(dependencies) {
        class DialogManager extends dependencies["mail.model"] {
            ...
            unregister(dialog) {
                ...
                this.update({
                    _ordered: this._ordered.filter((dialogLocalId) => dialogLocalId !== dialog.localId),
             ...
             */
            _computeAllOrdered() {
                return [["replace", this._ordered.map((dialogLocalId) => this.env.models["mail.dialog"].get(dialogLocalId))]];
            }
        }
