    ...
    function factory(dependencies) {
        ...
        class Attachment extends dependencies["mail.model"] {
            ...
            _computeComposers() {
                ...
                const relatedTemporaryAttachment = this.env.models["mail.attachment"].find((attachment) => attachment.filename === this.filename && attachment.isTemporary);
            ...
            _computeFileType() {
                ...
                const match = this.type === "url" ? this.url.match("(youtu|.png|.jpg|.gif)") : this.mimetype.match("(image|video|application/pdf|text)");
                if (!match) {
                    return undefined;
                }
             ...
             */
            _computeIsViewable() {
                return this.mediaType === "image" || this.mediaType === "video" || this.mimetype === "application/pdf" || this.isTextFile;
            }
        ...
        Attachment.fields = {
            ...
            defaultSource: attr({
                ...
                dependencies: ["checkSum", "fileType", "id", "url"],
            }),
            displayName: attr({
            ...
            fileType: attr({
                ...
                dependencies: ["mimetype", "type", "url"],
            }),
            id: attr({
                compute: "_computeId",
            ...
            isViewable: attr({
                ...
                dependencies: ["mediaType", "isTextFile", "mimetype"],
            }),
            mediaType: attr({
