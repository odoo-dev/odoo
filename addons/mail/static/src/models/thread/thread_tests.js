        ...
        QUnit.module("models", {}, function () {
            QUnit.module("thread", {}, function () {
                ...
                QUnit.test("create (channel)", async function (assert) {
                    ...
                    assert.notOk(this.env.models["mail.thread"].find((thread) => thread.id === 100 && thread.model === "mail.channel"));
                    ...
                    assert.ok(this.env.models["mail.thread"].find((thread) => thread.id === 100 && thread.model === "mail.channel"));
                    ...
                    assert.strictEqual(
                        thread,
                        this.env.models["mail.thread"].find((thread) => thread.id === 100 && thread.model === "mail.channel")
                    );
                ...
                QUnit.test("create (chat)", async function (assert) {
                    ...
                    assert.notOk(this.env.models["mail.thread"].find((thread) => thread.id === 200 && thread.model === "mail.channel"));
                    ...
                    assert.ok(channel);
                    assert.ok(this.env.models["mail.thread"].find((thread) => thread.id === 200 && thread.model === "mail.channel"));
                    ...
                    assert.strictEqual(
                        channel,
                        this.env.models["mail.thread"].find((thread) => thread.id === 200 && thread.model === "mail.channel")
                    );
