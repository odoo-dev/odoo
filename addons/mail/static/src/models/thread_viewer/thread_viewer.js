    ...
    function factory(dependencies) {
        class ThreadViewer extends dependencies["mail.model"] {
            ...
            _updateAfter(previous) {
                ...
                if (this.thread && this.threadCache.isLoading && !this.isShowingLoading && !this._isPreparingLoading) {
        ...
        ThreadViewer.fields = {
            ...
            threadCache: many2one("mail.thread_cache", {
                ...
                dependencies: ["stringifiedDomain", "thread", "threadCaches"],
            }),
            threadCacheInitialPosition: attr({
                compute: "_computeThreadCacheInitialPosition",
                dependencies: ["threadCache", "threadCacheInitialScrollPositions"],
            }),
            /**
