    ...
    class MessagingNotificationHandler extends dependencies['mail.model'] {
        ...
        _handleNotificationCategoryStates(data) {
            if ('is_category_channel_open' in data) {
                this.env.messaging.discuss.categoryChannel.update({ isServerOpen: data.is_category_channel_open });
            }
            if ('is_category_chat_open' in data) {
                this.env.messaging.discuss.categoryChat.update({ isServerOpen: data.is_category_chat_open });
            }
        }
