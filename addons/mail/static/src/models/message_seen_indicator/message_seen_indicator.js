    ...
    function factory(dependencies) {
        class MessageSeenIndicator extends dependencies["mail.model"] {
            ...
            static recomputeSeenValues(channel = undefined) {
                ...
                for (const indicator of indicators) {
                    indicator.update({
                        ...
                        isMessagePreviousToLastCurrentPartnerMessageSeenByEveryone: indicator._computeIsMessagePreviousToLastCurrentPartnerMessageSeenByEveryone(),
                        partnersThatHaveFetched: indicator._computePartnersThatHaveFetched(),
            ...
            _computeHasEveryoneFetched() {
                ...
                const otherPartnerSeenInfosDidNotFetch = this.thread.partnerSeenInfos.filter((partnerSeenInfo) => partnerSeenInfo.partner !== this.message.author && (!partnerSeenInfo.lastFetchedMessage || partnerSeenInfo.lastFetchedMessage.id < this.message.id));
            ...
            _computeHasEveryoneSeen() {
                ...
                const otherPartnerSeenInfosDidNotSee = this.thread.partnerSeenInfos.filter((partnerSeenInfo) => partnerSeenInfo.partner !== this.message.author && (!partnerSeenInfo.lastSeenMessage || partnerSeenInfo.lastSeenMessage.id < this.message.id));
            ...
            _computeHasSomeoneFetched() {
                ...
                const otherPartnerSeenInfosFetched = this.thread.partnerSeenInfos.filter((partnerSeenInfo) => partnerSeenInfo.partner !== this.message.author && partnerSeenInfo.lastFetchedMessage && partnerSeenInfo.lastFetchedMessage.id >= this.message.id);
            ...
            _computeHasSomeoneSeen() {
                ...
                const otherPartnerSeenInfosSeen = this.thread.partnerSeenInfos.filter((partnerSeenInfo) => partnerSeenInfo.partner !== this.message.author && partnerSeenInfo.lastSeenMessage && partnerSeenInfo.lastSeenMessage.id >= this.message.id);
            ...
            _computeIsMessagePreviousToLastCurrentPartnerMessageSeenByEveryone() {
                if (!this.message || !this.thread || !this.thread.lastCurrentPartnerMessageSeenByEveryone) {
                    return false;
                }
            ...
            _computePartnersThatHaveFetched() {
                ...
                const otherPartnersThatHaveFetched = this.thread.partnerSeenInfos.filter((partnerSeenInfo) => partnerSeenInfo.partner !== this.message.author && partnerSeenInfo.lastFetchedMessage && partnerSeenInfo.lastFetchedMessage.id >= this.message.id).map((partnerSeenInfo) => partnerSeenInfo.partner);
            ...
            _computePartnersThatHaveSeen() {
                ...
                const otherPartnersThatHaveSeen = this.thread.partnerSeenInfos.filter((partnerSeenInfo) => partnerSeenInfo.partner !== this.message.author && partnerSeenInfo.lastSeenMessage && partnerSeenInfo.lastSeenMessage.id >= this.message.id).map((partnerSeenInfo) => partnerSeenInfo.partner);
        ...
        MessageSeenIndicator.fields = {
            ...
            isMessagePreviousToLastCurrentPartnerMessageSeenByEveryone: attr({
                ...
                default: false,
                dependencies: ["messageId", "threadLastCurrentPartnerMessageSeenByEveryone"],
            }),
