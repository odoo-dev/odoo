    ...
    function factory(dependencies) {
        class ChatWindow extends dependencies["mail.model"] {
            ...
            focusPreviousVisibleUnfoldedChatWindow() {
                const previousVisibleUnfoldedChatWindow = this._getNextVisibleUnfoldedChatWindow({ reverse: true });
        ...
        ChatWindow.fields = {
            ...
            isFolded: attr({
                ...
                dependencies: ["thread", "threadFoldState", "_isFolded"],
                default: false,
            }),
            ...
            name: attr({
                ...
                dependencies: ["thread", "threadDisplayName"],
            }),
            /**
