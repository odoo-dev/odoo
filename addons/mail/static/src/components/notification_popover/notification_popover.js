odoo.define("mail/static/src/components/notification_popover/notification_popover.js", function (require) {
    ...
    class NotificationPopover extends Component {
        ...
        constructor(...args) {
            ...
            useStore(
                (props) => {
                    const notifications = props.notificationLocalIds.map((notificationLocalId) => this.env.models["mail.notification"].get(notificationLocalId));
                    return {
         ...
         */
        get notifications() {
            return this.props.notificationLocalIds.map((notificationLocalId) => this.env.models["mail.notification"].get(notificationLocalId));
        }
    }
