        ...
        QUnit.module("components", {}, function () {
            QUnit.module("activity_mark_done_popover", {}, function () {
                ...
                QUnit.test("activity mark done popover simplest layout", async function (assert) {
                    ...
                    assert.containsOnce(document.body, ".o_ActivityMarkDonePopover", "Popover component should be present");
                    assert.containsOnce(document.body, ".o_ActivityMarkDonePopover_feedback", "Popover component should contain the feedback textarea");
                    assert.containsOnce(document.body, ".o_ActivityMarkDonePopover_buttons", "Popover component should contain the action buttons");
                    assert.containsOnce(document.body, ".o_ActivityMarkDonePopover_doneScheduleNextButton", "Popover component should contain the done & schedule next button");
                    assert.containsOnce(document.body, ".o_ActivityMarkDonePopover_doneButton", "Popover component should contain the done button");
                    assert.containsOnce(document.body, ".o_ActivityMarkDonePopover_discardButton", "Popover component should contain the discard button");
                });
                ...
                QUnit.test("activity with force next mark done popover simplest layout", async function (assert) {
                    ...
                    assert.containsOnce(document.body, ".o_ActivityMarkDonePopover_buttons", "Popover component should contain the action buttons");
                    assert.containsOnce(document.body, ".o_ActivityMarkDonePopover_doneScheduleNextButton", "Popover component should contain the done & schedule next button");
                    assert.containsNone(document.body, ".o_ActivityMarkDonePopover_doneButton", "Popover component should NOT contain the done button");
                    assert.containsNone(document.body, ".o_ActivityMarkDonePopover_discardButton", "Popover component should NOT contain the discard button");
                });
                ...
                QUnit.test("activity mark done popover mark done without feedback", async function (assert) {
                    ...
                    assert.verifySteps(["action_feedback"], "Mark done and schedule next button should call the right rpc");
                });
                ...
                QUnit.test("activity mark done popover mark done and schedule next", async function (assert) {
                    ...
                    assert.verifySteps(["action_feedback_schedule_next"], "Mark done and schedule next button should call the right rpc");
                });
            });
        });
    });
