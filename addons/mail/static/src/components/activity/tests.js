/** @odoo-module alias=mail.components.Activity.tests **/
...
QUnit.test('activity details toggle', async function (assert) {
    ...
    const activity = env.services.action.dispatch(
        'Activity/create',
        {
            creator: env.services.action.dispatch(
                'RecordFieldCommand/insert',
                {
                    displayName: "Admin",
                    id: 1,
...
QUnit.test('activity details layout', async function (assert) {
    ...
    const activity = env.services.action.dispatch(
        'Activity/create',
        {
            assignee: env.services.action.dispatch(
                'RecordFieldCommand/insert',
                {
...
QUnit.test('activity with mail template layout', async function (assert) {
    ...
    const activity = env.services.action.dispatch(
        ...
        {
            id: 12,
            mailTemplates: env.services.action.dispatch(
                'RecordFieldCommand/insert',
                {
                    id: 1,
...
QUnit.test('activity with mail template: preview mail', async function (assert) {
    ...
    createServer(this.data);
    const env = await this.createEnv({ env: { bus } });
    const activity = env.services.action.dispatch(
        'Activity/create',
        {
            id: 12,
