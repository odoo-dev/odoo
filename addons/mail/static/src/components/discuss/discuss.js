odoo.define("mail/static/src/components/discuss/discuss.js", function (require) {
    ...
    class Discuss extends Component {
            ...
            useStore(
                (props) => {
                    ...
                    return {
                        ...
                        threadCache: discuss.threadViewer.threadCache ? discuss.threadViewer.threadCache.__state : undefined,
        ...
        patched() {
            ...
            if (this.discuss.thread && this.discuss.thread === this.env.messaging.inbox && this._lastThreadCache === this.discuss.threadViewer.threadCache.localId && this._lastThreadCounter > 0 && this.discuss.thread.counter === 0) {
        ...
        _updateLocalStoreProps() {
             ...
             */
            this._lastThreadCache = this.discuss.threadViewer.threadCache && this.discuss.threadViewer.threadCache.localId;
            /**
             * Locally tracked store props `threadCounter`.
             * Useful to display the rainbow man on inbox.
             */
            this._lastThreadCounter = this.discuss.thread && this.discuss.thread.counter;
        }
        ...
        _onReplyingToMessageMessagePosted() {
            this.env.services["notification"].notify({
                message: _.str.sprintf(this.env._t(`Message posted on "%s"`), owl.utils.escape(this.discuss.replyingToMessage.originThread.displayName)),
                type: "warning",
            });
