        ...
        QUnit.module("components", {}, function () {
            QUnit.module("message_seen_indicator", {}, function () {
                QUnit.module("message_seen_indicator_tests.js", {
                    beforeEach() {
                        ...
                        this.createMessageSeenIndicatorComponent = async ({ message, thread }, otherProps) => {
                            ...
                            this.component = new MessageSeenIndicatorComponent(
                                null,
                                Object.assign(
                                    {
                ...
                QUnit.test("rendering when just one has received the message", async function (assert) {
                    ...
                    assert.containsOnce(document.body, ".o_MessageSeenIndicator", "should display a message seen indicator component");
                    assert.doesNotHaveClass(document.querySelector(".o_MessageSeenIndicator"), "o-all-seen", "indicator component should not be considered as all seen");
                    assert.containsOnce(document.body, ".o_MessageSeenIndicator_icon", "should display only one seen indicator icon");
                });
                ...
                QUnit.test("rendering when just one has seen the message", async function (assert) {
                    ...
                    assert.containsOnce(document.body, ".o_MessageSeenIndicator", "should display a message seen indicator component");
                    assert.doesNotHaveClass(document.querySelector(".o_MessageSeenIndicator"), "o-all-seen", "indicator component should not be considered as all seen");
                    assert.containsN(document.body, ".o_MessageSeenIndicator_icon", 2, "should display two seen indicator icon");
                });
                ...
                QUnit.test("rendering when just everyone has seen the message", async function (assert) {
                    ...
                    await this.createMessageSeenIndicatorComponent({ message, thread });
                    assert.containsOnce(document.body, ".o_MessageSeenIndicator", "should display a message seen indicator component");
                    assert.hasClass(document.querySelector(".o_MessageSeenIndicator"), "o-all-seen", "indicator component should not considered as all seen");
                    assert.containsN(document.body, ".o_MessageSeenIndicator_icon", 2, "should display two seen indicator icon");
                });
            });
        });
