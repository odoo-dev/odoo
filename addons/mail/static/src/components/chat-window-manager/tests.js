/** @odoo-module alias=mail.components.ChatWindowManager.tests **/

import makeDeferred from 'mail.utils.makeDeferred';
import afterEach from 'mail.utils.test.afterEach';
import afterNextRender from 'mail.utils.test.afterEach';
...
QUnit.test('open chat from "new message" chat window should open chat in place of this "new message" chat window', async function (assert) {
     ...
     * ([mocked] global window width: @see `mail.utils.test.createEnv` method)
