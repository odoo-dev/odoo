    ...
    class MessageList extends Component {
            ...
            useStore(
                (props) => {
                    ...
                    return {
                        ...
                        messages: threadCache ? threadCache.orderedMessages.map((message) => message.__state) : [],
        ...
        willPatch() {
            ...
            this._willPatchSnapshot = {
                isLastMessageVisible: lastMessageRef && lastMessageRef.isBottomVisible({ offset: 10 }),
        ...
        shouldMessageBeSquashed(prevMessage, message) {
            ...
            if (prevMessage.moderation_status === "pending_moderation" || message.moderation_status === "pending_moderation") {
                return false;
            }
            ...
            if (prevOriginThread && originThread && prevOriginThread.model === originThread.model && originThread.model !== "mail.channel" && prevOriginThread.id !== originThread.id) {
        ...
        _checkThreadMarkAsRead() {
            ...
            if (threadCache === thread.mainCache && this.mostRecentMessageRef.isPartiallyVisible()) {
                thread.markAsSeen();
            }
        }
        ...
        async _scrollToMostRecentMessage() {
            ...
            this.el.scrollTop = this.props.order === "asc" ? this.el.scrollTop + 15 : this.el.scrollTop - 15;
            this._isAutoLoadOnScrollActive = true;
        }
