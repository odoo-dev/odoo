odoo.define("mail/static/src/components/composer/composer.js", function (require) {
    ...
    class Composer extends Component {
        ...
        constructor(...args) {
            ...
            useStore((props) => {
                ...
                return {
                    ...
                    thread: composer && composer.thread ? composer.thread.__state : undefined,
                };
            });
            /**
        ...
        patched() {
            ...
            if (this.props.isFocusOnMount && this._lastComposer !== this.composer) {
                this.focus();
            }
            this._lastComposer = this.composer;
        }
         ...
         */
        get hasFooter() {
            return this.props.hasThreadTyping || this.composer.attachments.length > 0 || !this.props.isCompact;
        }
         ...
         */
        get hasHeader() {
            return (this.props.hasThreadName && this.composer.thread) || (this.props.hasFollowers && !this.props.isLog);
        }
