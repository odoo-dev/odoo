        ...
        QUnit.module("components", {}, function () {
            QUnit.module("thread_icon", {}, function () {
                ...
                QUnit.test("chat: correspondent is typing", async function (assert) {
                    ...
                    assert.containsOnce(document.body, ".o_ThreadIcon", "should have thread icon");
                    assert.containsOnce(document.body, ".o_ThreadIcon_online", "should have thread icon with partner im status icon 'online'");
                    ...
                    assert.containsOnce(document.body, ".o_ThreadIcon_typing", "should have thread icon with partner currently typing");
                    assert.strictEqual(document.querySelector(".o_ThreadIcon_typing").title, "Demo is typing...", "title of icon should tell demo is currently typing");
                    ...
                    assert.containsOnce(document.body, ".o_ThreadIcon_online", "should have thread icon with partner im status icon 'online' (no longer typing)");
                });
            });
        });
    });
