/** @odoo-module alias=mail.components.FollowerListMenu **/
...
class FollowerListMenu extends usingModels(Component) {
    ...
    _onClickAddChannels(ev) {
        ev.preventDefault();
        this._hide();
        this.env.services.action.dispatch('Thread/promptAddChannelFollower', this.thread);
    }
    ...
    _onClickAddFollowers(ev) {
        ev.preventDefault();
        this._hide();
        this.env.services.action.dispatch('Thread/promptAddPartnerFollower', this.thread);
    }
