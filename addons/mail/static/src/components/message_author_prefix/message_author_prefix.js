    ...
    class MessageAuthorPrefix extends Component {
        ...
        constructor(...args) {
            ...
            useStore((props) => {
                ...
                const thread = props.threadLocalId ? this.env.models["mail.thread"].get(props.threadLocalId) : undefined;
                return {
                    author: author ? author.__state : undefined,
                    currentPartner: this.env.messaging.currentPartner ? this.env.messaging.currentPartner.__state : undefined,
