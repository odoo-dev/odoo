 ...
 * @property {import("@mail/discuss/core/message_model").Message|null} message
 * @property {import("@mail/discuss/core/thread_model").Thread|null} thread
...
export function useMessageToReplyTo() {
    return useState({
         ...
         * @param {import("@mail/discuss/core/message_model").Message} message
         * @returns {boolean}
         */
        ...
        /** @type {import("@mail/discuss/core/message_model").Message|null} */
        message: null,
        /** @type {import("@mail/discuss/core/thread_model").Thread|null} */
        thread: null,
        /**
         * @param {import("@mail/discuss/core/thread_model").Thread} thread
         * @param {import("@mail/discuss/core/message_model").Message} message
