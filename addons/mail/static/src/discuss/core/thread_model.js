...
import { ScrollPosition } from "@mail/discuss/core/scroll_position_model";
 ...
 * @property {import('@mail/discuss/core/persona_model').Persona|false} persona
...
export class Thread {
    ...
    /** @type {string} */
    model;
    /** @type {import("@mail/discuss/attachments/attachment_model").Attachment[]} */
    attachments = [];
    /** @type {integer} */
    activeRtcSessionId;
    /** @type {object|undefined} */
    channel;
    /** @type {import("@mail/discuss/core/channel_member_model").ChannelMember[]} */
    channelMembers = [];
    /** @type {RtcSession{}} */
    rtcSessions = {};
    ...
    /** @type {integer} */
    chatPartnerId;
    /** @type {import("@mail/discuss/composer/composer_model").Composer} */
    composer;
    counter = 0;
    /** @type {string} */
    customName;
    /** @type {string} */
    description;
    /** @type {import("@mail/discuss/core/follower_model").Follower[]} */
    followers = [];
    isAdmin = false;
    loadMore = false;
    ...
    /** @type {import("@mail/discuss/core/message_model").Message[]} */
    messages = [];
    /** @type {string} */
    name;
    /** @type {number} */
    ...
    /** @type {import("@mail/discuss/core/persona_model").Persona|undefined} */
    get correspondent() {
        if (this.type === "channel") {
            return undefined;
        }
    ...
    /**
     * @returns {import("@mail/discuss/core/follower_model").Follower}
     */
    get followerOfSelf() {
    ...
    /** @returns {import("@mail/discuss/core/message_model").Message | undefined} */
    get mostRecentMsg() {
    ...
    /**
     *
     * @param {import("@mail/discuss/core/persona_model").Persona} persona
     */
