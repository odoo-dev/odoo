...
export class DiscussChannel extends Record {
    ...
    setup() {
        ...
        let memberBusSubscription = "not_member";
        this.onChange(
            () => {
                ...
                return [
                    member.memberSince >= startedAt ? "member_after_start" : "member_before_start",
                ];
            },
            function onChangeMemberBusSubscription(subscription) {
                const wasMember = memberBusSubscription !== "not_member";
                memberBusSubscription = subscription;
                if (
