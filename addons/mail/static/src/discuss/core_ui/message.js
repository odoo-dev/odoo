...
import { ImStatus } from "@mail/discuss/discuss_app/im_status";
import { AttachmentList } from "@mail/discuss/attachments/attachment_list";
import { MessageInReply } from "./message_in_reply";
import { isEventHandled, markEventHandled } from "@mail/discuss/utils/misc";
import { convertBrToLineBreak, htmlToTextContentInline } from "@mail/discuss/utils/format";
import { onExternalClick } from "@mail/discuss/utils/hooks";
import {
    Component,
    onMounted,
    onPatched,
 ...
 * @property {import("@mail/discuss/core/message_model").Message} message
 * @property {import("@mail/discuss/utils/hooks").MessageToReplyTo} [messageToReplyTo]
...
export class Message extends Component {
    ...
    setup() {
        ...
        this.store = useStore();
        /** @type {import("@mail/discuss/core/thread_service").ThreadService} */
        this.threadService = useState(useService("mail.thread"));
        /** @type {import("@mail/discuss/core/message_service").MessageService} */
        this.messageService = useState(useService("mail.message"));
        /** @type {import("@mail/discuss/attachments/attachment_service").AttachmentService} */
