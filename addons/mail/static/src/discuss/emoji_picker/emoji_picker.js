...
import { markEventHandled } from "@mail/discuss/utils/misc";
...
/**
 * @returns {import("@mail/discuss/emoji_picker/emoji_data")}
 */
export async function loadEmoji() {
    await _loadEmoji();
    return odoo.runtimeImport("@mail/discuss/emoji_picker/emoji_data");
}
