...
import { Thread } from "@mail/discuss/core_ui/thread";
...
import {
    ...
    useMessageHighlight,
    useMessageToReplyTo,
} from "@mail/discuss/utils/hooks";
import { Component, useChildSubEnv, useRef, useState } from "@odoo/owl";
import { useService } from "@web/core/utils/hooks";
import { localization } from "@web/core/l10n/localization";
import { CallSettings } from "@mail/discuss/rtc/call_settings";
import { ChannelMemberList } from "@mail/discuss/discuss_app/channel_member_list";
import { ThreadIcon } from "@mail/discuss/discuss_app/thread_icon";
import { ChannelInvitation } from "@mail/discuss/discuss_app/channel_invitation";
import { isEventHandled } from "@mail/discuss/utils/misc";
import { ChannelSelector } from "@mail/discuss/discuss_app/channel_selector";

/**
 * @typedef {Object} Props
 * @property {import("@mail/discuss/web/chat_window/chat_window_model").ChatWindow} chatWindow
...
export class ChatWindow extends Component {
    ...
    setup() {
        this.store = useStore();
        /** @type {import("@mail/discuss/web/chat_window/chat_window_service").ChatWindowService} */
