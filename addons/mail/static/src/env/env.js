odoo.define("mail/static/src/env/env.js", function (require) {
    "use strict";
     ...
     * kinds of buses.
     */
    env.bus.on("hide_home_menu", null, () => env.messagingBus.trigger("hide_home_menu"));
    env.bus.on("show_home_menu", null, () => env.messagingBus.trigger("show_home_menu"));
    env.bus.on("will_hide_home_menu", null, () => env.messagingBus.trigger("will_hide_home_menu"));
    env.bus.on("will_show_home_menu", null, () => env.messagingBus.trigger("will_show_home_menu"));
