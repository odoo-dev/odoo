...
export class RtcSession {
    ...
    update(data) {
        ...
        this.isOwnSession = this.channelMember?.partnerId === this._state.user.partnerId; // discuss refactor: todo guest
    }
    get channelMember() {
     ...
     */
    get volume() {
        /* discuss refactor: whatever component needs it has to get from settings or here.
    ...
    /**
     * TODO should get the volume settings from the settings service instead
     * @param {number} volume
     * discuss refactor: TODO should be a function of settings? to refactor when used
     */
    setVolume(volume) {
        /**
