/** @odoo-module alias=mail.tours.fullComposerTest **/
 ...
 */
tour.register('mail.tours.fullComposerTest', {
    test: true,
}, [{
    ...
    extra_trigger: '.o-Attachment:not(.o-isUploading)' // waiting the attachment to be uploaded
}, {
