odoo.define("mail/static/src/widgets/form_renderer/form_renderer.js", function (require) {
    ...
    FormRenderer.include({
        ...
        _makeChatterContainerComponent() {
            ...
            this._chatterContainerComponent = new ChatterContainerWrapperComponent(this, components.ChatterContainer, props);
        ...
        _makeChatterContainerProps() {
            ...
            const activityIds = this.state.data.activity_ids ? this.state.data.activity_ids.res_ids : [];
            const followerIds = this.state.data.message_follower_ids ? this.state.data.message_follower_ids.res_ids : [];
            const messageIds = this.state.data.message_ids ? this.state.data.message_ids.res_ids : [];
