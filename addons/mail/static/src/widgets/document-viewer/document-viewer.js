/** @odoo-module alias=mail.widgets.DocumentViewer **/
 ...
 * @see `mail.components.AttachmentViewer`
 * TODO: remove this widget when it's not longer used
 *
 * @deprecated
 */
export default Widget.extend({
    template: 'mail.widgets.DocumentViewer',
    events: {
    ...
    init(parent, attachments, activeAttachmentID) {
        ...
        this.attachment = attachments.filter(
            attachment => {
        ...
        this.activeAttachment = attachments.find(
    ...
    _onPrint(e) {
        ...
        const script = qweb.render(
            'mail.widgets.DocumentViewer.printImage',
            { src },
        );
