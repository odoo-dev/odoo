/** @odoo-module alias=mail.widgets.MessagingMenu **/

import MessagingMenu from 'mail.components.MessagingMenu';
...
const activityMenuIndex = SystrayMenu.Items.findIndex(
    SystrayMenuItem => SystrayMenuItem.prototype.name === 'activity_menu',
);
