...
function ThreadFactory({ Entity }) {
    ...
    class Thread extends Entity {
         ...
         *
         * @param {Object} param0
         * @param {boolean} [param0.autoselect=false]
         * @param {string} [param0.autoselectChatWindowMode]
         * @param {string} param0.name
         * @param {integer|undefined} [param0.partnerId=undefined]
         * @param {string|undefined} [param0.public=undefined]
         ...
         *
         * @param {mail.messaging.entity.Thread>[]} threadsOrLocalIds
         */
...
registerNewEntity('Thread', ThreadFactory, ['Entity']);
