...
def parse_res_ids(res_ids):
    """ Returns the already valid list/tuple of int or returns the
    literal eval of the string as a list/tuple of int.
    Void strings / missing values are evaluated as an empty list.

    :param str|tuple|list res_ids: a list of ids, tuple or list
    :raise: ValidationError if the provided res_ids is an incorrect type or invalid format
