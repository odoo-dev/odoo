...
class TestLeaveRequests(TestHrHolidaysCommon):
    ...
    def test_overlapping_requests(self):
        ...
        self.env['hr.time'].with_user(self.user_employee_id).create({
            'name': 'Hol11',
    ...
    def test_limited_type_not_enough_days(self):
        with freeze_time('2022-01-05'):
            allocation = self.env['hr.time.allocation'].with_user(self.user_hruser_id).create({
    ...
    def test_limited_type_days_left(self):
        ...
        with freeze_time('2022-01-05'):
            ...
            hol = self.env['hr.time'].with_user(self.user_employee_id).create({
                'name': 'Hol11',
                'employee_id': self.employee_emp_id,
                'work_entry_type_id': self.holidays_type_2.id,
                'request_date_from': (datetime.today() - relativedelta(days=1)),
    ...
    def test_accrual_validity_time_valid(self):
        ...
        allocation = self.env['hr.time.allocation'].with_user(self.user_hrmanager_id).create({
            'name': 'Sick Time Off',
            'work_entry_type_id': self.holidays_type_2.id,
    ...
    def test_create_group_leave_without_hr_right(self):
        ...
        leave_wizard = self.env['hr.time.generate.multi.wizard'].create({
            'work_entry_type_id': self.holidays_type_1.id,
    ...
    def test_group_time_off_wizard(self):
        ...
        leave_wizard = self.env['hr.time.generate.multi.wizard'].new({
        ...
        allocation_e1 = self.env['hr.time.allocation'].create({
        'name': 'Alloc E1',
        ...
        wizard2 = self.env['hr.time.generate.multi.wizard'].new({
            'employee_ids': (self.employee_1 + self.employee_2).ids,
        ...
        allocation_e2 = self.env['hr.time.allocation'].create({
            'name': 'Alloc E2',
        ...
        wizard3 = self.env['hr.time.generate.multi.wizard'].new({
            'employee_ids': (self.employee_1 + self.employee_2).ids,
            'date_from': date(2020, 1, 2),
            'date_to': date(2020, 1, 2),
        })
    ...
    def test_create_group_leave_form_allocation_mode_without_hr_right(self):
        ...
        leave_wizard.action_generate_time_off()
        generated_leaves = self.env['hr.time'].search([
    ...
    def test_allocation_request(self):
        ...
        allocation_form = Form(self.env['hr.time.allocation'].with_user(self.user_employee))
    ...
    def test_employee_is_absent(self):
        ...
        user_employee_leave = self.env['hr.time'].with_user(self.user_employee_id).create({
            'name': 'Hol11',
            'employee_id': self.employee_emp_id,
            'work_entry_type_id': self.holidays_type_1.id,
            'request_date_from': (date.today() - relativedelta(days=1)),
    ...
    def test_timezone_company_validated(self):
        ...
        leave_wizard_form = Form(self.env['hr.time.generate.multi.wizard'])
        ...
        leave_wizard.action_generate_time_off()
        employee_leave = self.env['hr.time'].search([('employee_id', '=', employee.id)])
        self.assertEqual(
    ...
    def test_number_of_hours_display_flexible_calendar(self):
        ...
        leave0 = self.env['hr.time'].create({
            'name': 'Holiday 1 day',
            'employee_id': employee.id,
            'work_entry_type_id': work_entry_type.id,
        ...
        leave3 = self.env['hr.time'].create({
        ...
        leave4 = self.env['hr.time'].create({
        ...
        leave5 = self.env['hr.time'].create({
    ...
    def _test_leave_with_tz(self, tz, local_date_from, local_date_to, number_of_days):
        ...
        leave = self.env['hr.time'].with_user(self.user_employee_id).new({
            'name': 'Test',
            'employee_id': self.employee_emp_id,
            'work_entry_type_id': self.holidays_type_1.id,
    ...
    def test_no_days_expired(self):
        ...
        allocation_one = self.env['hr.time.allocation'].create({
            'name': 'Expired Allocation',
            'employee_id': self.employee_emp_id,
            'work_entry_type_id': self.holidays_type_2.id,
            'number_of_days': 20,
        ...
        allocation_two = self.env['hr.time.allocation'].create({
            'name': 'Expired Allocation',
            'employee_id': self.employee_emp_id,
            'work_entry_type_id': self.holidays_type_2.id,
            'number_of_days': 3,
    ...
    def test_company_leaves(self):
        # First expired allocation
        self.env['hr.time.allocation.generate.multi.wizard'].create({
            'name': 'Allocation',
        ...
        req1_form = Form(self.env['hr.time'].sudo())
    ...
    def test_leave_with_public_holiday_other_company(self):
        ...
        leave = self.env['hr.time'].with_user(self.user_employee_id).create({
            'name': 'Holiday Request',
            'employee_id': self.employee_emp.id,
            'work_entry_type_id': self.holidays_type_1.id,
    ...
    def test_several_allocations(self):
        ...
        self.env['hr.time.allocation'].create(allocation_vals).action_approve()
        self.env['hr.time.allocation'].create(allocation_vals).action_approve()
    ...
    def test_several_allocations_split(self):
        ...
        Leave = self.env['hr.time'].with_user(self.user_employee_id).sudo()
        leave_vals = {
            'name': 'Holiday Request',
            'employee_id': self.employee_emp_id,
            'work_entry_type_id': self.holidays_type_2.id,
    ...
    def test_time_off_recovery_on_write(self):
        ...
        time_off_1 = self.env['hr.time'].create({
            'name': 'Holiday Request',
            'employee_id': self.employee_emp_id,
            'work_entry_type_id': self.holidays_type_1.id,
            'request_date_from': '2021-12-06',
        ...
        time_off_2 = self.env['hr.time'].create({
            'name': 'Holiday Request',
            'employee_id': self.employee_emp_id,
            'work_entry_type_id': self.holidays_type_1.id,
    ...
    def test_archived_allocation(self):
        with freeze_time('2022-09-15'):
            allocation_2021 = self.env['hr.time.allocation'].create({
            ...
            allocation_2022 = self.env['hr.time.allocation'].create({
            ...
            # Leave taken in 2021
            leave_2021 = self.env['hr.time'].with_user(self.user_employee_id).create({
                'name': 'Holiday Request',
                'employee_id': self.employee_emp.id,
                'work_entry_type_id': self.holidays_type_2.id,
            ...
            leave_2022 = self.env['hr.time'].with_user(self.user_employee_id).create({
                'name': 'Holiday Request',
                'employee_id': self.employee_emp.id,
                'work_entry_type_id': self.holidays_type_2.id,
    ...
    def test_prevent_misplacement_of_allocations_without_end_date(self):
        ...
        allocations = self.env['hr.time.allocation'].create([
            {
        ...
        with self.assertRaises(ValidationError):
            self.env['hr.time'].with_user(self.user_employee_id).create(trigger_error_leave)
    ...
    def test_current_leave_status(self):
        ...
        def run_validation_flow(leave_validation_type):
            ...
            current_leave = self.env['hr.time'].with_user(self.user_employee_id).create({
                'name': 'Holiday Request',
                'employee_id': employee.id,
                'work_entry_type_id': work_entry_type.id,
    ...
    def test_duration_display_global_leave(self):
        ...
        sick_leave = self.env['hr.time'].create({
            'name': 'Sick 3 days',
            'employee_id': employee.id,
        ...
        comp_leave = self.env['hr.time'].create({
        ...
        msg = "hr_time: duration_display should update after adding an overlapping holiday"
    ...
    def test_duration_display_public_leave_include(self):
        ...
        self.assertEqual(sick_leave.duration_display, '2 days', "hr_time: duration_display should not count public holiday")
        ...
        self.assertEqual(sick_leave.duration_display, '3 days', "hr_time: duration_display should not update after adding an overlapping holiday")
    ...
    def test_default_request_date_timezone(self):
        ...
        leave_form = Form(self.env['hr.time'].with_user(self.user_employee).with_context(context))
    ...
    def test_filter_time_off_type_multiple_employees(self):
        ...
        """
        self.assertFalse(self.env['hr.time.allocation'].search([['work_entry_type_id', '=', self.holidays_type_2.id]]))
    ...
    def test_mail_update_with_no_validation(self):
        ...
        test_leave = self.env['hr.time'].create({
            'name': 'Test leave',
            'employee_id': self.employee_emp_id,
            'work_entry_type_id': self.holidays_support_document.id,
            'request_date_from': date(2022, 3, 11),
    ...
    def test_time_off_date_edit(self):
        ...
        leave = self.env['hr.time'].with_user(user_id).create({
            'name': 'Test leave',
    ...
    def test_get_default_work_entry_type(self):
        ...
        hr_time_default_value = self.env['hr.time'].with_context({
            'default_work_entry_type_request_unit': 'hour',
        }).default_get(list(self.env['hr.time'].fields_get()) + ['work_entry_type_id'])
        self.assertEqual(hr_time_default_value.get('work_entry_type_id'), hour_work_entry_type.id)

        self.env['hr.work.entry.type'].search([('id', '=', hour_work_entry_type.id)]).unlink()
        hr_time_default_value = self.env['hr.time'].with_context({
            'default_work_entry_type_request_unit': 'hour',
        }).default_get(list(self.env['hr.time'].fields_get()) + ['work_entry_type_id'])
        self.assertEqual(hr_time_default_value.get('work_entry_type_id'), half_day_work_entry_type.id)

        self.env['hr.work.entry.type'].search([('id', '=', half_day_work_entry_type.id)]).unlink()
        hr_time_default_value = self.env['hr.time'].with_context({
            'default_work_entry_type_request_unit': 'hour',
        }).default_get(list(self.env['hr.time'].fields_get()) + ['work_entry_type_id'])
        self.assertEqual(hr_time_default_value.get('work_entry_type_id'), False)
    ...
    def test_leave_duration_on_public_holiday_with_flexible_request(self):
        ...
        leaves = self.env["hr.time"].with_user(self.user_employee_id).create([
            {
                **data,
                'employee_id': self.employee_emp.id,
                'work_entry_type_id': self.holidays_type_1.id,
    ...
    def test_validated_leave_back_to_approval(self):
        """
        =====================================================================================================================
        | case 1: An approved leave can be moved back to confirm state if user has group `group_hr_time_user`           |
        | case 2: An approved leave can't be moved back to confirm state if user doesn't have group `group_hr_time_user`|
        =====================================================================================================================
        """
        sick_work_entry_type = self.env['hr.work.entry.type'].create({
            'name': 'leave in days',
        ...
        sick_leave = self.env['hr.time'].with_user(self.user_employee_id).create({
    ...
    def test_unified_time_off_half_day_scenarios(self):
        leave_half_day_am = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        leave_half_day_pm = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        leave_half_day_multi = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        leave_half_day_multi2 = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        leave_half_day_multi3 = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        leave_half_day_multi4 = self.env['hr.time'].with_user(self.user_employee_id).create({
    ...
    def test_unified_time_off_half_day_scenarios_irregular_calendar(self):
        ...
        irregular_leave = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        irregular_leave2 = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        irregular_leave3 = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        irregular_leave4 = self.env['hr.time'].with_user(self.user_employee_id).create({
    ...
    def test_unified_time_off_hours_scenarios(self):
        ...
        leave_hours_day_mid_break = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        leave_hours_day_end = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        leave_hours_multi = self.env['hr.time'].with_user(self.user_employee_id).create({
        ...
        leave_hours_multi2 = self.env['hr.time'].with_user(self.user_employee_id).create({
    ...
    def test_multi_timeoff_wizard_days_with_allocation(self):
        ...
        leave_wizard.action_generate_time_off()
        new_leaves = self.env['hr.time'].search([
            ('employee_id', 'in', (employee_1 + employee_2).ids),
            ('work_entry_type_id', '=', self.holidays_type_2.id),
        ]) - leaves
    ...
    def test_multi_timeoff_wizard_days_conflicting(self):
        ...
        leave_wizard.action_generate_time_off()
        first_generated_leaves = self.env['hr.time'].search([
            ('employee_id', 'in', (employee_1 + employee_2).ids),
            ('work_entry_type_id', '=', self.holidays_type_1.id),
        ])
        ...
        leave_wizard.action_generate_time_off()
        second_generated_leaves = self.env['hr.time'].search([
            ('employee_id', 'in', (employee_1 + employee_2).ids),
            ('work_entry_type_id', '=', self.holidays_type_1.id),
    ...
    def test_multi_timeoff_wizard_half_day(self):
        ...
        leave_wizard.action_generate_time_off()
        morning_leaves = self.env['hr.time'].search([
            ('employee_id', 'in', (employee_1 + employee_2).ids),
            ('work_entry_type_id', '=', self.holidays_type_half.id),
        ])
        ...
        leave_wizard.action_generate_time_off()
        afternoon_leaves = self.env['hr.time'].search([
            ('employee_id', 'in', (employee_1 + employee_2).ids),
            ('work_entry_type_id', '=', self.holidays_type_half.id),
        ]) - morning_leaves
    ...
    def test_coextensive_holidays_one_include_public_leave(self):
        ...
        sick_leave_hr = self.env['hr.time'].create({
            'name': 'Paid 3 days',
        ...
        self.assertEqual(sick_leave.duration_display, '3 days', "hr_time: duration_display should not update after adding an overlapping holiday")
        self.assertEqual(sick_leave_hr.duration_display, '2 days', "hr_time: duration_display should update after adding an overlapping holiday")
    ...
    def test_leave_request_by_removing_dates_work_entry_type_id(self):
        ...
        """
        with Form(self.env['hr.time']) as leave_form:
    ...
    def test_calendar_event_create_access_rights(self):
        ...
        self.env['ir.model.access'].create([
            ...
            # https://github.com/odoo/odoo/blob/cc0060e889603eb2e47fa44a8a22a70d7d784185/addons/hr_time/models/hr_time.py#L894-L898
        ...
        with freeze_time('2025, 1, 8'):
            leave = self.env['hr.time'].with_user(self.user_hrmanager_id).create({
                'name': 'Holiday Request',
                'employee_id': self.employee_emp_id,
                'work_entry_type_id': self.holidays_type_1.id,
    ...
    def test_set_employee_on_leave_req_without_start_date(self):
        ...
        leave_req_form = Form(self.env['hr.time'].with_user(self.user_hrmanager_id))
    ...
    def test_flexible_schedule_full_day_off(self):
        ...
        flex_leave = self.env['hr.time'].create({
            'name': "Full Day Leave",
    ...
    def test_duration_flexible_employee_different_timezone(self):
        ...
        leave = self.env['hr.time'].with_user(self.env.user).create({
            'name': 'Test',
            'employee_id': self.employee_emp.id,
            'work_entry_type_id': self.holidays_type_1.id,
            'request_hour_from': 8,
    ...
    def test_group_leave_conflicting_days_computation(self):
        ...
        """
        LeaveType = self.env['hr.work.entry.type'].with_user(self.user_hrmanager_id)
    ...
    def test_group_leave_hourly_conflict(self):
        ...
        hourly_leave = self.env['hr.leave'].with_user(self.user_employee_id).create({
            'name': 'Hourly Leave',
            'employee_id': self.employee_emp_id,
            'work_entry_type_id': hourly_type.id,
            'request_date_from': '2026-02-24',
            'request_date_to': '2026-02-24',
            'request_hour_from': 8,
            'request_hour_to': 12,
