...
class PurchaseOrder(models.Model):
    ...
    def _compute_has_alternatives(self):
        ...
        if self.env.user.has_group('purchase_alternative.group_purchase_alternatives'):
    ...
    def action_compare_alternative_lines(self):
        ...
        view_id = self.env.ref('purchase_alternative.purchase_order_line_compare_tree').id
        return {
