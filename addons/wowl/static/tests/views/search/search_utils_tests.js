...
QUnit.module("SearchUtils", () => {
  ...
  QUnit.skip("Quarter option: custom translation", async function (assert) {
    const unpatchDate = patchDate(2020, 5, 1, 13, 0, 0);
  ...
  QUnit.skip("Quarter option: custom translation and right to left", async function (assert) {
    const unpatchDate = patchDate(2020, 5, 1, 13, 0, 0);
    const referenceMoment = DateTime.utc().setLocale("en");
    testUtils.mock.patch(_t.database.db, {
      Q2: "2e Trimestre",
