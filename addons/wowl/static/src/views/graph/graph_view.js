...
import { GraphModel, SEP, getMeasureDescription } from "./graph_model";
        ...
        case "field":
          ...
          if (isDefaultMeasure) {
            ...
            if (GROUPABLE_TYPES.includes(type)) {
              ...
              if (!metaData.defaultGroupBy) {
                metaData.defaultGroupBy = [];
              }
              metaData.defaultGroupBy.push(groupBy);
            }
          }
          break;
      }
...
export class GraphView extends Component {
  ...
  async onMeasureSelected(ev) {
    ...
    this.model.updateMetaData({ activeMeasure: measure });
  }
