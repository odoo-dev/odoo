...
registry.category("web_tour.tours").add("test_survey_roaming_mandatory_questions", {
    ...
    steps: () => [
        ...
        {
            content:
                "Check if the visible question is the indirectly skipped mandatory conditional question Q4",
        ...
        {
            content:
                "Check if the visible question is the indirectly skipped non-mandatory conditional question Q5",
