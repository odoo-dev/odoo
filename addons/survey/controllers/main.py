...
class Survey(http.Controller):
    ...
    @http.route('/survey/begin/<string:survey_token>/<string:answer_token>', type='rpc', auth='public', website=True)
    ...
    @http.route('/survey/next_question/<string:survey_token>/<string:answer_token>', type='rpc', auth='public', website=True)
    ...
    @http.route('/survey/submit/<string:survey_token>/<string:answer_token>', type='rpc', auth='public', website=True)
