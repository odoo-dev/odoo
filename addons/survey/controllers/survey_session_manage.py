...
class UserInputSession(http.Controller):
    ...
    @http.route('/survey/session/next_question/<string:survey_token>', type='rpc', auth='user', website=True)
    ...
    @http.route('/survey/session/results/<string:survey_token>', type='rpc', auth='user', website=True)
    ...
    @http.route('/survey/session/leaderboard/<string:survey_token>', type='rpc', auth='user', website=True)
    ...
    @http.route('/survey/check_session_code/<string:session_code>', type='rpc', auth='public', website=True)
