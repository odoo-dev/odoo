...
class EventBoothRegistration(models.Model):
    ...
    def _cancel_pending_registrations(self):
        ...
        # Registrations of already cancelled orders are kept: those orders released
        # their booths and may be confirmed again, which has to report the booths
        # taken in the meantime instead of silently dropping them from the order.
