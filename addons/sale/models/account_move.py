    ...
    def _sale_create_reinvoice_sale_line(self):
        ...
        for move_line_id, unknown_sale_line in map_move_sale_line.items():
            if isinstance(unknown_sale_line, int):  # index of newly created sale line
                ...
                msg = _("Extra line with %s added from vendor bill <a href=# data-oe-model=account.move data-oe-id=%d>%s</a>") % (order_line.product_id.display_name, invoice.id, invoice.display_name)
