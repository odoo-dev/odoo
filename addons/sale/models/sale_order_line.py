...
class SaleOrderLine(models.Model):
    ...
    def _get_linked_lines_by_line(self):
        ...
        no_line = self.env['sale.order.line']
        linked_lines_by_line = {}
        for line in self:
            linked_lines = no_line
            if line._origin:
                linked_lines = lines_by_origin.get(line._origin, no_line)
            if not linked_lines and line.virtual_id:
                linked_lines = lines_by_virtual.get(line.virtual_id, no_line)
