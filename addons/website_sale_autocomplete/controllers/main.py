...
class AutoCompleteController(http.Controller):
    ...
    @http.route('/autocomplete/address', methods=['POST'], type='rpc', auth='public', website=True)
    ...
    @http.route('/autocomplete/address_full', methods=['POST'], type='rpc', auth='public', website=True)
