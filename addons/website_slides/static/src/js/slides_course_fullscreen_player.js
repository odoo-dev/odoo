...
var VideoPlayerYouTube = publicWidget.Widget.extend({
    ...
    start: function () {
        var self = this;
        return Promise.all([this._super.apply(this, arguments), this._loadYoutubeAPI()]).then(
            function () {
...
var Sidebar = publicWidget.Widget.extend({
    ...
    _getCurrentIndex: function () {
        ...
        var currentIndex = this.slideEntries.findIndex(
                ...
                if (slide._autoSetDone && !session.is_website_user) {
                    ...
                    if (slide.category === "document") {
                        ...
                        self.el
                            ...
                            .addEventListener("load", () => self._toggleSlideCompleted(slide));
                    } else {
