...
class WebsiteSlides(WebsiteProfile):
    ...
    @http.route(['/slides/channel/join'], type='rpc', auth='public', website=True)
    ...
    @http.route(['/slides/channel/leave'], type='rpc', auth='user', website=True)
    ...
    @http.route(['/slides/channel/tag/search_read'], type='rpc', auth='user', methods=['POST'], website=True)
    ...
    @http.route(['/slides/channel/tag/group/search_read'], type='rpc', auth='user', methods=['POST'], website=True)
    ...
    @http.route('/slides/channel/tag/add', type='rpc', auth='user', methods=['POST'], website=True)
    ...
    @http.route(['/slides/channel/send_share_email'], type='rpc', auth='user', website=True)
    ...
    @http.route(['/slides/channel/subscribe'], type='rpc', auth='user', website=True)
    ...
    @http.route(['/slides/channel/unsubscribe'], type='rpc', auth='user', website=True)
    ...
    @http.route('/slides/slide/get_html_content', type="rpc", auth="public", website=True)
    ...
    @http.route('/slides/slide/set_completed', website=True, type="rpc", auth="public")
    ...
    @http.route('/slides/slide/set_uncompleted', website=True, type='rpc', auth='public')
    ...
    @http.route('/slides/slide/like', type='rpc', auth="public", website=True)
    ...
    @http.route('/slides/slide/archive', type='rpc', auth='user', website=True)
    ...
    @http.route('/slides/slide/toggle_is_preview', type='rpc', auth='user', website=True)
    ...
    @http.route(['/slides/slide/send_share_email'], type='rpc', auth='user', website=True)
    ...
    @http.route('/slide_channel_tag/add', type='rpc', auth='user', methods=['POST'], website=True)
    ...
    @http.route('/slides/slide/quiz/question_add_or_update', type='rpc', methods=['POST'], auth='user', website=True)
    ...
    @http.route('/slides/slide/quiz/get', type="rpc", auth="public", website=True)
    ...
    @http.route('/slides/slide/quiz/reset', type="rpc", auth="user", website=True)
    ...
    @http.route('/slides/slide/quiz/submit', type="rpc", auth="public", website=True)
    ...
    @http.route(['/slides/slide/quiz/save_to_session'], type='rpc', auth='public', website=True)
    ...
    @http.route(['/slides/category/search_read'], type='rpc', auth='user', methods=['POST'], website=True)
    ...
    @http.route(['/slides/prepare_preview'], type='rpc', auth='user', methods=['POST'], website=True)
    ...
    @http.route(['/slides/add_slide'], type='rpc', auth='user', methods=['POST'], website=True)
    ...
    @http.route(['/slides/tag/search_read'], type='rpc', auth='user', methods=['POST'], website=True)
