...
class SlideSlide(models.Model):
    ...
    def _fetch_youtube_metadata(self, image_url_only=False):
        ...
        self.ensure_one()
        google_app_key = self.env['website']._get_current_website().sudo().website_slide_google_app_key
        error_message = False
        try:
    ...
    def _fetch_google_drive_metadata(self, image_url_only=False):
        ...
        if not params.get('access_token'):
            params['key'] = self.env['website']._get_current_website().sudo().website_slide_google_app_key
