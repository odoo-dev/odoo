...
class Properties(Field):
    ...
    def to_write(self, records, value):
        ...
        # force self.write() if some definition has changed
        if self._must_update_definition(value):
    ...
    def write(self, records, value):
        ...
        if not isinstance(value, dict | None):
            ...
            value = self.convert_to_cache(value, records)

        # assert isinstance(value, dict | None)
        super().write(records, value)

    def _must_update_definition(self, value: typing.Any) -> bool:
        return is_list_of(value, dict) and any(
    ...
    def _update_definition(self, records: BaseModel, value: typing.Any) -> typing.Any:
        """Update the properties definition.
