...
class PropertiesDefinition(Field):
    ...
    def _validate_properties_definition(self, properties_definition, env):
        ...
        allowed_keys = self.ALLOWED_KEYS + env["ir.model.fields"]._additional_allowed_keys_properties_definition()

        env["ir.model.fields"]._validate_properties_definition(properties_definition, self)
