...
class Registry(Mapping[str, type["BaseModel"]]):
    ...
    def new(
        ...
        *,
        ...
        reset_classes_tp_versions_used([*registry.values(), type(registry)], reset_above_ratio=0.3)  # cpython optimisation
        registry.ready = True
        registry.last_used = time.monotonic()
    ...
    def _setup_models__(self, cr: BaseCursor, model_names: Iterable[str] | None = None) -> None:  # noqa: PLW3201
        ...
        reset_classes_tp_versions_used([*self.values(), type(self)])  # cpython optimisation
