    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    def _update_field_translations(self, field_name, translations, digest=None, source_lang=None):
        ...
        if field.related and not field.store:
            ...
            records = self
            for path in related_path.split("."):
    ...
    def mapped(self, func):
        ...
        sequence of mapped results.

        :param func: a function or a dot-separated sequence of field names
        :type func: callable or str
        :return: result of func applied to each record in ``self``.
        :rtype: sequence of mapped results (same size as self)
