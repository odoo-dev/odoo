...
class LogAccessMixin(AbstractModel):
    ...
    _log_access = True  # TODO deprecate, let people inherit from this model
...
class Model(SimpleModel, LogAccessMixin):
    """ Main super-class for regular database-persisted Odoo models with log access.
