...
#from odoo.tools.profiler import SpeedscopeResult, Profiler
#
#
...
#        return {
#            'init_stack_level': 0,
#            'init_stack': [['/path/tp/file_1.py', 135, '__main__', 'main()'],], # not sure
#            'init_thread': 123456,
#            'result': [
#                {  # init frame
#                    'start': 2.0,
...
#
#    def test_converts_init_stack(self):
...
#        rt = p.results['traces']
#
#        self.assertEqual(rq['init_stack'], rt['init_stack'])
#        self.assertEqual(rq['init_thread'], rt['init_thread'])
#        self.assertEqual(rq['init_stack'][-1][2], 'test_profilers')
#        self.assertEqual(rq['init_stack'][-1][0].split('/')[-1], 'test_profiler.py')
#        self.assertEqual(rq['init_stack_level'], rt['init_stack_level'])
#        self.assertEqual(rq['init_stack_level'], len(rq['init_stack'])-1)
#
