...
""",
    ...
    'external_dependencies': [
        {'pypi': 'OpenSSL'},
        {'pypi': 'pillow', 'modules': ['PIL'], 'apt': 'python3-pil'},
        {'pypi': 'aiosmtpd', 'test': True},
        {'pypi': 'babel'},
        {'pypi': 'collections'},
        {'pypi': 'cryptography'},
        {'pypi': 'dateutil'},
        {'pypi': 'docutils'},
        {'pypi': 'freezegun', 'test': True},
        {'pypi': 'idna'},
        {'pypi': 'lxml'},
        {'pypi': 'markupsafe'},
        {'pypi': 'num2words', 'optional': True},
        {'pypi': 'passlib'},
        {'pypi': 'pdfminer', 'test': True},
        {'pypi': 'psycopg2'},
        {'pypi': 'requests'},
        {'pypi': 'rjsmin'},
        {'pypi': 'sass'},
        {'pypi': 'slugify', 'optional': True},
        {'pypi': 'stdnum'},
        {'pypi': 'urllib3'},
        {'pypi': 'werkzeug'},
        {'pypi': 'zeep'},
