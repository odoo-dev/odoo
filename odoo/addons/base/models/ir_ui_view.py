...
from odoo.tools import _, config, frozendict, SQL, partition, unique
...
* if False, the view currently does not extend its parent but can be enabled
    ...
    def _get_inheriting_views(self):
        ...
        for f, column in zip(field_names, columns, strict=True):
            self._fields[f]._insert_cache(views, column)
