...
class IrFilters(models.Model):
    ...
    user_ids = fields.Many2many('res.users', string='Users', ondelete='cascade', domain=[], help="The users the filter is shared with. If empty, the filter is shared with all users.", context={'active_test': False})
