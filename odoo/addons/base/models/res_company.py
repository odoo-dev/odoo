...
class ResCompany(models.Model):
    ...
    font = fields.Selection([("Lato", "Lato"), ("Roboto", "Roboto"), ("Open_Sans", "Open Sans"), ("Montserrat", "Montserrat"), ("Oswald", "Oswald"), ("Raleway", "Raleway"), ('Tajawal', 'Tajawal'), ('IBMPlexMono', 'IBM Plex Mono'), ('Noto_Sans_Mono', 'Noto Sans Mono'), ('Deja_Vu_Sans_Mono', 'DejaVu Sans Mono')], default="Lato")
