...
class TestHttp(http.Controller):
    ...
    @http.route('/test_http/echo-json', type='rpc', auth='none', methods=['POST'], csrf=False)
    def echo_json(self, **kwargs):
        return kwargs

    @http.route('/test_http/echo-json-context', type='rpc', auth='user', methods=['POST'], csrf=False, readonly=True)
    ...
    @http.route('/test_http/cors_json', type='rpc', auth='none', cors='*')
    ...
    @http.route('/test_http/json_value_error', type='rpc', auth='none')
