...
class TestDevice(TestHttpBase):
    ...
    def test_detection_device_readonly(self):
        ...
        self.assertEqual(len(odoo.http.root.session_cls(session.sid)['_trace']), 1)
    ...
    def test_detection_device_according_to_time(self):
        ...
        self.assertEqual(len(logs), 1)
        self.assertEqual(len(odoo.http.root.session_cls(session.sid)['_trace']), 1)
        self.assertEqual(self.info_trace(odoo.http.root.session_cls(session.sid)['_trace'][0])['elapsed_time'], 0)
        ...
        self.assertEqual(len(logs), 1)
        self.assertEqual(len(odoo.http.root.session_cls(session.sid)['_trace']), 1)
        self.assertEqual(self.info_trace(odoo.http.root.session_cls(session.sid)['_trace'][0])['elapsed_time'], 0)  # No trace update (< 3600 sec)
        ...
        self.assertEqual(len(odoo.http.root.session_cls(session.sid)['_trace']), 1)
        self.assertEqual(self.info_trace(odoo.http.root.session_cls(session.sid)['_trace'][0])['elapsed_time'], 3600)
        ...
        self.assertEqual(len(odoo.http.root.session_cls(session.sid)['_trace']), 1)
        self.assertEqual(self.info_trace(odoo.http.root.session_cls(session.sid)['_trace'][0])['elapsed_time'], 7200)
    ...
    def test_detection_device_according_to_useragent(self):
        ...
        self.assertEqual(len(logs), 1)
        self.assertEqual(len(odoo.http.root.session_cls(session.sid)['_trace']), 1)
        self.assertEqual(self.info_trace(odoo.http.root.session_cls(session.sid)['_trace'][0])['platform'], 'linux')
        self.assertEqual(self.info_trace(odoo.http.root.session_cls(session.sid)['_trace'][0])['browser'], 'chrome')
        ...
        self.assertEqual(len(logs), 2)
        self.assertEqual(len(odoo.http.root.session_cls(session.sid)['_trace']), 2)
        self.assertEqual(self.info_trace(odoo.http.root.session_cls(session.sid)['_trace'][1])['platform'], 'linux')
        self.assertEqual(self.info_trace(odoo.http.root.session_cls(session.sid)['_trace'][1])['browser'], 'firefox')
    ...
    def test_detection_device_according_to_ipaddress(self):
        ...
        self.assertEqual(len(logs), 2)
        self.assertEqual(len(odoo.http.root.session_cls(session.sid)['_trace']), 2)
        self.assertNotEqual(self.info_trace(odoo.http.root.session_cls(session.sid)['_trace'][0])['ip_address'], TEST_IP)
        self.assertEqual(self.info_trace(odoo.http.root.session_cls(session.sid)['_trace'][1])['ip_address'], TEST_IP)
    ...
    def _create_device_log_for_user(self, session, count):
        for _ in range(count):
            self.DeviceLog.create({
                'session_identifier': odoo.http.root.session_cls(session.sid).static_sid,
                'user_id': session.uid,
                'revoked': False,
            })
    ...
    def test_specific_public_user_write(self):
        ...
        self.assertFalse(odoo.http.root.session_cls(session.sid)['_trace'])
