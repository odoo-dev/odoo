...
class TestGroupbyWeek(common.TransactionCase):
    ...
    def add_datetime_records(self):
        tzinfo = timezone(self.Model._context['tz'])
    ...
    def test_belgium(self):
        ...
        self.Model = self.Model.with_context(lang='fr_BE', tz='Europe/Brussels')
        self.assertEqual(
        ...
        date_counts_by_week = {group['date:week']: group['date_count'] for group in groups}
        ...
        self.assertDictEqual(
            {group['datetime:week']: group['datetime_count'] for group in groups},
            date_counts_by_week,
    ...
    def test_syria(self):
        ...
        self.Model = self.Model.with_context(lang='ar_SY', tz='Asia/Damascus')
        self.assertEqual(
    ...
    def test_united_states(self):
        ...
        self.Model = self.Model.with_context(lang='en_US', tz='America/New_York')
        self.assertEqual(
