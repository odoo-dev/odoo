...
<b>Subject:</b> test (#23)</p>
   ...
   font-size: 30px; max-width: 100%; after: "Not sure
    ...
    def test_quote_gmail(self):
        for src, exp_in, exp_out in (
            (mail_examples.GMAIL_1, mail_examples.GMAIL_1_IN, mail_examples.GMAIL_1_OUT),
            (mail_examples.GMAIL_2, mail_examples.GMAIL_2_IN, mail_examples.GMAIL_2_OUT),
            (mail_examples.GMAIL_3, mail_examples.GMAIL_3_IN, mail_examples.GMAIL_3_OUT),
        ):
