...
registry.category("web_tour.tours").add("widget_x2many", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                'tr:has(td:contains(/^Mitchell Admin$/)) .o_list_record_selector input[type="checkbox"]',
            run: "click",
        },
        {
            trigger:
                'tr:has(td:contains(/^Mitchell Admin$/)) .o_list_record_selector input[type="checkbox"]:checked',
        },
        {
        ...
        },
        {
            ...
            trigger:
                'tr:has(td:contains(/^Marc Demo$/)) .o_list_record_selector input[type="checkbox"]',
            run: "click",
        },
        {
            trigger:
                'tr:has(td:contains(/^Marc Demo$/)) .o_list_record_selector input[type="checkbox"]:checked',
        },
        {
            content: "save selected participants",
            trigger: ".o_select_button",
        ...
        },
        {
            ...
            content: "remove b",
            trigger:
                ".o_field_widget[name=messages] .o_data_row:has(.o_data_cell:contains(/^bbb$/)) .o_list_record_remove",
            run: "click",
        },
        {
            content: "remove e",
            trigger:
                ".o_field_widget[name=messages] .o_data_row:has(.o_data_cell:contains(/^e$/)) .o_list_record_remove",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                ".o_content:has(.o_field_widget[name=messages] tbody:has(tr td:contains(/^aaa$/)):has(tr td:contains(/^c$/)):has(tr td:contains(/^d$/)))",
        },
        {
        ...
        {
            trigger:
                ".o_form_editable .o_field_widget[name=messages] tbody tr:has(td:contains(/^d$/))",
        },
        {
            // add message ddd
        ...
        {
            trigger:
                ".o_field_widget[name=important_messages] .o_data_row .o_list_number:contains(/^13$/)",
        },
        {
        ...
        {
            trigger:
                ".o_field_widget[name=important_messages] .o_data_row .o_list_number:contains(/^22$/)",
        },
        {
