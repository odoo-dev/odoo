...
def patch_evented():
    ...
    # psycopg3 chooses wait_c at import time unless select is already patched.
    # Force a Python wait function so gevent can yield during libpq I/O.
    import psycopg.waiting  # noqa: PLC0415
    psycopg.waiting.wait = psycopg.waiting.wait_select
    odoo.evented = True
