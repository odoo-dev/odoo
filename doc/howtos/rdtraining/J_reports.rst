...
.. warning::
    ...
    |core training branch| from the repository |core training repository|, it
...
Note that you will often see other non-QWeb and non-XML files containing "_report" in their name also within
the report folder. These are unrelated to the reports covered in this tutorial and are beyond its scope. For
now you can think of them as extra advanced topic for customized views that often use direct SQL queries.
...
* Copy these `data files <https://github.com/odoo/technical-training-solutions/blob/14.0-J_reports/estate/data/>`__
  into a new directory (data) in your estate module and copy
  `these lines <https://github.com/odoo/technical-training-solutions/blob/14.0-J_reports/estate/data/>`__
