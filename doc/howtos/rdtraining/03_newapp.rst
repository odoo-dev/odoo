...
one of the dependencies is uninstalled, our module and **any other that depends on it will also
be uninstalled**. Think about your favorite Linux distribution package manager
(``apt``, ``dnf``, ``pacman``...): Odoo works in the same fashion.

.. exercise:: Creation of the required addon files
